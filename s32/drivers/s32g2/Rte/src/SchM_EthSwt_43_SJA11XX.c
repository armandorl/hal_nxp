...
#include "Mcal.h"
#include "OsIf.h"
#include "SchM_EthSwt_43_SJA11XX.h"
...
==================================================================================================*/
#define SCHM_ETHSWT_43_SJA11XX_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_ETHSWT_43_SJA11XX_AR_RELEASE_MINOR_VERSION_C     4
#define SCHM_ETHSWT_43_SJA11XX_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_ETHSWT_43_SJA11XX_SW_MAJOR_VERSION_C             4
#define SCHM_ETHSWT_43_SJA11XX_SW_MINOR_VERSION_C             0
#define SCHM_ETHSWT_43_SJA11XX_SW_PATCH_VERSION_C             0
...
* 
*/
uint32 EthSwt_43_SJA11XX_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 EthSwt_43_SJA11XX_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define EthSwt_43_SJA11XX_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define EthSwt_43_SJA11XX_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
@remarks Implements 
*/
void SchM_Check_ethswt_43_sja11xx(void)
{
