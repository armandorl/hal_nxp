...
==================================================================================================*/
#define SCHM_ETHTRCV_43_PHY_AR_RELEASE_MAJOR_VERSION_C     4
#define SCHM_ETHTRCV_43_PHY_AR_RELEASE_MINOR_VERSION_C     4
#define SCHM_ETHTRCV_43_PHY_AR_RELEASE_REVISION_VERSION_C  0
#define SCHM_ETHTRCV_43_PHY_SW_MAJOR_VERSION_C             4
#define SCHM_ETHTRCV_43_PHY_SW_MINOR_VERSION_C             0
#define SCHM_ETHTRCV_43_PHY_SW_PATCH_VERSION_C             0
...
* 
*/
uint32 EthTrcv_43_PHY_schm_read_msr(void); 
...
#ifdef MCAL_PLATFORM_ARM
#if (MCAL_PLATFORM_ARM == MCAL_ARM_AARCH64)
ASM_KEYWORD uint32 EthTrcv_43_PHY_schm_read_msr(void)
{
    mrs x0, S3_3_c4_c2_1
}
#elif  (MCAL_PLATFORM_ARM == MCAL_ARM_RARCH)
...
#ifdef MCAL_PLATFORM_S12
    #define EthTrcv_43_PHY_schm_read_msr()  ASM_KEYWORD("tfr ccr, d6")
#else
    #define EthTrcv_43_PHY_schm_read_msr() ASM_KEYWORD("mfmsr r3")
#endif
...
@remarks Implements 
*/
void SchM_Check_ethtrcv_43_phy(void)
{
