...
#define UART_TYPES_AR_RELEASE_MINOR_VERSION     4
#define UART_TYPES_AR_RELEASE_REVISION_VERSION  0
#define UART_TYPES_SW_MAJOR_VERSION             4
...
/*Checks against Uart_Defines.h */
    ...
    #error "Uart_Types.h and Uart_Defines.h have different vendor ids"
#endif
    ...
    #error "AUTOSAR Version Numbers of Uart_Types.h and Uart_Defines.h are different"
#endif
    ...
    #error "Software Version Numbers of Uart_Types.h and Uart_Defines.h are different"
#endif
...
*/
/* implements     Uart_DataDirectionType_Enumeration */
typedef enum
{
...
typedef enum
{
    ...
    UART_STATUS_DMA_ERROR           =  0x08, /**< @brief Uart Dma Error error  */
#if (UART_HAS_TIMEOUT_INTERRUPT_ENABLED == STD_ON)
    UART_STATUS_RX_IDLE_STATE       =  0x09, /**< @brief Uart Idle state of the reception line is generated  */
#endif
} Uart_StatusType;
