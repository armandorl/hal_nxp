...
#define UART_IPW_TYPES_AR_RELEASE_MINOR_VERSION     4
#define UART_IPW_TYPES_AR_RELEASE_REVISION_VERSION  0
#define UART_IPW_TYPES_SW_MAJOR_VERSION             4
...
#if (UART_IPW_TYPES_VENDOR_ID!= LINFLEXD_UART_IP_TYPES_VENDOR_ID)
    #error "Uart_Ipw_Types.h and Linflexd_Uart_Ip_Types.h have different vendor ids"
#endif
#if ((UART_IPW_TYPES_AR_RELEASE_MAJOR_VERSION   != LINFLEXD_UART_IP_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (UART_IPW_TYPES_AR_RELEASE_MINOR_VERSION   != LINFLEXD_UART_IP_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (UART_IPW_TYPES_AR_RELEASE_REVISION_VERSION!= LINFLEXD_UART_IP_TYPES_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Uart_Ipw_Types.h and Linflexd_Uart_Ip_Types.h are different"
#endif
#if ((UART_IPW_TYPES_SW_MAJOR_VERSION!= LINFLEXD_UART_IP_TYPES_SW_MAJOR_VERSION) || \
     (UART_IPW_TYPES_SW_MINOR_VERSION!= LINFLEXD_UART_IP_TYPES_SW_MINOR_VERSION) || \
     (UART_IPW_TYPES_SW_PATCH_VERSION!= LINFLEXD_UART_IP_TYPES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Uart_Ipw_Types.h and Linflexd_Uart_Ip_Types.h are different"
#endif

/* Checks against Uart_Defines.h */
#if (UART_IPW_TYPES_VENDOR_ID != UART_DEFINES_VENDOR_ID_CFG)
    #error "Uart_Ipw_Types.h and Uart_Defines.h have different vendor ids"
#endif
    ...
    #error "AutoSar Version Numbers of Uart_Ipw_Types.h and Uart_Defines.h are different"
#endif
/* Check if current file and Uart_Defines.h header file are of the same Software version */
    ...
    #error "Software Version Numbers of Uart_Ipw_Types.h and Uart_Defines.h are different"
#endif
...
/* Check if current file and StandardTypes.h header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Uart_Ipw_Types.h and StandardTypes.h are different"
    #endif
#endif
#endif
/*==================================================================================================
 ...
 *
 */
/* implements     Uart_EventType_Enumeration */
typedef enum
{
 ...
 *
 */
/* implements   Uart_BaudrateType_Enumeration */
typedef enum
{
 ...
 *
 */
/* implements     Uart_CallbackType_typedef */
...
typedef struct
{
    const Linflexd_Uart_Ip_UserConfigType *LinflexdUserConfig; /**< @brief Linflexd Ip configuration structure  */
}
...
typedef struct
{
    ...
    Uart_CallbackType Callback;     /**< @brief Callback to invoke for Uart events */
