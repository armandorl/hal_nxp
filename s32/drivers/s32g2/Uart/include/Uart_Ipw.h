...
#define UART_IPW_SW_MAJOR_VERSION             4
...
#if (UART_IPW_VENDOR_ID != LINFLEXD_UART_IP_VENDOR_ID)
    #error "Uart_Ipw.h and Linflexd_Uart_Ip.h have different vendor ids"
#endif
#if ((UART_IPW_AR_RELEASE_MAJOR_VERSION    != LINFLEXD_UART_IP_AR_RELEASE_MAJOR_VERSION) || \
     (UART_IPW_AR_RELEASE_MINOR_VERSION    != LINFLEXD_UART_IP_AR_RELEASE_MINOR_VERSION) || \
     (UART_IPW_AR_RELEASE_REVISION_VERSION != LINFLEXD_UART_IP_AR_RELEASE_REVISION_VERSION))
    #error "AUTOSAR Version Numbers of Uart_Ipw.h and Linflexd_Uart_Ip.h are different"
#endif
#if ((UART_IPW_SW_MAJOR_VERSION != LINFLEXD_UART_IP_SW_MAJOR_VERSION) || \
     (UART_IPW_SW_MINOR_VERSION != LINFLEXD_UART_IP_SW_MINOR_VERSION) || \
     (UART_IPW_SW_PATCH_VERSION != LINFLEXD_UART_IP_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Uart_Ipw.h and Linflexd_Uart_Ip.h are different"
#endif
