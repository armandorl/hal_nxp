...
static void Sys_StartSecondaryCores(void)
{
    ...
    extern const uint32 __Stack_start_c1;

    /* Create vector table at start address for holding core in loop
    CM7_core_EXCEPTION_0 = CM7_core_STACK_TOP_VALUE
    CM7_core_EXCEPTION_1 = CM7_core_RESET_HANDLER_ADDR
    CM7_core_RESET_HANDLER = CM7_core_self-branch_OP_CODE_VALUE */
    *(volatile uint32*)((uint32)&__CORE1_START_ADDRESS) = (uint32)&__Stack_start_c1;
    *(volatile uint32*)((uint32)&__CORE1_START_ADDRESS + 0x4u) = (uint32)&__CORE1_START_ADDRESS + 0x25u;
    *(volatile uint32*)((uint32)&__CORE1_START_ADDRESS + 0x24u) = 0xFFFEF7FFu;
    ...
    extern const uint32 __Stack_start_c2;

    /* Create vector table at start address for holding core in loop
    CM7_core_EXCEPTION_0 = CM7_core_STACK_TOP_VALUE
    CM7_core_EXCEPTION_1 = CM7_core_RESET_HANDLER_ADDR
    CM7_core_RESET_HANDLER = CM7_core_self-branch_OP_CODE_VALUE */
    *(volatile uint32*)((uint32)&__CORE2_START_ADDRESS) = (uint32)&__Stack_start_c2;
    *(volatile uint32*)((uint32)&__CORE2_START_ADDRESS + 0x4u) = (uint32)&__CORE2_START_ADDRESS + 0x25u;
    *(volatile uint32*)((uint32)&__CORE2_START_ADDRESS + 0x24u) = 0xFFFEF7FFu;
    ...
    extern const uint32 __Stack_start_c3;

    /* Create vector table at start address for holding core in loop
    CM7_core_EXCEPTION_0 = CM7_core_STACK_TOP_VALUE
    CM7_core_EXCEPTION_1 = CM7_core_RESET_HANDLER_ADDR
    CM7_core_RESET_HANDLER = CM7_core_self-branch_OP_CODE_VALUE */
    *(volatile uint32*)((uint32)&__CORE3_START_ADDRESS) = (uint32)&__Stack_start_c3;
    *(volatile uint32*)((uint32)&__CORE3_START_ADDRESS + 0x4u) = (uint32)&__CORE3_START_ADDRESS + 0x25u;
    *(volatile uint32*)((uint32)&__CORE3_START_ADDRESS + 0x24u) = 0xFFFEF7FFu;
