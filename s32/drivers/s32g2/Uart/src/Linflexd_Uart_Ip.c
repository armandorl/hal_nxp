...
#define LINFLEXD_UART_IP_SW_MAJOR_VERSION_C               4
...
static void Linflexd_Uart_Ip_SetUp_StopBitsCount(const uint8 Instance);
static void Linflexd_Uart_Ip_SetUp_TransferMode(const uint8 Instance);
...
static void Linflexd_Uart_Ip_SetUp_Init(const uint8 Instance)
{
    ...
    Linflexd_Uart_Ip_SetUARTSRToDefaultValue(Base);
    ...
    /* Set stop bits count */
    Linflexd_Uart_Ip_SetUp_StopBitsCount(Instance);

    /* Set transfer mode */
    Linflexd_Uart_Ip_SetUp_TransferMode(Instance);
}

/*FUNCTION**********************************************************************
 *
 * Function Name : Linflexd_Uart_Ip_SetUp_BaudRate
 * Description   : Set up Linflexd Uart Baudrate.
 * This is not a public API as it is called from other driver functions.
 *
 *END**************************************************************************/
static void Linflexd_Uart_Ip_SetUp_BaudRate(const uint8 Instance)
 ...
 * Description   : Set up Linflexd Uart Parity Bit.
 * This is not a public API as it is called from other driver functions.
 *
 *END**************************************************************************/
static void Linflexd_Uart_Ip_SetUp_Parity(const uint8 Instance)
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Linflexd_Uart_Ip_SetUp_StopBitsCount
 * Description   : Set up Linflexd Uart Stop Bits.
 * This is not a public API as it is called from other driver functions.
 *
 *END**************************************************************************/
static void Linflexd_Uart_Ip_SetUp_StopBitsCount(const uint8 Instance)
...
/*FUNCTION**********************************************************************
 *
 * Function Name : Linflexd_Uart_Ip_SetUp_TransferMode
 * Description   : Set up Linflexd Uart Transfer Mode.
 * This is not a public API as it is called from other driver functions.
 *
 *END**************************************************************************/
static void Linflexd_Uart_Ip_SetUp_TransferMode(const uint8 Instance)
