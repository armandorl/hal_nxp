...
#define UART_IPW_SW_MAJOR_VERSION_C             4
...
* This is not a public API as it is called from other driver functions.
*/
void Uart_Ipw_Callback(uint8 HwInstance, Linflexd_Uart_Ip_EventType Event, void *UserData)
{
    (void)UserData;
    uint8 Channel = Uart_Ipw_s8HwMapping[HwInstance];
