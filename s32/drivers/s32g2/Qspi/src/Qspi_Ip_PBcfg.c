...
extern Qspi_Ip_StatusType FlsQspiErrorCheckCallout(uint32 instance);
extern Qspi_Ip_StatusType FlsQspiInitCallout(uint32 instance);
extern Qspi_Ip_StatusType FlsQspiResetCallout(uint32 instance);
extern Qspi_Ip_StatusType FlsQspiEccCheckCallout(uint32 instance, uint32 startAddress, uint32 dataLength);
...
static const Qspi_Ip_InstrOpType MemCfg_0_BOARD_InitPeripherals_paLutOperations_0[47U] =
{
    ...
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /* 39: READ_CR2_SPI_MODE */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_1 | (Qspi_Ip_InstrOpType)0x71U),
    ...
    (Qspi_Ip_InstrOpType)(QSPI_IP_LUT_INSTR_STOP),
    /* 43: WRITE_CR2_SPI_MODE */
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_CMD | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_1 | (Qspi_Ip_InstrOpType)0x72U),
    (Qspi_Ip_InstrOpType)((Qspi_Ip_InstrOpType)QSPI_IP_LUT_INSTR_ADDR | (Qspi_Ip_InstrOpType)QSPI_IP_LUT_PADS_1 | (Qspi_Ip_InstrOpType)32U),
...
{
    {
        ...
        /* readIdSettings */
        {
            36U,  /* readIdLut */
            3U,  /* readIdSize */
            {0x3A, 0x81, 0xC2}  /* readIdExpected - JEDEC ID bytes [manufacturer, type, capacity] */
        },
        {
            /* eraseSettings */
            {
...
#if 0
		QspiConfigSet_BOARD_InitPeripherals_paQspiUnitCfg /* ctrlAutoCfgPtr */
#else
		NULL_PTR
#endif
    }
