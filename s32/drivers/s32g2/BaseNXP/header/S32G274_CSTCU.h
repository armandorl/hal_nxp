...
/*!
 * @file S32G274_CSTCU.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CSTCU
 *
...
#if !defined(S32G274_CSTCU_H_)  /* Check if memory map has not been already included */
#define S32G274_CSTCU_H_
...
#define CSTCU_LSTCU_MBSCH_COUNT                   12u
#define CSTCU_LSTCU_LBSCH_COUNT                   12u

/** CSTCU - Register Layout Typedef */
typedef struct CSTCU_Struct {
...
#define IP_CSTCU_BASE                            (0x404C0000u)
...
#endif  /* #if !defined(S32G274_CSTCU_H_) */
