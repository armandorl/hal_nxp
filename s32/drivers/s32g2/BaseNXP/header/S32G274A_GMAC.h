...
/*!
 * @file S32G274A_GMAC.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_GMAC
 *
...
#if !defined(S32G274A_GMAC_H_)  /* Check if memory map has not been already included */
#define S32G274A_GMAC_H_
...
#define GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1_MASK (0x8000U)
#define GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1_SHIFT (15U)
#define GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1_WIDTH (1U)
#define GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1(x)  (((uint32_t)(((uint32_t)(x)) << GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1_SHIFT)) & GMAC_MTL_RXP_CONTROL_STATUS_MTL_SCS1_MASK)
...
#endif  /* #if !defined(S32G274A_GMAC_H_) */
