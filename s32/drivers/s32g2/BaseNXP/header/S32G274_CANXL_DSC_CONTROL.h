...
/*!
 * @file S32G274_CANXL_DSC_CONTROL.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_DSC_CONTROL
 *
...
#if !defined(S32G274_CANXL_DSC_CONTROL_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_DSC_CONTROL_H_
...
typedef struct CANXL_DSC_CONTROL_Struct {
  struct CANXL_DSC_CONTROL_DSCMBCTRLAR {           /* offset: 0x0, array step: 0x20 */
    ...
    __IO uint32_t DCABT;                             /**< Descriptor Control Abort, array offset: 0x18, array step: 0x20 */
...
#define CANXL_DSC_CONTROL_INSTANCE_COUNT         (1u)

/* CANXL_DSC_CONTROL - Peripheral instance base addresses */
/** Peripheral CANEXCEL__DSC_CONTROL base address */
#define IP_CANEXCEL__DSC_CONTROL_BASE            (0x6A024000u)
/** Peripheral CANEXCEL__DSC_CONTROL base pointer */
#define IP_CANEXCEL__DSC_CONTROL                 ((CANXL_DSC_CONTROL_Type *)IP_CANEXCEL__DSC_CONTROL_BASE)
/** Array initializer of CANXL_DSC_CONTROL peripheral base addresses */
#define IP_CANXL_DSC_CONTROL_BASE_ADDRS          { IP_CANEXCEL__DSC_CONTROL_BASE }
/** Array initializer of CANXL_DSC_CONTROL peripheral base pointers */
#define IP_CANXL_DSC_CONTROL_BASE_PTRS           { IP_CANEXCEL__DSC_CONTROL }
...
/*! @name DCABT - Descriptor Control Abort */
/*! @{ */

#define CANXL_DSC_CONTROL_DCABT_ABTREQ_MASK      (0x1U)
#define CANXL_DSC_CONTROL_DCABT_ABTREQ_SHIFT     (0U)
#define CANXL_DSC_CONTROL_DCABT_ABTREQ_WIDTH     (1U)
#define CANXL_DSC_CONTROL_DCABT_ABTREQ(x)        (((uint32_t)(((uint32_t)(x)) << CANXL_DSC_CONTROL_DCABT_ABTREQ_SHIFT)) & CANXL_DSC_CONTROL_DCABT_ABTREQ_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274_CANXL_DSC_CONTROL_H_) */
