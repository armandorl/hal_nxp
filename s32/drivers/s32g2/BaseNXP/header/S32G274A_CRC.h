 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_CRC
 *
...
#if !defined(S32G274A_CRC_H_)  /* Check if memory map has not been already included */
#define S32G274A_CRC_H_
...
#define CRC_CHANNEL_EXT_COUNT                     3u
...
typedef struct {
  ...
  struct {                                         /* offset: 0x108, array step: 0x10 */
    __IO uint32_t CSTAT_EXT;                         /**< Current Status Extend Register, array offset: 0x108, array step: 0x10 */
    __I  uint32_t OUTP_EXT;                          /**< Output Extend Register, array offset: 0x10C, array step: 0x10 */
    uint8_t RESERVED_0[8];
  } CHANNEL_EXT[CRC_CHANNEL_EXT_COUNT];
...
#define IP_CRC_0_BASE                            (0x40190000u)
/** Peripheral CRC_0 base pointer */
#define IP_CRC_0                                 ((CRC_Type *)IP_CRC_0_BASE)
/** Array initializer of CRC peripheral base addresses */
#define IP_CRC_BASE_ADDRS                        { IP_CRC_0_BASE }
/** Array initializer of CRC peripheral base pointers */
#define IP_CRC_BASE_PTRS                         { IP_CRC_0 }
...
#define CRC_CFG_POLYG_EXT_MASK                   (0xF00U)
#define CRC_CFG_POLYG_EXT_SHIFT                  (8U)
#define CRC_CFG_POLYG_EXT_WIDTH                  (4U)
#define CRC_CFG_POLYG_EXT(x)                     (((uint32_t)(((uint32_t)(x)) << CRC_CFG_POLYG_EXT_SHIFT)) & CRC_CFG_POLYG_EXT_MASK)
/*! @} */
...
/*! @name CSTAT_EXT - Current Status Extend Register */
/*! @{ */

#define CRC_CSTAT_EXT_CSTAT_EXT_MASK             (0xFFFFFFFFU)
#define CRC_CSTAT_EXT_CSTAT_EXT_SHIFT            (0U)
#define CRC_CSTAT_EXT_CSTAT_EXT_WIDTH            (32U)
#define CRC_CSTAT_EXT_CSTAT_EXT(x)               (((uint32_t)(((uint32_t)(x)) << CRC_CSTAT_EXT_CSTAT_EXT_SHIFT)) & CRC_CSTAT_EXT_CSTAT_EXT_MASK)
/*! @} */

/*! @name OUTP_EXT - Output Extend Register */
/*! @{ */

#define CRC_OUTP_EXT_OUTP_EXT_MASK               (0xFFFFFFFFU)
#define CRC_OUTP_EXT_OUTP_EXT_SHIFT              (0U)
#define CRC_OUTP_EXT_OUTP_EXT_WIDTH              (32U)
#define CRC_OUTP_EXT_OUTP_EXT(x)                 (((uint32_t)(((uint32_t)(x)) << CRC_OUTP_EXT_OUTP_EXT_SHIFT)) & CRC_OUTP_EXT_OUTP_EXT_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274A_CRC_H_) */
