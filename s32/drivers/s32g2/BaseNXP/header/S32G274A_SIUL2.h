...
/*!
 * @file S32G274A_SIUL2.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_SIUL2
 *
...
#if !defined(S32G274A_SIUL2_H_)  /* Check if memory map has not been already included */
#define S32G274A_SIUL2_H_
...
#define IP_SIUL2_BASE_ADDRS                      { IP_SIUL2_0_BASE, IP_SIUL2_1_BASE }
/** Array initializer of SIUL2 peripheral base pointers */
#define IP_SIUL2_BASE_PTRS                       { IP_SIUL2_0, IP_SIUL2_1 }
...
#define SIUL2_MIDR2_SUBMINOR_MASK_MASK           (0xC000000U)
#define SIUL2_MIDR2_SUBMINOR_MASK_SHIFT          (26U)
#define SIUL2_MIDR2_SUBMINOR_MASK_WIDTH          (2U)
#define SIUL2_MIDR2_SUBMINOR_MASK(x)             (((uint32_t)(((uint32_t)(x)) << SIUL2_MIDR2_SUBMINOR_MASK_SHIFT)) & SIUL2_MIDR2_SUBMINOR_MASK_MASK)
...
#endif  /* #if !defined(S32G274A_SIUL2_H_) */
