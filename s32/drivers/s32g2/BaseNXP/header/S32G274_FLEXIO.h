...
/*!
 * @file S32G274_FLEXIO.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_FLEXIO
 *
...
#if !defined(S32G274_FLEXIO_H_)  /* Check if memory map has not been already included */
#define S32G274_FLEXIO_H_
...
#define FLEXIO_SHIFTCTL_COUNT                     16u
#define FLEXIO_SHIFTCFG_COUNT                     16u
#define FLEXIO_SHIFTBUF_COUNT                     16u
#define FLEXIO_SHIFTBUFBIS_COUNT                  16u
#define FLEXIO_SHIFTBUFBYS_COUNT                  16u
#define FLEXIO_SHIFTBUFBBS_COUNT                  16u
#define FLEXIO_TIMCTL_COUNT                       16u
#define FLEXIO_TIMCFG_COUNT                       16u
#define FLEXIO_TIMCMP_COUNT                       16u
#define FLEXIO_SHIFTBUFNBS_COUNT                  16u
#define FLEXIO_SHIFTBUFHWS_COUNT                  16u
#define FLEXIO_SHIFTBUFNIS_COUNT                  16u
#define FLEXIO_SHIFTBUFOES_COUNT                  16u
#define FLEXIO_SHIFTBUFEOS_COUNT                  16u
#define FLEXIO_SHIFTBUFHBS_COUNT                  16u
...
#define FLEXIO_INSTANCE_COUNT                    (2u)

/* FLEXIO - Peripheral instance base addresses */
/** Peripheral FLEXIO_0 base address */
#define IP_FLEXIO_0_BASE                         (0x402B0000u)
/** Peripheral FLEXIO_0 base pointer */
#define IP_FLEXIO_0                              ((FLEXIO_Type *)IP_FLEXIO_0_BASE)
/** Peripheral FLEXIO_1 base address */
#define IP_FLEXIO_1_BASE                         (0x406B8000u)
/** Peripheral FLEXIO_1 base pointer */
#define IP_FLEXIO_1                              ((FLEXIO_Type *)IP_FLEXIO_1_BASE)
/** Array initializer of FLEXIO peripheral base addresses */
#define IP_FLEXIO_BASE_ADDRS                     { IP_FLEXIO_0_BASE, IP_FLEXIO_1_BASE }
/** Array initializer of FLEXIO peripheral base pointers */
#define IP_FLEXIO_BASE_PTRS                      { IP_FLEXIO_0, IP_FLEXIO_1 }
...
#define FLEXIO_SHIFTSTAT_SSF_MASK                (0xFFFFU)
#define FLEXIO_SHIFTSTAT_SSF_SHIFT               (0U)
#define FLEXIO_SHIFTSTAT_SSF_WIDTH               (16U)
...
#define FLEXIO_SHIFTERR_SEF_MASK                 (0xFFFFU)
#define FLEXIO_SHIFTERR_SEF_SHIFT                (0U)
#define FLEXIO_SHIFTERR_SEF_WIDTH                (16U)
...
#define FLEXIO_TIMSTAT_TSF_MASK                  (0xFFFFU)
#define FLEXIO_TIMSTAT_TSF_SHIFT                 (0U)
#define FLEXIO_TIMSTAT_TSF_WIDTH                 (16U)
...
#define FLEXIO_SHIFTSIEN_SSIE_MASK               (0xFFFFU)
#define FLEXIO_SHIFTSIEN_SSIE_SHIFT              (0U)
#define FLEXIO_SHIFTSIEN_SSIE_WIDTH              (16U)
...
#define FLEXIO_SHIFTEIEN_SEIE_MASK               (0xFFFFU)
#define FLEXIO_SHIFTEIEN_SEIE_SHIFT              (0U)
#define FLEXIO_SHIFTEIEN_SEIE_WIDTH              (16U)
...
#define FLEXIO_TIMIEN_TEIE_MASK                  (0xFFFFU)
#define FLEXIO_TIMIEN_TEIE_SHIFT                 (0U)
#define FLEXIO_TIMIEN_TEIE_WIDTH                 (16U)
...
#define FLEXIO_SHIFTSDEN_SSDE_MASK               (0xFFFFU)
#define FLEXIO_SHIFTSDEN_SSDE_SHIFT              (0U)
#define FLEXIO_SHIFTSDEN_SSDE_WIDTH              (16U)
...
#define FLEXIO_TIMERSDEN_TSDE_MASK               (0xFFFFU)
#define FLEXIO_TIMERSDEN_TSDE_SHIFT              (0U)
#define FLEXIO_TIMERSDEN_TSDE_WIDTH              (16U)
...
#define FLEXIO_SHIFTCTL_TIMSEL_MASK              (0xF000000U)
#define FLEXIO_SHIFTCTL_TIMSEL_SHIFT             (24U)
#define FLEXIO_SHIFTCTL_TIMSEL_WIDTH             (4U)
...
#endif  /* #if !defined(S32G274_FLEXIO_H_) */
