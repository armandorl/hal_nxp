...
/*!
 * @file S32G274_LPSPI.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_LPSPI
 *
...
#if !defined(S32G274_LPSPI_H_)  /* Check if memory map has not been already included */
#define S32G274_LPSPI_H_
...
#define LPSPI_INSTANCE_COUNT                     (8u)

/* LPSPI - Peripheral instance base addresses */
/** Peripheral LPE_LPSPI_0 base address */
#define IP_LPE_LPSPI_0_BASE                      (0x4217C000u)
/** Peripheral LPE_LPSPI_0 base pointer */
#define IP_LPE_LPSPI_0                           ((LPSPI_Type *)IP_LPE_LPSPI_0_BASE)
/** Peripheral LPE_LPSPI_1 base address */
#define IP_LPE_LPSPI_1_BASE                      (0x42180000u)
/** Peripheral LPE_LPSPI_1 base pointer */
#define IP_LPE_LPSPI_1                           ((LPSPI_Type *)IP_LPE_LPSPI_1_BASE)
/** Peripheral LPSPI_0 base address */
#define IP_LPSPI_0_BASE                          (0x400D8000u)
/** Peripheral LPSPI_0 base pointer */
#define IP_LPSPI_0                               ((LPSPI_Type *)IP_LPSPI_0_BASE)
/** Peripheral LPSPI_1 base address */
#define IP_LPSPI_1_BASE                          (0x400DC000u)
/** Peripheral LPSPI_1 base pointer */
#define IP_LPSPI_1                               ((LPSPI_Type *)IP_LPSPI_1_BASE)
/** Peripheral LPSPI_2 base address */
#define IP_LPSPI_2_BASE                          (0x402B4000u)
/** Peripheral LPSPI_2 base pointer */
#define IP_LPSPI_2                               ((LPSPI_Type *)IP_LPSPI_2_BASE)
/** Peripheral LPSPI_3 base address */
#define IP_LPSPI_3_BASE                          (0x406C4000u)
/** Peripheral LPSPI_3 base pointer */
#define IP_LPSPI_3                               ((LPSPI_Type *)IP_LPSPI_3_BASE)
/** Peripheral LPSPI_4 base address */
#define IP_LPSPI_4_BASE                          (0x406C8000u)
/** Peripheral LPSPI_4 base pointer */
#define IP_LPSPI_4                               ((LPSPI_Type *)IP_LPSPI_4_BASE)
/** Peripheral LPSPI_5 base address */
#define IP_LPSPI_5_BASE                          (0x408B8000u)
/** Peripheral LPSPI_5 base pointer */
#define IP_LPSPI_5                               ((LPSPI_Type *)IP_LPSPI_5_BASE)
/** Array initializer of LPSPI peripheral base addresses */
#define IP_LPSPI_BASE_ADDRS                      { IP_LPE_LPSPI_0_BASE, IP_LPE_LPSPI_1_BASE, IP_LPSPI_0_BASE, IP_LPSPI_1_BASE, IP_LPSPI_2_BASE, IP_LPSPI_3_BASE, IP_LPSPI_4_BASE, IP_LPSPI_5_BASE }
/** Array initializer of LPSPI peripheral base pointers */
#define IP_LPSPI_BASE_PTRS                       { IP_LPE_LPSPI_0, IP_LPE_LPSPI_1, IP_LPSPI_0, IP_LPSPI_1, IP_LPSPI_2, IP_LPSPI_3, IP_LPSPI_4, IP_LPSPI_5 }
...
#define LPSPI_CFGR1_PCSPOL_MASK                  (0xFF00U)  /* Merged from fields with different position or width, of widths (2, 4, 6, 8), largest definition used */
#define LPSPI_CFGR1_PCSPOL_SHIFT                 (8U)
#define LPSPI_CFGR1_PCSPOL_WIDTH                 (8U)
#define LPSPI_CFGR1_PCSPOL(x)                    (((uint32_t)(((uint32_t)(x)) << LPSPI_CFGR1_PCSPOL_SHIFT)) & LPSPI_CFGR1_PCSPOL_MASK)  /* Merged from fields with different position or width, of widths (2, 4, 6, 8), largest definition used */
...
#define LPSPI_TCR_PCS_MASK                       (0x7000000U)  /* Merged from fields with different position or width, of widths (1, 2, 3), largest definition used */
#define LPSPI_TCR_PCS_SHIFT                      (24U)
#define LPSPI_TCR_PCS_WIDTH                      (3U)
#define LPSPI_TCR_PCS(x)                         (((uint32_t)(((uint32_t)(x)) << LPSPI_TCR_PCS_SHIFT)) & LPSPI_TCR_PCS_MASK)  /* Merged from fields with different position or width, of widths (1, 2, 3), largest definition used */
...
#endif  /* #if !defined(S32G274_LPSPI_H_) */
