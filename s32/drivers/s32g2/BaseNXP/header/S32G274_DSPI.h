 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_DSPI
 *
...
#if !defined(S32G274_DSPI_H_)  /* Check if memory map has not been already included */
#define S32G274_DSPI_H_
...
#define DSPI_INSTANCE_COUNT                      (2u)

/* DSPI - Peripheral instance base addresses */
/** Peripheral DSPI_0 base address */
#define IP_DSPI_0_BASE                           (0x406EC000u)
/** Peripheral DSPI_0 base pointer */
#define IP_DSPI_0                                ((DSPI_Type *)IP_DSPI_0_BASE)
/** Peripheral DSPI_1 base address */
#define IP_DSPI_1_BASE                           (0x406F0000u)
/** Peripheral DSPI_1 base pointer */
#define IP_DSPI_1                                ((DSPI_Type *)IP_DSPI_1_BASE)
/** Array initializer of DSPI peripheral base addresses */
#define IP_DSPI_BASE_ADDRS                       { IP_DSPI_0_BASE, IP_DSPI_1_BASE }
/** Array initializer of DSPI peripheral base pointers */
#define IP_DSPI_BASE_PTRS                        { IP_DSPI_0, IP_DSPI_1 }
...
#define DSPI_MCR_PCSIS_MASK                      (0x30000U)
#define DSPI_MCR_PCSIS_SHIFT                     (16U)
#define DSPI_MCR_PCSIS_WIDTH                     (2U)
...
#define DSPI_PUSHR_PCS_MASK                      (0x30000U)
#define DSPI_PUSHR_PCS_SHIFT                     (16U)
#define DSPI_PUSHR_PCS_WIDTH                     (2U)
...
#define DSPI_DSICR0_TRG_MASK                     (0x400000U)
#define DSPI_DSICR0_TRG_SHIFT                    (22U)
#define DSPI_DSICR0_TRG_WIDTH                    (1U)
#define DSPI_DSICR0_TRG(x)                       (((uint32_t)(((uint32_t)(x)) << DSPI_DSICR0_TRG_SHIFT)) & DSPI_DSICR0_TRG_MASK)
...
#endif  /* #if !defined(S32G274_DSPI_H_) */
