...
/*!
 * @file S32G399A_OCOTP.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_OCOTP
 *
...
#if !defined(S32G399A_OCOTP_H_)  /* Check if memory map has not been already included */
#define S32G399A_OCOTP_H_
...
/** Peripheral OCOTP_1 base address */
#define IP_OCOTP_1_BASE                          (0x400A4000u)
/** Peripheral OCOTP_1 base pointer */
#define IP_OCOTP_1                               ((OCOTP_Type *)IP_OCOTP_1_BASE)
/** Array initializer of OCOTP peripheral base addresses */
#define IP_OCOTP_BASE_ADDRS                      { IP_OCOTP_1_BASE }
/** Array initializer of OCOTP peripheral base pointers */
#define IP_OCOTP_BASE_PTRS                       { IP_OCOTP_1 }
...
#define OCOTP_SEC_SEC98_MASK                     (0x2U)
#define OCOTP_SEC_SEC98_SHIFT                    (1U)
#define OCOTP_SEC_SEC98_WIDTH                    (1U)
#define OCOTP_SEC_SEC98(x)                       (((uint32_t)(((uint32_t)(x)) << OCOTP_SEC_SEC98_SHIFT)) & OCOTP_SEC_SEC98_MASK)

#define OCOTP_SEC_SEC99_MASK                     (0x4U)
#define OCOTP_SEC_SEC99_SHIFT                    (2U)
#define OCOTP_SEC_SEC99_WIDTH                    (1U)
#define OCOTP_SEC_SEC99(x)                       (((uint32_t)(((uint32_t)(x)) << OCOTP_SEC_SEC99_SHIFT)) & OCOTP_SEC_SEC99_MASK)

#define OCOTP_SEC_SEC100_MASK                    (0x8U)
#define OCOTP_SEC_SEC100_SHIFT                   (3U)
#define OCOTP_SEC_SEC100_WIDTH                   (1U)
#define OCOTP_SEC_SEC100(x)                      (((uint32_t)(((uint32_t)(x)) << OCOTP_SEC_SEC100_SHIFT)) & OCOTP_SEC_SEC100_MASK)
/*! @} */
...
#define OCOTP_DED_DED98_MASK                     (0x2U)
#define OCOTP_DED_DED98_SHIFT                    (1U)
#define OCOTP_DED_DED98_WIDTH                    (1U)
#define OCOTP_DED_DED98(x)                       (((uint32_t)(((uint32_t)(x)) << OCOTP_DED_DED98_SHIFT)) & OCOTP_DED_DED98_MASK)

#define OCOTP_DED_DED99_MASK                     (0x4U)
#define OCOTP_DED_DED99_SHIFT                    (2U)
#define OCOTP_DED_DED99_WIDTH                    (1U)
#define OCOTP_DED_DED99(x)                       (((uint32_t)(((uint32_t)(x)) << OCOTP_DED_DED99_SHIFT)) & OCOTP_DED_DED99_MASK)

#define OCOTP_DED_DED100_MASK                    (0x8U)
#define OCOTP_DED_DED100_SHIFT                   (3U)
#define OCOTP_DED_DED100_WIDTH                   (1U)
#define OCOTP_DED_DED100(x)                      (((uint32_t)(((uint32_t)(x)) << OCOTP_DED_DED100_SHIFT)) & OCOTP_DED_DED100_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G399A_OCOTP_H_) */
