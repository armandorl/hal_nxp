...
/*!
 * @file S32G274A_MC_CGM.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_MC_CGM
 *
...
#if !defined(S32G274A_MC_CGM_H_)  /* Check if memory map has not been already included */
#define S32G274A_MC_CGM_H_
...
#endif  /* #if !defined(S32G274A_MC_CGM_H_) */
