...
/*!
 * @file S32G274_SYSTICK.h
 * @version 1.3
 * @date 2024-06-14
 * @brief Peripheral Access Layer for S32G274_SYSTICK
 *
...
#if !defined(S32G274_SYSTICK_H_)  /* Check if memory map has not been already included */
#define S32G274_SYSTICK_H_
...
#endif  /* #if !defined(S32G274_SYSTICK_H_) */
