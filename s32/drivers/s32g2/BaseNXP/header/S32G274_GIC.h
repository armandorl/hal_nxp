 ...
 * @version 1.3
 * @date 2024-07-21
 * @brief Peripheral Access Layer for S32G274_GIC
 *
...
#if !defined(S32G274_GIC_H_)  /* Check if memory map has not been already included */
#define S32G274_GIC_H_
...
#define IP_S32_GICD_BASE                         (0x43000000u)
...
#define IP_S32_GICR_BASE                         (0x430C0000u)
...
#define GIC500_CLUSTER_COUNT               (1U)
/* Cores map to Aff0 */
#define GIC500_CPU_PER_CLUSTER_COUNT       (2U)
...
#define IP_GIC500_BASE                     (0x43000000U)
...
#define GIC500_GICD_IROUTER_AFF2(x)                (((uint32_t)(((uint32_t)(x)) << GIC500_GICD_IROUTER_AFF2_SHIFT)) & GIC500_GICD_IROUTER_AFF2_MASK)

#define GIC500_GICD_IROUTER_AFF1_MASK              (0x0000FF00UL)
#define GIC500_GICD_IROUTER_AFF1_SHIFT             (8UL)
#define GIC500_GICD_IROUTER_AFF1(x)                (((uint32_t)(((uint32_t)(x)) << GIC500_GICD_IROUTER_AFF1_SHIFT)) & GIC500_GICD_IROUTER_AFF1_MASK)

#define GIC500_GICD_IROUTER_AFF0_MASK              (0x000000FFUL)
#define GIC500_GICD_IROUTER_AFF0_SHIFT             (0UL)
#define GIC500_GICD_IROUTER_AFF0(x)                (((uint32_t)(((uint32_t)(x)) << GIC500_GICD_IROUTER_AFF0_SHIFT)) & GIC500_GICD_IROUTER_AFF0_MASK)

#define GIC500_GICD_IROUTER_IRM_MASK               (0x80000000UL)
#define GIC500_GICD_IROUTER_IRM_SHIFT              (31UL)
#define GIC500_GICD_IROUTER_IRM(x)                 (((uint32_t)(((uint32_t)(x)) << GIC500_GICD_IROUTER_IRM_SHIFT)) & GIC500_GICD_IROUTER_IRM_MASK)
/*==================================================================================================
*                                          USER TYPES
==================================================================================================*/
struct gic500_gicd_if
{
    ...
    const volatile uint32_t padding15[31];      /* Reserved */
    const volatile uint32_t padding16[33];      /* Reserved */
          volatile uint32_t NSACR[62];          /* +0x0E00 - RW - Non-Secure Access Control Registers */
    const volatile uint32_t padding17[2];       /* Reserved */
          volatile uint32_t SGIR;               /* +0x0F00 - WO - Software Generated Interrupt Register */
    const volatile uint32_t padding18[3];       /* Reserved */
...
{
    const volatile uint32_t padding0[16];       /* Reserved */
          volatile uint32_t SETSPI_NSR;         /* +0x0040 - WO - Aliased Non-secure SPI Set Register */
    const volatile uint32_t padding1;           /* Reserved */
          volatile uint32_t CLRSPI_NSR;         /* +0x0048 - WO - Aliased Non-secure SPI Clear Register */
    const volatile uint32_t padding2;           /* Reserved */
          volatile uint32_t SETSPI_SR;          /* +0x0050 - WO - Aliased Secure SPI Set Register */
    const volatile uint32_t padding3;           /* Reserved */
          volatile uint32_t CLRSPI_SR;          /* +0x0058 - WO - Aliased Secure SPI Clear Register */
    const volatile uint32_t padding4[16361];    /* Reserved */
};
...
struct gic500_gits_if
{
    ...
    const volatile uint32_t padding0[28];       /* Reserved */
          volatile uint64_t CBASER;             /* +0x0080 - RW - Command Queue Control Register */
          volatile uint64_t CWRITER;            /* +0x0088 - RW - Command Queue Write Pointer Register */
    const volatile uint64_t CREADR;             /* +0x0090 - RO - Command Queue Read Pointer Register */
    const volatile uint32_t padding1[26];       /* Reserved */
    const volatile uint64_t BASER;              /* +0x0100 - RW - ITS Table Control Register */
    const volatile uint32_t padding2[12222];    /* Reserved */
          volatile uint32_t TRKCTLR;            /* +0x0C00 - WO - Tracking Control Register */
    const volatile uint32_t TRKR;               /* +0x0C04 - RO - Tracking Status Register */
    const volatile uint32_t TRKDIDR;            /* +0x0C08 - RO - Debug Tracked DID Register */
    const volatile uint32_t TRKPIDR;            /* +0x0C0C - RO - Debug Tracked PID Register */
    const volatile uint32_t TRKVIDR;            /* +0x0C10 - RO - Debug Tracked VID Register */
    const volatile uint32_t TRKTGTR;            /* +0x0C14 - RO - Debug Tracked Target Register */
    const volatile uint32_t TRKICR;             /* +0x0C18 - RO - Debug ITE Cache Statistics Register */
    const volatile uint32_t TRKLCR;             /* +0x0C1C - RO - Debug LPI Cache Statistics Register */
    const volatile uint32_t padding3[4076];     /* Reserved */
    const volatile uint32_t PIDR4;              /* +0xFFD0 - RO - Peripheral ID 4 Register */
    const volatile uint32_t PIDR5;              /* +0xFFD4 - RO - Peripheral ID 5 Register */
    const volatile uint32_t PIDR6;              /* +0xFFD8 - RO - Peripheral ID 6 Register */
    const volatile uint32_t PIDR7;              /* +0xFFDC - RO - Peripheral ID 7 Register */
...
{
    const volatile uint32_t padding0[16];       /* Reserved */
          volatile uint32_t TRANSLATER;         /* +0x0040 - WO - ITS Translation Register */
    const volatile uint32_t padding3[16367];    /* Reserved */
};
...
typedef struct {
    ...
    const volatile uint8_t padding0[GIC500_PADDING_BYTES];
#endif
...
#endif  /* #if !defined(S32G274_GIC_H_) */
