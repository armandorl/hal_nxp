...
/*!
 * @file S32G274A_FXOSC.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_FXOSC
 *
...
#if !defined(S32G274A_FXOSC_H_)  /* Check if memory map has not been already included */
#define S32G274A_FXOSC_H_
...
#define IP_FXOSC_BASE                            (0x40050000u)
...
#endif  /* #if !defined(S32G274A_FXOSC_H_) */
