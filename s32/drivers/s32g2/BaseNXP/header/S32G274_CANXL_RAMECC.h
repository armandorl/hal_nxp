...
/*!
 * @file S32G274_CANXL_RAMECC.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_RAMECC
 *
...
#if !defined(S32G274_CANXL_RAMECC_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_RAMECC_H_
...
typedef struct CANXL_RAMECC_Struct {
...
#define CANXL_RAMECC_INSTANCE_COUNT              (1u)

/* CANXL_RAMECC - Peripheral instance base addresses */
/** Peripheral CANEXCEL__RAMECC base address */
#define IP_CANEXCEL__RAMECC_BASE                 (0x6A060000u)
/** Peripheral CANEXCEL__RAMECC base pointer */
#define IP_CANEXCEL__RAMECC                      ((CANXL_RAMECC_Type *)IP_CANEXCEL__RAMECC_BASE)
/** Array initializer of CANXL_RAMECC peripheral base addresses */
#define IP_CANXL_RAMECC_BASE_ADDRS               { IP_CANEXCEL__RAMECC_BASE }
/** Array initializer of CANXL_RAMECC peripheral base pointers */
#define IP_CANXL_RAMECC_BASE_PTRS                { IP_CANEXCEL__RAMECC }
...
#endif  /* #if !defined(S32G274_CANXL_RAMECC_H_) */
