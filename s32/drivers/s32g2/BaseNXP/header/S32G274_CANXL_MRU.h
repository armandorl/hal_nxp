...
/*!
 * @file S32G274_CANXL_MRU.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_MRU
 *
...
#if !defined(S32G274_CANXL_MRU_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_MRU_H_
...
typedef struct CANXL_MRU_Struct {
...
#define CANXL_MRU_INSTANCE_COUNT                 (1u)

/* CANXL_MRU - Peripheral instance base addresses */
/** Peripheral CANEXCEL__MRU base address */
#define IP_CANEXCEL__MRU_BASE                    (0x6A027000u)
/** Peripheral CANEXCEL__MRU base pointer */
#define IP_CANEXCEL__MRU                         ((CANXL_MRU_Type *)IP_CANEXCEL__MRU_BASE)
/** Array initializer of CANXL_MRU peripheral base addresses */
#define IP_CANXL_MRU_BASE_ADDRS                  { IP_CANEXCEL__MRU_BASE }
/** Array initializer of CANXL_MRU peripheral base pointers */
#define IP_CANXL_MRU_BASE_PTRS                   { IP_CANEXCEL__MRU }
...
#endif  /* #if !defined(S32G274_CANXL_MRU_H_) */
