 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_STM
 *
...
#if !defined(S32G274A_STM_H_)  /* Check if memory map has not been already included */
#define S32G274A_STM_H_
...
#define IP_STM_BASE_ADDRS                        { IP_STM_0_BASE, IP_STM_1_BASE, IP_STM_2_BASE, IP_STM_3_BASE, IP_STM_4_BASE, IP_STM_5_BASE, IP_STM_6_BASE, IP_STM_7_BASE, IP_STM_TS_BASE }
/** Array initializer of STM peripheral base pointers */
#define IP_STM_BASE_PTRS                         { IP_STM_0, IP_STM_1, IP_STM_2, IP_STM_3, IP_STM_4, IP_STM_5, IP_STM_6, IP_STM_7, IP_STM_TS }
...
#endif  /* #if !defined(S32G274A_STM_H_) */
