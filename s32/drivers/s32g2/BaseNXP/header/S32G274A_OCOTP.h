...
/*!
 * @file S32G274A_OCOTP.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_OCOTP
 *
...
#if !defined(S32G274A_OCOTP_H_)  /* Check if memory map has not been already included */
#define S32G274A_OCOTP_H_
...
#define IP_OCOTP_BASE                            (0x400A4000u)
...
#endif  /* #if !defined(S32G274A_OCOTP_H_) */
