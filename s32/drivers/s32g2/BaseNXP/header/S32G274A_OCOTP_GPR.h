...
/*!
 * @file S32G274A_ocotp_gpr.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_ocotp_gpr
 *
...
#if !defined(S32G274A_ocotp_gpr_H_)  /* Check if memory map has not been already included */
#define S32G274A_ocotp_gpr_H_
...
#endif  /* #if !defined(S32G274A_ocotp_gpr_H_) */
