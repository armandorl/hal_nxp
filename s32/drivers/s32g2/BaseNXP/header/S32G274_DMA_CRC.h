...
/*!
 * @file S32G274_DMA_CRC.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_DMA_CRC
 *
...
#if !defined(S32G274_DMA_CRC_H_)  /* Check if memory map has not been already included */
#define S32G274_DMA_CRC_H_
...
#define DMA_CRC_INSTANCE_COUNT                   (1u)

/* DMA_CRC - Peripheral instance base addresses */
/** Peripheral DMA_CRC base address */
#define IP_DMA_CRC_BASE                          (0x40454000u)
/** Peripheral DMA_CRC base pointer */
#define IP_DMA_CRC                               ((DMA_CRC_Type *)IP_DMA_CRC_BASE)
/** Array initializer of DMA_CRC peripheral base addresses */
#define IP_DMA_CRC_BASE_ADDRS                    { IP_DMA_CRC_BASE }
/** Array initializer of DMA_CRC peripheral base pointers */
#define IP_DMA_CRC_BASE_PTRS                     { IP_DMA_CRC }
...
#define DMA_CRC_CTL_CH_SEL_MASK                  (0x1FU)
...
#endif  /* #if !defined(S32G274_DMA_CRC_H_) */
