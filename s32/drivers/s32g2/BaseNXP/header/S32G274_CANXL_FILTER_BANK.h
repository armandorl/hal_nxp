...
/*!
 * @file S32G274_CANXL_FILTER_BANK.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_FILTER_BANK
 *
...
#if !defined(S32G274_CANXL_FILTER_BANK_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_FILTER_BANK_H_
...
typedef struct CANXL_FILTER_BANK_Struct {
...
#define CANXL_FILTER_BANK_INSTANCE_COUNT         (1u)

/* CANXL_FILTER_BANK - Peripheral instance base addresses */
/** Peripheral CANEXCEL__FILTER_BANK base address */
#define IP_CANEXCEL__FILTER_BANK_BASE            (0x6A022000u)
/** Peripheral CANEXCEL__FILTER_BANK base pointer */
#define IP_CANEXCEL__FILTER_BANK                 ((CANXL_FILTER_BANK_Type *)IP_CANEXCEL__FILTER_BANK_BASE)
/** Array initializer of CANXL_FILTER_BANK peripheral base addresses */
#define IP_CANXL_FILTER_BANK_BASE_ADDRS          { IP_CANEXCEL__FILTER_BANK_BASE }
/** Array initializer of CANXL_FILTER_BANK peripheral base pointers */
#define IP_CANXL_FILTER_BANK_BASE_PTRS           { IP_CANEXCEL__FILTER_BANK }
...
#endif  /* #if !defined(S32G274_CANXL_FILTER_BANK_H_) */
