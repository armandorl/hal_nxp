...
/*!
 * @file S32G274A_STCU2.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_STCU2
 *
...
#if !defined(S32G274A_STCU2_H_)  /* Check if memory map has not been already included */
#define S32G274A_STCU2_H_
...
#define STCU2_BSTART_BSTART_MASK                 (0x7U)
#define STCU2_BSTART_BSTART_SHIFT                (0U)
#define STCU2_BSTART_BSTART_WIDTH                (3U)
#define STCU2_BSTART_BSTART(x)                   (((uint32_t)(((uint32_t)(x)) << STCU2_BSTART_BSTART_SHIFT)) & STCU2_BSTART_BSTART_MASK)

#define STCU2_BSTART_BSR_MASK                    (0x10U)
#define STCU2_BSTART_BSR_SHIFT                   (4U)
#define STCU2_BSTART_BSR_WIDTH                   (1U)
#define STCU2_BSTART_BSR(x)                      (((uint32_t)(((uint32_t)(x)) << STCU2_BSTART_BSR_SHIFT)) & STCU2_BSTART_BSR_MASK)

#define STCU2_BSTART_CLKEN_MASK                  (0x80000000U)
#define STCU2_BSTART_CLKEN_SHIFT                 (31U)
#define STCU2_BSTART_CLKEN_WIDTH                 (1U)
#define STCU2_BSTART_CLKEN(x)                    (((uint32_t)(((uint32_t)(x)) << STCU2_BSTART_CLKEN_SHIFT)) & STCU2_BSTART_CLKEN_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274A_STCU2_H_) */
