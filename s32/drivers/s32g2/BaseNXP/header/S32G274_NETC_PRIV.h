...
/*!
 * @file S32G274_NETC_PRIV.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_NETC_PRIV
 *
...
#if !defined(S32G274_NETC_PRIV_H_)  /* Check if memory map has not been already included */
#define S32G274_NETC_PRIV_H_
...
typedef struct NETC_PRIV_Struct {
...
#define IP_NETC__NETC_PRIV_BASE                  (0x6D210000u)
...
#define NETC_PRIV_IEICR0_LINK_SLICE_ID_MASK      (0x1FU)
#define NETC_PRIV_IEICR0_LINK_SLICE_ID_SHIFT     (0U)
#define NETC_PRIV_IEICR0_LINK_SLICE_ID_WIDTH     (5U)
...
#define NETC_PRIV_IEICR0_BLOCK_ID_MASK           (0x1F00U)
#define NETC_PRIV_IEICR0_BLOCK_ID_SHIFT          (8U)
#define NETC_PRIV_IEICR0_BLOCK_ID_WIDTH          (5U)
#define NETC_PRIV_IEICR0_BLOCK_ID(x)             (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_IEICR0_BLOCK_ID_SHIFT)) & NETC_PRIV_IEICR0_BLOCK_ID_MASK)

#define NETC_PRIV_IEICR0_SM_ID_MASK              (0x3F0000U)
#define NETC_PRIV_IEICR0_SM_ID_SHIFT             (16U)
...
#define NETC_PRIV_IEICR0_ENGINE_ID_MASK          (0x1000000U)
#define NETC_PRIV_IEICR0_ENGINE_ID_SHIFT         (24U)
...
#define NETC_PRIV_IEICR0_ARM_MASK                (0x80000000U)
#define NETC_PRIV_IEICR0_ARM_SHIFT               (31U)
...
#define NETC_PRIV_MEICR_LINK_ID_WIDTH            (5U)
...
#define NETC_PRIV_EICR_EN_WIDTH                  (8U)
...
#define NETC_PRIV_CMESR_LINK_SLICE_ID_WIDTH      (5U)
...
#define NETC_PRIV_CMESR_LE_WIDTH                 (1U)
...
#define NETC_PRIV_UNMESR0_LINK_SLICE_ID_WIDTH    (5U)
...
#define NETC_PRIV_UNMESR0_LE_WIDTH               (1U)
...
#define NETC_PRIV_UFMESR0_LINK_SLICE_ID_WIDTH    (5U)
...
#define NETC_PRIV_UFMESR0_EDCE_MASK              (0x8000U)
#define NETC_PRIV_UFMESR0_EDCE_SHIFT             (15U)
#define NETC_PRIV_UFMESR0_EDCE_WIDTH             (1U)
#define NETC_PRIV_UFMESR0_EDCE(x)                (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_UFMESR0_EDCE_SHIFT)) & NETC_PRIV_UFMESR0_EDCE_MASK)
...
#define NETC_PRIV_UFMESR0_LE_WIDTH               (1U)
...
#define NETC_PRIV_UNIESR_LINK_SLICE_ID_MASK      (0x1FU)
#define NETC_PRIV_UNIESR_LINK_SLICE_ID_SHIFT     (0U)
#define NETC_PRIV_UNIESR_LINK_SLICE_ID_WIDTH     (5U)
...
#define NETC_PRIV_UNIESR_BLOCK_ID_MASK           (0x1F00U)
#define NETC_PRIV_UNIESR_BLOCK_ID_SHIFT          (8U)
#define NETC_PRIV_UNIESR_BLOCK_ID_WIDTH          (5U)
#define NETC_PRIV_UNIESR_BLOCK_ID(x)             (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_UNIESR_BLOCK_ID_SHIFT)) & NETC_PRIV_UNIESR_BLOCK_ID_MASK)

#define NETC_PRIV_UNIESR_SM_ID_MASK              (0x3F0000U)
#define NETC_PRIV_UNIESR_SM_ID_SHIFT             (16U)
...
#define NETC_PRIV_UNIESR_ENGINE_ID_MASK          (0x1000000U)
#define NETC_PRIV_UNIESR_ENGINE_ID_SHIFT         (24U)
...
#define NETC_PRIV_UNIESR_LE_MASK                 (0x20000000U)
#define NETC_PRIV_UNIESR_LE_SHIFT                (29U)
#define NETC_PRIV_UNIESR_LE_WIDTH                (1U)
#define NETC_PRIV_UNIESR_LE(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_UNIESR_LE_SHIFT)) & NETC_PRIV_UNIESR_LE_MASK)
...
#define NETC_PRIV_UFIESR_LINK_SLICE_ID_MASK      (0x1FU)
#define NETC_PRIV_UFIESR_LINK_SLICE_ID_SHIFT     (0U)
#define NETC_PRIV_UFIESR_LINK_SLICE_ID_WIDTH     (5U)
...
#define NETC_PRIV_UFIESR_BLOCK_ID_MASK           (0x1F00U)
#define NETC_PRIV_UFIESR_BLOCK_ID_SHIFT          (8U)
#define NETC_PRIV_UFIESR_BLOCK_ID_WIDTH          (5U)
#define NETC_PRIV_UFIESR_BLOCK_ID(x)             (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_UFIESR_BLOCK_ID_SHIFT)) & NETC_PRIV_UFIESR_BLOCK_ID_MASK)

#define NETC_PRIV_UFIESR_SM_ID_MASK              (0x3F0000U)
#define NETC_PRIV_UFIESR_SM_ID_SHIFT             (16U)
...
#define NETC_PRIV_UFIESR_ENGINE_ID_MASK          (0x1000000U)
#define NETC_PRIV_UFIESR_ENGINE_ID_SHIFT         (24U)
...
#define NETC_PRIV_UFIESR_LE_MASK                 (0x20000000U)
#define NETC_PRIV_UFIESR_LE_SHIFT                (29U)
#define NETC_PRIV_UFIESR_LE_WIDTH                (1U)
#define NETC_PRIV_UFIESR_LE(x)                   (((uint32_t)(((uint32_t)(x)) << NETC_PRIV_UFIESR_LE_SHIFT)) & NETC_PRIV_UFIESR_LE_MASK)
...
#endif  /* #if !defined(S32G274_NETC_PRIV_H_) */
