 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_XBIC
 *
...
#if !defined(S32G274_XBIC_H_)  /* Check if memory map has not been already included */
#define S32G274_XBIC_H_
...
typedef struct XBIC_Struct {
  __IO uint32_t MCR;                               /**< XBIC Module Control, offset: 0x0 */
  __IO uint32_t EIR;                               /**< XBIC Error Injection Attributes, offset: 0x4 */
  __IO uint32_t EIR_SYN;                           /**< XBIC Error Injection Syndrome, offset: 0x8 */
  __IO uint32_t ESR;                               /**< XBIC Error Status Attributes, offset: 0xC */
  __I  uint32_t ESR_SYN;                           /**< XBIC Error Status Syndrome, offset: 0x10 */
  __I  uint32_t EAR;                               /**< XBIC Error Address, offset: 0x14 */
...
/** Peripheral LPE_XBIC base address */
#define IP_LPE_XBIC_BASE                         (0x42000000u)
/** Peripheral LPE_XBIC base pointer */
#define IP_LPE_XBIC                              ((XBIC_Type *)IP_LPE_XBIC_BASE)
/** Peripheral XBIC_AUX base address */
#define IP_XBIC_AUX_BASE                         (0x40400000u)
/** Peripheral XBIC_AUX base pointer */
#define IP_XBIC_AUX                              ((XBIC_Type *)IP_XBIC_AUX_BASE)
/** Peripheral XBIC_PER base address */
#define IP_XBIC_PER_BASE                         (0x40404000u)
/** Peripheral XBIC_PER base pointer */
#define IP_XBIC_PER                              ((XBIC_Type *)IP_XBIC_PER_BASE)
/** Peripheral XBIC_TCM base address */
#define IP_XBIC_TCM_BASE                         (0x40A04000u)
/** Peripheral XBIC_TCM base pointer */
#define IP_XBIC_TCM                              ((XBIC_Type *)IP_XBIC_TCM_BASE)
/** Array initializer of XBIC peripheral base addresses */
#define IP_XBIC_BASE_ADDRS                       { IP_LPE_XBIC_BASE, IP_XBIC_AUX_BASE, IP_XBIC_PER_BASE, IP_XBIC_TCM_BASE }
/** Array initializer of XBIC peripheral base pointers */
#define IP_XBIC_BASE_PTRS                        { IP_LPE_XBIC, IP_XBIC_AUX, IP_XBIC_PER, IP_XBIC_TCM }
...
#define XBIC_EIR_MST_MASK                        (0x3FU)
#define XBIC_EIR_MST_SHIFT                       (0U)
#define XBIC_EIR_MST_WIDTH                       (6U)
#define XBIC_EIR_MST(x)                          (((uint32_t)(((uint32_t)(x)) << XBIC_EIR_MST_SHIFT)) & XBIC_EIR_MST_MASK)

#define XBIC_EIR_SLV_MASK                        (0x700U)
#define XBIC_EIR_SLV_SHIFT                       (8U)
...
/*! @name EIR_SYN - XBIC Error Injection Syndrome */
/*! @{ */

#define XBIC_EIR_SYN_SYN_MASK                    (0xFFU)
#define XBIC_EIR_SYN_SYN_SHIFT                   (0U)
#define XBIC_EIR_SYN_SYN_WIDTH                   (8U)
#define XBIC_EIR_SYN_SYN(x)                      (((uint32_t)(((uint32_t)(x)) << XBIC_EIR_SYN_SYN_SHIFT)) & XBIC_EIR_SYN_SYN_MASK)
/*! @} */

/*! @name ESR - XBIC Error Status Attributes */
/*! @{ */

#define XBIC_ESR_MST_MASK                        (0x3FU)
#define XBIC_ESR_MST_SHIFT                       (0U)
#define XBIC_ESR_MST_WIDTH                       (6U)
#define XBIC_ESR_MST(x)                          (((uint32_t)(((uint32_t)(x)) << XBIC_ESR_MST_SHIFT)) & XBIC_ESR_MST_MASK)

#define XBIC_ESR_SLV_MASK                        (0x700U)
#define XBIC_ESR_SLV_SHIFT                       (8U)
...
/*! @name ESR_SYN - XBIC Error Status Syndrome */
/*! @{ */

#define XBIC_ESR_SYN_SYN_MASK                    (0xFFU)
#define XBIC_ESR_SYN_SYN_SHIFT                   (0U)
#define XBIC_ESR_SYN_SYN_WIDTH                   (8U)
#define XBIC_ESR_SYN_SYN(x)                      (((uint32_t)(((uint32_t)(x)) << XBIC_ESR_SYN_SYN_SHIFT)) & XBIC_ESR_SYN_SYN_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274_XBIC_H_) */
