...
/*!
 * @file S32G399A_PCIE_RC.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_PCIE_RC
 *
...
#if !defined(S32G399A_PCIE_RC_H_)  /* Check if memory map has not been already included */
#define S32G399A_PCIE_RC_H_
...
#define IP_PCIE_RC_BASE                          (0x40400000u)
...
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9_MASK (0x200U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9_SHIFT (9U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9_WIDTH (1U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9_SHIFT)) & PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_9_MASK)
...
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17_MASK (0x60000U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17_SHIFT (17U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17_WIDTH (2U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17_SHIFT)) & PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_17_MASK)
...
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22_MASK (0x400000U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22_SHIFT (22U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22_WIDTH (1U)
#define PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22_SHIFT)) & PCIE_RC_TYPE1_STATUS_COMMAND_REG_RSVDP_22_MASK)
...
#define PCIE_RC_BAR0_REG_BAR0_MEM_IO_WIDTH       (1U)
...
#define PCIE_RC_BAR0_REG_BAR0_TYPE_WIDTH         (2U)
...
#define PCIE_RC_BAR0_REG_BAR0_PREFETCH_WIDTH     (1U)
...
#define PCIE_RC_BAR0_REG_BAR0_START_WIDTH        (28U)
...
#define PCIE_RC_BAR1_REG_BAR1_MEM_IO_WIDTH       (1U)
...
#define PCIE_RC_BAR1_REG_BAR1_TYPE_WIDTH         (2U)
...
#define PCIE_RC_BAR1_REG_BAR1_PREFETCH_WIDTH     (1U)
...
#define PCIE_RC_BAR1_REG_BAR1_START_WIDTH        (28U)
...
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23_SHIFT (23U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23_WIDTH (1U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23_SHIFT)) & PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_23_MASK)
...
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25_MASK (0x6000000U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25_SHIFT (25U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25_WIDTH (2U)
#define PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25_SHIFT)) & PCIE_RC_SEC_STAT_IO_LIMIT_IO_BASE_REG_RSVDP_25_MASK)
...
#define PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8_MASK   (0xFFFFFF00U)
#define PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8_SHIFT  (8U)
#define PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8_WIDTH  (24U)
#define PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8_SHIFT)) & PCIE_RC_TYPE1_CAP_PTR_REG_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_ROM_BAR_VALIDATION_STATUS_WIDTH (3U)
...
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_ROM_BAR_VALIDATION_DETAILS_WIDTH (4U)
...
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8_MASK (0x700U)
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8_SHIFT (8U)
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8_WIDTH (3U)
#define PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8_SHIFT)) & PCIE_RC_TYPE1_EXP_ROM_BASE_REG_RSVDP_8_MASK)
...
#define PCIE_RC_CON_STATUS_REG_RSVDP_2_MASK      (0x4U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_2_SHIFT     (2U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_2_WIDTH     (1U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_2(x)        (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CON_STATUS_REG_RSVDP_2_SHIFT)) & PCIE_RC_CON_STATUS_REG_RSVDP_2_MASK)
...
#define PCIE_RC_CON_STATUS_REG_RSVDP_4_MASK      (0xF0U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_4_SHIFT     (4U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_4_WIDTH     (4U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_4(x)        (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CON_STATUS_REG_RSVDP_4_SHIFT)) & PCIE_RC_CON_STATUS_REG_RSVDP_4_MASK)
...
#define PCIE_RC_CON_STATUS_REG_RSVDP_16_MASK     (0x3F0000U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_16_SHIFT    (16U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_16_WIDTH    (6U)
#define PCIE_RC_CON_STATUS_REG_RSVDP_16(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CON_STATUS_REG_RSVDP_16_SHIFT)) & PCIE_RC_CON_STATUS_REG_RSVDP_16_MASK)
...
#define PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27_MASK (0xF8000000U)
#define PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27_SHIFT (27U)
#define PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27_WIDTH (5U)
#define PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27_SHIFT)) & PCIE_RC_PCI_MSI_CAP_ID_NEXT_CTRL_REG_RSVDP_27_MASK)
/*! @} */

/*! @name MSI_CAP_OFF_04H_REG - Message Address Register for MSI (Offset 04h). */
/*! @{ */

#define PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0_MASK (0x3U)
#define PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0_SHIFT (0U)
#define PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0_WIDTH (2U)
#define PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0_SHIFT)) & PCIE_RC_MSI_CAP_OFF_04H_REG_RSVDP_0_MASK)
...
#define PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31_SHIFT (31U)
#define PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31_WIDTH (1U)
#define PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31_SHIFT)) & PCIE_RC_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6_MASK (0x7FC0U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6_SHIFT (6U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6_WIDTH (9U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6_SHIFT)) & PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_6_MASK)
...
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16_SHIFT (16U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16_WIDTH (16U)
#define PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16_SHIFT)) & PCIE_RC_DEVICE_CAPABILITIES_REG_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22_MASK (0xFFC00000U)
#define PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22_SHIFT (22U)
#define PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22_WIDTH (10U)
#define PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22_SHIFT)) & PCIE_RC_DEVICE_CONTROL_DEVICE_STATUS_RSVDP_22_MASK)
/*! @} */
...
#define PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23_SHIFT (23U)
#define PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23_WIDTH (1U)
#define PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23_SHIFT)) & PCIE_RC_LINK_CAPABILITIES_REG_RSVDP_23_MASK)
...
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2_MASK (0x4U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2_SHIFT (2U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2_WIDTH (1U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2_SHIFT)) & PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_2_MASK)
...
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12_MASK (0x3000U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12_SHIFT (12U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12_WIDTH (2U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12_SHIFT)) & PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_12_MASK)
...
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26_MASK (0x4000000U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26_SHIFT (26U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26_WIDTH (1U)
#define PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26_SHIFT)) & PCIE_RC_LINK_CONTROL_LINK_STATUS_REG_RSVDP_26_MASK)
...
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14_MASK (0xC000U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14_SHIFT (14U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14_WIDTH (2U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14_SHIFT)) & PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_14_MASK)
...
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25_MASK (0xFE000000U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25_SHIFT (25U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25_WIDTH (7U)
#define PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25_SHIFT)) & PCIE_RC_SLOT_CONTROL_SLOT_STATUS_RSVDP_25_MASK)
/*! @} */
...
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5_MASK (0xFFE0U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5_SHIFT (5U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5_WIDTH (11U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5_SHIFT)) & PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_5_MASK)
...
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17_MASK (0xFFFE0000U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17_SHIFT (17U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17_WIDTH (15U)
#define PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17_SHIFT)) & PCIE_RC_ROOT_CONTROL_ROOT_CAPABILITIES_REG_RSVDP_17_MASK)
/*! @} */
...
#define PCIE_RC_ROOT_STATUS_REG_RSVDP_18_MASK    (0xFFFC0000U)
#define PCIE_RC_ROOT_STATUS_REG_RSVDP_18_SHIFT   (18U)
#define PCIE_RC_ROOT_STATUS_REG_RSVDP_18_WIDTH   (14U)
#define PCIE_RC_ROOT_STATUS_REG_RSVDP_18(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ROOT_STATUS_REG_RSVDP_18_SHIFT)) & PCIE_RC_ROOT_STATUS_REG_RSVDP_18_MASK)
/*! @} */
...
#define PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24_MASK (0x7F000000U)
#define PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24_SHIFT (24U)
#define PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24_WIDTH (7U)
#define PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24_SHIFT)) & PCIE_RC_DEVICE_CAPABILITIES2_REG_RSVDP_24_MASK)
/*! @} */
...
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0_MASK (0x1U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0_SHIFT (0U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0_WIDTH (1U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0_SHIFT)) & PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_0_MASK)
...
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9_MASK (0x7FFE00U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9_SHIFT (9U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9_WIDTH (14U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9_SHIFT)) & PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_9_MASK)

#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25_MASK (0x7E000000U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25_SHIFT (25U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25_WIDTH (6U)
#define PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25_SHIFT)) & PCIE_RC_LINK_CAPABILITIES2_REG_RSVDP_25_MASK)
/*! @} */
...
#define PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26_MASK (0xC000000U)
#define PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26_SHIFT (26U)
#define PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26_WIDTH (2U)
#define PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26_SHIFT)) & PCIE_RC_LINK_CONTROL2_LINK_STATUS2_REG_RSVDP_26_MASK)
/*! @} */
...
#define PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27_MASK (0x38000000U)
#define PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27_SHIFT (27U)
#define PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27_WIDTH (3U)
#define PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27_SHIFT)) & PCIE_RC_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_RSVDP_27_MASK)
...
#define PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_MASK (0x7U)
#define PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_SHIFT (0U)
#define PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_WIDTH (3U)
#define PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_SHIFT)) & PCIE_RC_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_MASK)
...
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0_MASK (0xFU)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0_WIDTH (4U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0_SHIFT)) & PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6_MASK (0xFC0U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6_SHIFT (6U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6_WIDTH (6U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6_SHIFT)) & PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_6_MASK)
...
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23_SHIFT (23U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23_WIDTH (1U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23_SHIFT)) & PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_23_MASK)

#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27_MASK (0xF8000000U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27_WIDTH (5U)
#define PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27_SHIFT)) & PCIE_RC_UNCORR_ERR_STATUS_OFF_RSVDP_27_MASK)
/*! @} */

/*! @name UNCORR_ERR_MASK_OFF - Uncorrectable Error Mask Register. */
/*! @{ */

#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0_MASK (0xFU)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0_WIDTH (4U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0_SHIFT)) & PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6_MASK (0xFC0U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6_SHIFT (6U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6_WIDTH (6U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6_SHIFT)) & PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_6_MASK)
...
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23_SHIFT (23U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23_WIDTH (1U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23_SHIFT)) & PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_23_MASK)

#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27_MASK (0xF8000000U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27_WIDTH (5U)
#define PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27_SHIFT)) & PCIE_RC_UNCORR_ERR_MASK_OFF_RSVDP_27_MASK)
/*! @} */

/*! @name UNCORR_ERR_SEV_OFF - Uncorrectable Error Severity Register. */
/*! @{ */

#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0_MASK  (0xFU)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0_WIDTH (4U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0_SHIFT)) & PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6_MASK  (0xFC0U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6_SHIFT (6U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6_WIDTH (6U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6_SHIFT)) & PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_6_MASK)
...
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23_SHIFT (23U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23_WIDTH (1U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23_SHIFT)) & PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_23_MASK)

#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27_MASK (0xF8000000U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27_WIDTH (5U)
#define PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27_SHIFT)) & PCIE_RC_UNCORR_ERR_SEV_OFF_RSVDP_27_MASK)
/*! @} */
...
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1_MASK (0x3EU)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1_WIDTH (5U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1_SHIFT)) & PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9_MASK (0xE00U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9_SHIFT (9U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9_WIDTH (3U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9_SHIFT)) & PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_9_MASK)
...
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16_SHIFT)) & PCIE_RC_CORR_ERR_STATUS_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1_MASK   (0x3EU)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1_SHIFT  (1U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1_WIDTH  (5U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1_SHIFT)) & PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9_MASK   (0xE00U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9_SHIFT  (9U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9_WIDTH  (3U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9_SHIFT)) & PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_9_MASK)
...
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16_MASK  (0xFFFF0000U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16_SHIFT)) & PCIE_RC_CORR_ERR_MASK_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_ADV_ERR_CAP_CTRL_OFF_CTO_PRFX_HDR_LOG_CAP_WIDTH (1U)
...
#define PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13_MASK (0xFFFFE000U)
#define PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13_SHIFT (13U)
#define PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13_WIDTH (19U)
#define PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13_SHIFT)) & PCIE_RC_ADV_ERR_CAP_CTRL_OFF_RSVDP_13_MASK)
/*! @} */
...
#define PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3_MASK    (0xFFFFFFF8U)
#define PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3_SHIFT   (3U)
#define PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3_WIDTH   (29U)
#define PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3_SHIFT)) & PCIE_RC_ROOT_ERR_CMD_OFF_RSVDP_3_MASK)
/*! @} */
...
#define PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7_MASK (0x7FFFF80U)
#define PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7_SHIFT (7U)
#define PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7_WIDTH (20U)
#define PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7_SHIFT)) & PCIE_RC_ROOT_ERR_STATUS_OFF_RSVDP_7_MASK)
...
#define PCIE_RC_LINK_CONTROL3_REG_RSVDP_2_MASK   (0xFFFFFFFCU)
#define PCIE_RC_LINK_CONTROL3_REG_RSVDP_2_SHIFT  (2U)
#define PCIE_RC_LINK_CONTROL3_REG_RSVDP_2_WIDTH  (30U)
#define PCIE_RC_LINK_CONTROL3_REG_RSVDP_2(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_CONTROL3_REG_RSVDP_2_SHIFT)) & PCIE_RC_LINK_CONTROL3_REG_RSVDP_2_MASK)
/*! @} */
...
#define PCIE_RC_LANE_ERR_STATUS_REG_RSVDP_LANE_ERR_STATUS_WIDTH (30U)
...
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7_MASK (0x80U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7_SHIFT (7U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7_WIDTH (1U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7_SHIFT)) & PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_7_MASK)
...
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15_MASK (0x8000U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15_SHIFT (15U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15_WIDTH (1U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15_SHIFT)) & PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_15_MASK)
...
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23_SHIFT (23U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23_WIDTH (1U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23_SHIFT)) & PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_23_MASK)
...
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31_SHIFT (31U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31_WIDTH (1U)
#define PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31_SHIFT)) & PCIE_RC_SPCIE_CAP_OFF_0CH_REG_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5_MASK (0x60U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5_SHIFT (5U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5_WIDTH (2U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5_SHIFT)) & PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_5_MASK)
...
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12_MASK (0xF000U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12_SHIFT (12U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12_WIDTH (4U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12_SHIFT)) & PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_12_MASK)
...
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28_MASK (0xF0000000U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28_SHIFT (28U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28_WIDTH (4U)
#define PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28_SHIFT)) & PCIE_RC_EVENT_COUNTER_CONTROL_REG_RSVDP_28_MASK)
/*! @} */
...
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1_MASK (0xFEU)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1_SHIFT (1U)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1_WIDTH (7U)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1_SHIFT)) & PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_1_MASK)
...
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16_MASK (0xFF0000U)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16_SHIFT (16U)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16_WIDTH (8U)
#define PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16_SHIFT)) & PCIE_RC_TIME_BASED_ANALYSIS_CONTROL_REG_RSVDP_16_MASK)
...
#define PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32_MASK (0xFFFFFFFFU)
#define PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32_SHIFT (0U)
#define PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32_WIDTH (32U)
#define PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32_SHIFT)) & PCIE_RC_TIME_BASED_ANALYSIS_DATA_63_32_REG_TIME_BASED_ANALYSIS_DATA_63_32_MASK)
/*! @} */
...
#define PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE_MASK (0x40U)
#define PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE_SHIFT (6U)
#define PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE_WIDTH (1U)
#define PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE_SHIFT)) & PCIE_RC_EINJ_ENABLE_REG_ERROR_INJECTION6_ENABLE_MASK)

#define PCIE_RC_EINJ_ENABLE_REG_RSVDP_7_MASK     (0xFFFFFF80U)
#define PCIE_RC_EINJ_ENABLE_REG_RSVDP_7_SHIFT    (7U)
#define PCIE_RC_EINJ_ENABLE_REG_RSVDP_7_WIDTH    (25U)
#define PCIE_RC_EINJ_ENABLE_REG_RSVDP_7(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ_ENABLE_REG_RSVDP_7_SHIFT)) & PCIE_RC_EINJ_ENABLE_REG_RSVDP_7_MASK)
/*! @} */
...
#define PCIE_RC_EINJ0_CRC_REG_RSVDP_12_MASK      (0xFFFFF000U)
#define PCIE_RC_EINJ0_CRC_REG_RSVDP_12_SHIFT     (12U)
#define PCIE_RC_EINJ0_CRC_REG_RSVDP_12_WIDTH     (20U)
#define PCIE_RC_EINJ0_CRC_REG_RSVDP_12(x)        (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ0_CRC_REG_RSVDP_12_SHIFT)) & PCIE_RC_EINJ0_CRC_REG_RSVDP_12_MASK)
/*! @} */
...
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9_MASK    (0xFE00U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9_SHIFT   (9U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9_WIDTH   (7U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9_SHIFT)) & PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_9_MASK)
...
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29_MASK   (0xE0000000U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29_SHIFT  (29U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29_WIDTH  (3U)
#define PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29_SHIFT)) & PCIE_RC_EINJ1_SEQNUM_REG_RSVDP_29_MASK)
/*! @} */
...
#define PCIE_RC_EINJ2_DLLP_REG_RSVDP_10_MASK     (0xFFFFFC00U)
#define PCIE_RC_EINJ2_DLLP_REG_RSVDP_10_SHIFT    (10U)
#define PCIE_RC_EINJ2_DLLP_REG_RSVDP_10_WIDTH    (22U)
#define PCIE_RC_EINJ2_DLLP_REG_RSVDP_10(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ2_DLLP_REG_RSVDP_10_SHIFT)) & PCIE_RC_EINJ2_DLLP_REG_RSVDP_10_MASK)
/*! @} */
...
#define PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11_MASK   (0xFFFFF800U)
#define PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11_SHIFT  (11U)
#define PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11_WIDTH  (21U)
#define PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11_SHIFT)) & PCIE_RC_EINJ3_SYMBOL_REG_RSVDP_11_MASK)
/*! @} */
...
#define PCIE_RC_EINJ4_FC_REG_RSVDP_11_MASK       (0x800U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_11_SHIFT      (11U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_11_WIDTH      (1U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_11(x)         (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ4_FC_REG_RSVDP_11_SHIFT)) & PCIE_RC_EINJ4_FC_REG_RSVDP_11_MASK)
...
#define PCIE_RC_EINJ4_FC_REG_RSVDP_15_MASK       (0x8000U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_15_SHIFT      (15U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_15_WIDTH      (1U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_15(x)         (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ4_FC_REG_RSVDP_15_SHIFT)) & PCIE_RC_EINJ4_FC_REG_RSVDP_15_MASK)
...
#define PCIE_RC_EINJ4_FC_REG_RSVDP_29_MASK       (0xE0000000U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_29_SHIFT      (29U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_29_WIDTH      (3U)
#define PCIE_RC_EINJ4_FC_REG_RSVDP_29(x)         (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ4_FC_REG_RSVDP_29_SHIFT)) & PCIE_RC_EINJ4_FC_REG_RSVDP_29_MASK)
/*! @} */
...
#define PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9_MASK    (0xFFFFFE00U)
#define PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9_SHIFT   (9U)
#define PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9_WIDTH   (23U)
#define PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9_SHIFT)) & PCIE_RC_EINJ5_SP_TLP_REG_RSVDP_9_MASK)
/*! @} */
...
#define PCIE_RC_EINJ6_TLP_REG_RSVDP_12_MASK      (0xFFFFF000U)
#define PCIE_RC_EINJ6_TLP_REG_RSVDP_12_SHIFT     (12U)
#define PCIE_RC_EINJ6_TLP_REG_RSVDP_12_WIDTH     (20U)
#define PCIE_RC_EINJ6_TLP_REG_RSVDP_12(x)        (((uint32_t)(((uint32_t)(x)) << PCIE_RC_EINJ6_TLP_REG_RSVDP_12_SHIFT)) & PCIE_RC_EINJ6_TLP_REG_RSVDP_12_MASK)
/*! @} */
...
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_17_MASK    (0xE0000U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_17_SHIFT   (17U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_17_WIDTH   (3U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_17(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_CONTROL1_REG_RSVDP_17_SHIFT)) & PCIE_RC_SD_CONTROL1_REG_RSVDP_17_MASK)
...
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_24_MASK    (0xFF000000U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_24_SHIFT   (24U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_24_WIDTH   (8U)
#define PCIE_RC_SD_CONTROL1_REG_RSVDP_24(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_CONTROL1_REG_RSVDP_24_SHIFT)) & PCIE_RC_SD_CONTROL1_REG_RSVDP_24_MASK)
/*! @} */
...
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_3_MASK     (0xF8U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_3_SHIFT    (3U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_3_WIDTH    (5U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_3(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_CONTROL2_REG_RSVDP_3_SHIFT)) & PCIE_RC_SD_CONTROL2_REG_RSVDP_3_MASK)
...
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_11_MASK    (0xF800U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_11_SHIFT   (11U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_11_WIDTH   (5U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_11(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_CONTROL2_REG_RSVDP_11_SHIFT)) & PCIE_RC_SD_CONTROL2_REG_RSVDP_11_MASK)
...
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_17_MASK    (0xFFFE0000U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_17_SHIFT   (17U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_17_WIDTH   (15U)
#define PCIE_RC_SD_CONTROL2_REG_RSVDP_17(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_CONTROL2_REG_RSVDP_17_SHIFT)) & PCIE_RC_SD_CONTROL2_REG_RSVDP_17_MASK)
/*! @} */
...
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4_MASK (0xFFF0U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4_SHIFT (4U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4_WIDTH (12U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4_SHIFT)) & PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_4_MASK)
...
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21_MASK (0xE00000U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21_SHIFT (21U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21_WIDTH (3U)
#define PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21_SHIFT)) & PCIE_RC_SD_STATUS_L1LANE_REG_RSVDP_21_MASK)
...
#define PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11_MASK (0x7800U)
#define PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11_SHIFT (11U)
#define PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11_WIDTH (4U)
#define PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11_SHIFT)) & PCIE_RC_SD_STATUS_L1LTSSM_REG_RSVDP_11_MASK)
...
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_5_MASK    (0xE0U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_5_SHIFT   (5U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_5_WIDTH   (3U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_5(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_PM_REG_RSVDP_5_SHIFT)) & PCIE_RC_SD_STATUS_PM_REG_RSVDP_5_MASK)
...
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_24_MASK   (0xFF000000U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_24_SHIFT  (24U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_24_WIDTH  (8U)
#define PCIE_RC_SD_STATUS_PM_REG_RSVDP_24(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_PM_REG_RSVDP_24_SHIFT)) & PCIE_RC_SD_STATUS_PM_REG_RSVDP_24_MASK)
/*! @} */
...
#define PCIE_RC_SD_STATUS_L2_REG_RSVDP_28_MASK   (0xF0000000U)
#define PCIE_RC_SD_STATUS_L2_REG_RSVDP_28_SHIFT  (28U)
#define PCIE_RC_SD_STATUS_L2_REG_RSVDP_28_WIDTH  (4U)
#define PCIE_RC_SD_STATUS_L2_REG_RSVDP_28(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L2_REG_RSVDP_28_SHIFT)) & PCIE_RC_SD_STATUS_L2_REG_RSVDP_28_MASK)
/*! @} */
...
#define PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7_MASK  (0x80U)
#define PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7_SHIFT (7U)
#define PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7_WIDTH (1U)
#define PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7_SHIFT)) & PCIE_RC_SD_STATUS_L3FC_REG_RSVDP_7_MASK)
...
#define PCIE_RC_SD_STATUS_L3_REG_RSVDP_8_MASK    (0xFFFFFF00U)
#define PCIE_RC_SD_STATUS_L3_REG_RSVDP_8_SHIFT   (8U)
#define PCIE_RC_SD_STATUS_L3_REG_RSVDP_8_WIDTH   (24U)
#define PCIE_RC_SD_STATUS_L3_REG_RSVDP_8(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_STATUS_L3_REG_RSVDP_8_SHIFT)) & PCIE_RC_SD_STATUS_L3_REG_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_SD_EQ_CONTROL1_REG_EQ_RATE_SEL_MASK (0x30U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_EQ_RATE_SEL_SHIFT (4U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_EQ_RATE_SEL_WIDTH (2U)
...
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6_MASK  (0xC0U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6_SHIFT (6U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6_WIDTH (2U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6_SHIFT)) & PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_6_MASK)
...
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10_MASK (0xFC00U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10_SHIFT (10U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10_WIDTH (6U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10_SHIFT)) & PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_10_MASK)
...
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18_MASK (0x7C0000U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18_SHIFT (18U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18_WIDTH (5U)
#define PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18_SHIFT)) & PCIE_RC_SD_EQ_CONTROL1_REG_RSVDP_18_MASK)
...
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21_MASK (0xE00000U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21_SHIFT (21U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21_WIDTH (3U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21_SHIFT)) & PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_21_MASK)
...
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31_SHIFT (31U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31_WIDTH (1U)
#define PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31_SHIFT)) & PCIE_RC_SD_EQ_CONTROL2_REG_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18_MASK (0xFFC0000U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18_SHIFT (18U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18_WIDTH (10U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18_SHIFT)) & PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_18_MASK)
...
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29_MASK (0xE0000000U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29_SHIFT (29U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29_WIDTH (3U)
#define PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29_SHIFT)) & PCIE_RC_SD_EQ_CONTROL3_REG_RSVDP_29_MASK)
/*! @} */
...
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3_MASK   (0x8U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3_SHIFT  (3U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3_WIDTH  (1U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3_SHIFT)) & PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_3_MASK)
...
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8_MASK   (0xFFFFFF00U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8_SHIFT  (8U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8_WIDTH  (24U)
#define PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8_SHIFT)) & PCIE_RC_SD_EQ_STATUS1_REG_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21_MASK  (0xE00000U)
#define PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21_SHIFT (21U)
#define PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21_WIDTH (3U)
#define PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21_SHIFT)) & PCIE_RC_SD_EQ_STATUS2_REG_RSVDP_21_MASK)
...
#define PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30_MASK  (0xC0000000U)
#define PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30_SHIFT (30U)
#define PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30_WIDTH (2U)
#define PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30_SHIFT)) & PCIE_RC_SD_EQ_STATUS3_REG_RSVDP_30_MASK)
/*! @} */
...
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX_MASK (0x80U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX_SHIFT (7U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX_WIDTH (1U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX_SHIFT)) & PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_TX_MASK)

#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX_MASK (0x100U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX_SHIFT (8U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX_WIDTH (1U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX_SHIFT)) & PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_DTIM_TX_MASK)

#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9_MASK (0xFE00U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9_SHIFT (9U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9_WIDTH (7U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9_SHIFT)) & PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_9_MASK)
...
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX_MASK (0x800000U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX_SHIFT (23U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX_WIDTH (1U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX_SHIFT)) & PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_ERROR_PROT_DISABLE_CXS_RX_MASK)

#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24_MASK (0xFF000000U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24_SHIFT (24U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24_WIDTH (8U)
#define PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24_SHIFT)) & PCIE_RC_RASDP_ERROR_PROT_CTRL_OFF_RSVDP_24_MASK)
/*! @} */
...
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1_MASK (0xEU)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1_WIDTH (3U)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1_SHIFT)) & PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5_MASK (0xFFFE0U)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5_WIDTH (15U)
#define PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5_SHIFT)) & PCIE_RC_RASDP_CORR_COUNTER_CTRL_OFF_RSVDP_5_MASK)
...
#define PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8_MASK (0xFFF00U)
#define PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8_WIDTH (12U)
#define PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8_SHIFT)) & PCIE_RC_RASDP_CORR_COUNT_REPORT_OFF_RSVDP_8_MASK)
...
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1_MASK (0xEU)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1_WIDTH (3U)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1_SHIFT)) & PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5_MASK (0xFFFE0U)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5_WIDTH (15U)
#define PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5_SHIFT)) & PCIE_RC_RASDP_UNCORR_COUNTER_CTRL_OFF_RSVDP_5_MASK)
...
#define PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8_MASK (0xFFF00U)
#define PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8_WIDTH (12U)
#define PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8_SHIFT)) & PCIE_RC_RASDP_UNCORR_COUNT_REPORT_OFF_RSVDP_8_MASK)
...
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1_MASK (0xEU)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1_WIDTH (3U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1_SHIFT)) & PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6_MASK (0xC0U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6_SHIFT (6U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6_WIDTH (2U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6_SHIFT)) & PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_6_MASK)
...
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24_MASK (0xFF000000U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24_SHIFT (24U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24_WIDTH (8U)
#define PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24_SHIFT)) & PCIE_RC_RASDP_ERROR_INJ_CTRL_OFF_RSVDP_24_MASK)
/*! @} */

/*! @name RASDP_CORR_ERROR_LOCATION_OFF - Corrected Errors Location */
/*! @{ */

#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0_MASK (0xFU)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0_WIDTH (4U)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0_SHIFT)) & PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16_MASK (0xF0000U)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16_WIDTH (4U)
#define PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16_SHIFT)) & PCIE_RC_RASDP_CORR_ERROR_LOCATION_OFF_RSVDP_16_MASK)
...
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0_MASK (0xFU)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0_WIDTH (4U)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0_SHIFT)) & PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16_MASK (0xF0000U)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16_WIDTH (4U)
#define PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16_SHIFT)) & PCIE_RC_RASDP_UNCORR_ERROR_LOCATION_OFF_RSVDP_16_MASK)
...
#define PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2_MASK (0xFFFFFFFCU)
#define PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2_WIDTH (30U)
#define PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2_SHIFT)) & PCIE_RC_RASDP_ERROR_MODE_EN_OFF_RSVDP_2_MASK)
/*! @} */
...
#define PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1_MASK (0xFFFFFFFEU)
#define PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1_WIDTH (31U)
#define PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1_SHIFT)) & PCIE_RC_RASDP_ERROR_MODE_CLEAR_OFF_RSVDP_1_MASK)
/*! @} */
...
#define PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27_MASK (0x8000000U)
#define PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27_WIDTH (1U)
#define PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27_SHIFT)) & PCIE_RC_RASDP_RAM_ADDR_CORR_ERROR_OFF_RSVDP_27_MASK)
...
#define PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27_MASK (0x8000000U)
#define PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27_WIDTH (1U)
#define PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27_SHIFT)) & PCIE_RC_RASDP_RAM_ADDR_UNCORR_ERROR_OFF_RSVDP_27_MASK)
...
#define PCIE_RC_VSECDMA_EXT_CAP_HDR_OFF_ID_WIDTH (16U)
...
#define PCIE_RC_VSECDMA_EXT_CAP_HDR_OFF_CAP_WIDTH (4U)
...
#define PCIE_RC_VSECDMA_EXT_CAP_HDR_OFF_NEXT_OFFSET_WIDTH (12U)
...
#define PCIE_RC_VSECDMA_VENDOR_SPECIFIC_HDR_OFF_VSEC_ID_WIDTH (16U)
...
#define PCIE_RC_VSECDMA_VENDOR_SPECIFIC_HDR_OFF_VSEC_REV_WIDTH (4U)
...
#define PCIE_RC_VSECDMA_VENDOR_SPECIFIC_HDR_OFF_VSEC_LENGTH_WIDTH (12U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_MAP_FORMAT_WIDTH (3U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3_MASK (0xF8U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3_SHIFT (3U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3_WIDTH (5U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3_SHIFT)) & PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_3_MASK)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_BARN_WIDTH (3U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_PFN_WIDTH (5U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_CHANNEL_SEPARATION_WIDTH (3U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_AXI_WIDTH (1U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_MASTER_BUS_WIDTH_WIDTH (3U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_MASTER_BURST_LENGTH_WIDTH (3U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_MASTER_PAGE_BOUNDARY_POINTER_WIDTH_WIDTH (4U)
...
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30_MASK (0xC0000000U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30_SHIFT (30U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30_WIDTH (2U)
#define PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30_SHIFT)) & PCIE_RC_VSECDMA_DEVICE_INFORMATION_OFF_RSVDP_30_MASK)
/*! @} */
...
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_NUM_DMA_WR_CHAN_WIDTH (10U)
...
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10_MASK (0xFC00U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10_SHIFT (10U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10_WIDTH (6U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10_SHIFT)) & PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_10_MASK)
...
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_NUM_DMA_RD_CHAN_WIDTH (10U)
...
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26_MASK (0xFC000000U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26_SHIFT (26U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26_WIDTH (6U)
#define PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26_SHIFT)) & PCIE_RC_VSECDMA_NUM_CHAN_OFF_RSVDP_26_MASK)
/*! @} */
...
#define PCIE_RC_VSECDMA_UNROLL_ADDR_OFFSET_LOW_OFF_UNROLL_ADDR_OFFSET_LOW_WIDTH (32U)
...
#define PCIE_RC_VSECDMA_UNROLL_ADDR_OFFSET_HIGH_OFF_UNROLL_ADDR_OFFSET_HIGH_WIDTH (32U)
...
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_12_MASK     (0x7000U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_12_SHIFT    (12U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_12_WIDTH    (3U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_12(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PORT_FORCE_OFF_RSVDP_12_SHIFT)) & PCIE_RC_PORT_FORCE_OFF_RSVDP_12_MASK)
...
#define PCIE_RC_PORT_FORCE_OFF_SUPPORT_PART_LANES_RXEI_EXIT_WIDTH (1U)
...
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_24_MASK     (0xFF000000U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_24_SHIFT    (24U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_24_WIDTH    (8U)
#define PCIE_RC_PORT_FORCE_OFF_RSVDP_24(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PORT_FORCE_OFF_RSVDP_24_SHIFT)) & PCIE_RC_PORT_FORCE_OFF_RSVDP_24_MASK)
/*! @} */
...
#define PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31_SHIFT (31U)
#define PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31_WIDTH (1U)
#define PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31_SHIFT)) & PCIE_RC_ACK_F_ASPM_CTRL_OFF_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4_MASK  (0x10U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4_SHIFT (4U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4_WIDTH (1U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4(x)    (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4_SHIFT)) & PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_4_MASK)
...
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12_MASK (0xF000U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12_SHIFT (12U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12_WIDTH (4U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12_SHIFT)) & PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_12_MASK)
...
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28_MASK (0xF0000000U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28_SHIFT (28U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28_WIDTH (4U)
#define PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28_SHIFT)) & PCIE_RC_PORT_LINK_CTRL_OFF_RSVDP_28_MASK)
/*! @} */
...
#define PCIE_RC_LANE_SKEW_OFF_ELASTIC_BUFFER_MODE_WIDTH (1U)
...
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8_MASK (0x3F00U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8_WIDTH (6U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8_SHIFT)) & PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_8_MASK)
...
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31_SHIFT (31U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31_WIDTH (1U)
#define PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31_SHIFT)) & PCIE_RC_TIMER_CTRL_MAX_FUNC_NUM_OFF_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1_MASK (0xFFFFFFFEU)
#define PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1_WIDTH (31U)
#define PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1_SHIFT)) & PCIE_RC_AMBA_MUL_OB_DECOMP_NP_SUB_REQ_CTRL_OFF_RSVDP_1_MASK)
/*! @} */
...
#define PCIE_RC_TX_P_FC_CREDIT_STATUS_OFF_RSVDP_TX_P_FC_CREDIT_STATUS_WIDTH (12U)
...
#define PCIE_RC_TX_NP_FC_CREDIT_STATUS_OFF_RSVDP_TX_NP_FC_CREDIT_STATUS_WIDTH (12U)
...
#define PCIE_RC_TX_CPL_FC_CREDIT_STATUS_OFF_RSVDP_TX_CPL_FC_CREDIT_STATUS_WIDTH (12U)
...
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4_MASK    (0x1FF0U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4_SHIFT   (4U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4_WIDTH   (9U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4_SHIFT)) & PCIE_RC_QUEUE_STATUS_OFF_RSVDP_4_MASK)
...
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29_MASK   (0x60000000U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29_SHIFT  (29U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29_WIDTH  (2U)
#define PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29_SHIFT)) & PCIE_RC_QUEUE_STATUS_OFF_RSVDP_29_MASK)
...
#define PCIE_RC_GEN2_CTRL_OFF_SELECT_DEEMPH_VAR_MUX_WIDTH (1U)
...
#define PCIE_RC_GEN2_CTRL_OFF_SELECTABLE_DEEMPH_BIT_MUX_WIDTH (1U)
...
#define PCIE_RC_GEN2_CTRL_OFF_LANE_UNDER_TEST_WIDTH (4U)
...
#define PCIE_RC_GEN2_CTRL_OFF_FORCE_LANE_FLIP_WIDTH (1U)
...
#define PCIE_RC_CLOCK_GATING_CTRL_OFF_AXI_CLK_GATING_EN_WIDTH (1U)
...
#define PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2_MASK (0xFFFFFFFCU)
#define PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2_WIDTH (30U)
#define PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2_SHIFT)) & PCIE_RC_CLOCK_GATING_CTRL_OFF_RSVDP_2_MASK)
/*! @} */
...
#define PCIE_RC_GEN3_RELATED_OFF_NO_SEED_VALUE_CHANGE_WIDTH (1U)
...
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_2_MASK    (0xFCU)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_2_SHIFT   (2U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_2_WIDTH   (6U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_2(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_RELATED_OFF_RSVDP_2_SHIFT)) & PCIE_RC_GEN3_RELATED_OFF_RSVDP_2_MASK)
...
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_14_MASK   (0xC000U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_14_SHIFT  (14U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_14_WIDTH  (2U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_14(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_RELATED_OFF_RSVDP_14_SHIFT)) & PCIE_RC_GEN3_RELATED_OFF_RSVDP_14_MASK)
...
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_19_MASK   (0x180000U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_19_SHIFT  (19U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_19_WIDTH  (2U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_19(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_RELATED_OFF_RSVDP_19_SHIFT)) & PCIE_RC_GEN3_RELATED_OFF_RSVDP_19_MASK)
...
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_26_MASK   (0xFC000000U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_26_SHIFT  (26U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_26_WIDTH  (6U)
#define PCIE_RC_GEN3_RELATED_OFF_RSVDP_26(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_RELATED_OFF_RSVDP_26_SHIFT)) & PCIE_RC_GEN3_RELATED_OFF_RSVDP_26_MASK)
/*! @} */
...
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7_MASK (0x80U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7_SHIFT (7U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7_WIDTH (1U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7_SHIFT)) & PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_7_MASK)
...
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27_MASK (0xF8000000U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27_WIDTH (5U)
#define PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27_SHIFT)) & PCIE_RC_GEN3_EQ_CONTROL_OFF_RSVDP_27_MASK)
/*! @} */
...
#define PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18_MASK (0xFFFC0000U)
#define PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18_SHIFT (18U)
#define PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18_WIDTH (14U)
#define PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18_SHIFT)) & PCIE_RC_GEN3_EQ_FB_MODE_DIR_CHANGE_OFF_RSVDP_18_MASK)
/*! @} */
...
#define PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16_SHIFT)) & PCIE_RC_ORDER_RULE_CTRL_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22_MASK (0xC00000U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22_SHIFT (22U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22_WIDTH (2U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22_SHIFT)) & PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_22_MASK)
...
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RXSTATUS_VALUE_WIDTH (3U)
...
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27_MASK (0x78000000U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27_SHIFT (27U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27_WIDTH (4U)
#define PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27_SHIFT)) & PCIE_RC_PIPE_LOOPBACK_CONTROL_OFF_RSVDP_27_MASK)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_CPLQ_MNG_EN_WIDTH (1U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_CFG_TLP_BYPASS_EN_REG_WIDTH (1U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_CONFIG_LIMIT_REG_WIDTH (10U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_TARGET_ABOVE_CONFIG_LIMIT_REG_WIDTH (2U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_P2P_TRACK_CPL_TO_REG_WIDTH (1U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_P2P_ERR_RPT_CTRL_WIDTH (1U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_PORT_LOGIC_WR_DISABLE_WIDTH (1U)
...
#define PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23_MASK (0xFF800000U)
#define PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23_SHIFT (23U)
#define PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23_WIDTH (9U)
#define PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23(x)   (((uint32_t)(((uint32_t)(x)) << PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23_SHIFT)) & PCIE_RC_MISC_CONTROL_1_OFF_RSVDP_23_MASK)
/*! @} */
...
#define PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8_MASK (0xFFFFFF00U)
#define PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8_WIDTH (24U)
#define PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8_SHIFT)) & PCIE_RC_MULTI_LANE_CONTROL_OFF_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7_MASK (0x80U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7_SHIFT (7U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7_WIDTH (1U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7(x)  (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7_SHIFT)) & PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_7_MASK)
...
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_PHY_RST_TIMER_MASK (0x3F000U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_PHY_RST_TIMER_SHIFT (12U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_PHY_RST_TIMER_WIDTH (6U)
...
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18_MASK (0xFFFC0000U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18_SHIFT (18U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18_WIDTH (14U)
#define PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18_SHIFT)) & PCIE_RC_PHY_INTEROP_CTRL_OFF_RSVDP_18_MASK)
/*! @} */
...
#define PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1_MASK (0xFFFFFEU)
#define PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1_WIDTH (23U)
#define PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1_SHIFT)) & PCIE_RC_LINK_FLUSH_CONTROL_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1_MASK (0x2U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1_WIDTH (1U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1_SHIFT)) & PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5_MASK (0x3E0U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5_WIDTH (5U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5_SHIFT)) & PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_5_MASK)
...
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16_SHIFT)) & PCIE_RC_AMBA_ERROR_RESPONSE_DEFAULT_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9_MASK (0xFFFFFE00U)
#define PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9_SHIFT (9U)
#define PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9_WIDTH (23U)
#define PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9_SHIFT)) & PCIE_RC_AMBA_LINK_TIMEOUT_OFF_RSVDP_9_MASK)
/*! @} */

/*! @name AMBA_ORDERING_CTRL_OFF - AXI Bridge Ordering Control. */
/*! @{ */

#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0_MASK (0x1U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0_WIDTH (1U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0_SHIFT)) & PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2_MASK (0x4U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2_WIDTH (1U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2_SHIFT)) & PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_2_MASK)
...
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5_MASK (0x60U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5_WIDTH (2U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5_SHIFT)) & PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_5_MASK)
...
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8_MASK (0xFFFFFF00U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8_WIDTH (24U)
#define PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8_SHIFT)) & PCIE_RC_AMBA_ORDERING_CTRL_OFF_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1_MASK (0x2U)
#define PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1_SHIFT (1U)
#define PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_1_OFF_RSVDP_1_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2_MASK (0x4U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_2_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7_MASK (0x80U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7_SHIFT (7U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_7_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10_MASK (0x400U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10_SHIFT (10U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_10_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15_MASK (0x8000U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15_SHIFT (15U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_15_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18_MASK (0x40000U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18_SHIFT (18U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_18_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23_MASK (0x800000U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23_SHIFT (23U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_23_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26_MASK (0x4000000U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26_SHIFT (26U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_26_MASK)
...
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31_MASK (0x80000000U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31_SHIFT (31U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31_WIDTH (1U)
#define PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31_SHIFT)) & PCIE_RC_COHERENCY_CONTROL_3_OFF_RSVDP_31_MASK)
/*! @} */
...
#define PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5_MASK (0xFFFFFFE0U)
#define PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5_WIDTH (27U)
#define PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5_SHIFT)) & PCIE_RC_INTERFACE_TIMER_CONTROL_OFF_RSVDP_5_MASK)
/*! @} */
...
#define PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16_SHIFT)) & PCIE_RC_INTERFACE_TIMER_TARGET_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_SAFETY_MASK_OFF_RSVDP_6_MASK     (0xFFFFFFC0U)
#define PCIE_RC_SAFETY_MASK_OFF_RSVDP_6_SHIFT    (6U)
#define PCIE_RC_SAFETY_MASK_OFF_RSVDP_6_WIDTH    (26U)
#define PCIE_RC_SAFETY_MASK_OFF_RSVDP_6(x)       (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SAFETY_MASK_OFF_RSVDP_6_SHIFT)) & PCIE_RC_SAFETY_MASK_OFF_RSVDP_6_MASK)
/*! @} */
...
#define PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6_MASK   (0xFFFFFFC0U)
#define PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6_SHIFT  (6U)
#define PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6_WIDTH  (26U)
#define PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6_SHIFT)) & PCIE_RC_SAFETY_STATUS_OFF_RSVDP_6_MASK)
/*! @} */

/*! @name PL_APP_BUS_DEV_NUM_STATUS_OFF - Application driven bus and device number register. */
/*! @{ */

#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0_MASK (0x7U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0_SHIFT (0U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0_WIDTH (3U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0_SHIFT)) & PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_0_MASK)
...
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RC_DSW_DEV_NUM_WIDTH (5U)
...
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RC_DSW_BUS_NUM_WIDTH (8U)
...
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16_MASK (0xFFFF0000U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16_SHIFT (16U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16_WIDTH (16U)
#define PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16_SHIFT)) & PCIE_RC_PL_APP_BUS_DEV_NUM_STATUS_OFF_RSVDP_16_MASK)
/*! @} */
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_PCIPM_VDM_TRAFFIC_BLOCKED_WIDTH (1U)
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_PCIPM_NEW_TLP_CLIENT0_BLOCKED_WIDTH (1U)
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_PCIPM_NEW_TLP_CLIENT1_BLOCKED_WIDTH (1U)
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_PCIPM_NEW_TLP_CLIENT2_BLOCKED_WIDTH (1U)
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_PCIPM_RESERVED_4_7_WIDTH (4U)
...
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8_MASK (0xFFFFFF00U)
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8_SHIFT (8U)
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8_WIDTH (24U)
#define PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8_SHIFT)) & PCIE_RC_PCIPM_TRAFFIC_CTRL_OFF_RSVDP_8_MASK)
/*! @} */
...
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2_MASK (0xFFFCU)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2_WIDTH (14U)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2_SHIFT)) & PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_2_MASK)
...
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19_MASK (0xFFF80000U)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19_SHIFT (19U)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19_WIDTH (13U)
#define PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19_SHIFT)) & PCIE_RC_PL_CHK_REG_CONTROL_STATUS_OFF_RSVDP_19_MASK)
/*! @} */
...
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5_MASK (0xFFE0U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5_SHIFT (5U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5_WIDTH (11U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5_SHIFT)) & PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_5_MASK)
...
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28_MASK (0xF0000000U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28_SHIFT (28U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28_WIDTH (4U)
#define PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28_SHIFT)) & PCIE_RC_PL_CHK_REG_ERR_PF_VF_OFF_RSVDP_28_MASK)
/*! @} */
...
#define PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10_MASK   (0xFFFFFC00U)
#define PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10_SHIFT  (10U)
#define PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10_WIDTH  (22U)
#define PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10(x)     (((uint32_t)(((uint32_t)(x)) << PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10_SHIFT)) & PCIE_RC_AUX_CLK_FREQ_OFF_RSVDP_10_MASK)
/*! @} */
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_POWERDOWN_FORCE_WIDTH (1U)
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_POWERDOWN_VMAIN_ACK_WIDTH (1U)
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2_MASK (0xCU)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2_SHIFT (2U)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2_WIDTH (2U)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2_SHIFT)) & PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_2_MASK)
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_POWERDOWN_MAC_POWERDOWN_WIDTH (4U)
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_POWERDOWN_PHY_POWERDOWN_WIDTH (4U)
...
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12_MASK (0xFFFFF000U)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12_SHIFT (12U)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12_WIDTH (20U)
#define PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12_SHIFT)) & PCIE_RC_POWERDOWN_CTRL_STATUS_OFF_RSVDP_12_MASK)
/*! @} */
...
#define PCIE_RC_PIPE_RELATED_OFF_PIPE_GARBAGE_DATA_MODE_WIDTH (1U)
...
#define PCIE_RC_PIPE_RELATED_OFF_RSVDP_9_MASK    (0xFFFFFE00U)
#define PCIE_RC_PIPE_RELATED_OFF_RSVDP_9_SHIFT   (9U)
#define PCIE_RC_PIPE_RELATED_OFF_RSVDP_9_WIDTH   (23U)
#define PCIE_RC_PIPE_RELATED_OFF_RSVDP_9(x)      (((uint32_t)(((uint32_t)(x)) << PCIE_RC_PIPE_RELATED_OFF_RSVDP_9_SHIFT)) & PCIE_RC_PIPE_RELATED_OFF_RSVDP_9_MASK)
/*! @} */
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_0_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_0_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_0_MSG_CODE_MATCH_EN_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_0_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_1_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_1_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_1_MSG_CODE_MATCH_EN_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_1_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_2_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_2_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_2_MSG_CODE_MATCH_EN_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_2_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_3_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_3_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_INBOUND_3_MSG_CODE_MATCH_EN_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_INBOUND_3_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_4_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_4_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE_MASK (0xFFU)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE_SHIFT (0U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE_WIDTH (8U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_MSG_CODE_MASK)
...
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS_MASK (0x200000U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS_SHIFT (21U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS_WIDTH (1U)
#define PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS_SHIFT)) & PCIE_RC_IATU_REGION_CTRL_2_OFF_OUTBOUND_5_TLP_HEADER_FIELDS_BYPASS_MASK)
...
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR_MASK (0xFU)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR_SHIFT (0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR_WIDTH (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR_SHIFT)) & PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_CBUF_INCR_MASK)

#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_LIMIT_ADDR_HW_MASK (0xFF0U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_LIMIT_ADDR_HW_SHIFT (4U)
#define PCIE_RC_IATU_LIMIT_ADDR_OFF_OUTBOUND_5_LIMIT_ADDR_HW_WIDTH (8U)
...
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0_MASK (0xFFFFU)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0_SHIFT (0U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0_WIDTH (16U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0_SHIFT)) & PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED0_MASK)

#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE_MASK (0x7FF0000U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE_SHIFT (16U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE_WIDTH (11U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE_SHIFT)) & PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_TABLE_SIZE_MASK)

#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1_MASK (0xF8000000U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1_SHIFT (27U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1_WIDTH (5U)
#define PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1_SHIFT)) & PCIE_RC_SHADOW_PCI_MSIX_CAP_ID_NEXT_CTRL_REG_PCI_MSIX_RESERVED1_MASK)
/*! @} */

/*! @name SHADOW_MSIX_TABLE_OFFSET_REG - MSI-X Table Offset and BIR Register. */
/*! @{ */

#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR_MASK (0x7U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR_SHIFT (0U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR_WIDTH (3U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR_SHIFT)) & PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_BIR_MASK)

#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET_MASK (0xFFFFFFF8U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET_SHIFT (3U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET_WIDTH (29U)
#define PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET_SHIFT)) & PCIE_RC_SHADOW_MSIX_TABLE_OFFSET_REG_PCI_MSIX_TABLE_OFFSET_MASK)
/*! @} */

/*! @name SHADOW_MSIX_PBA_OFFSET_REG - MSI-X PBA Offset and BIR Register. */
/*! @{ */

#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_MASK (0x7U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_SHIFT (0U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_WIDTH (3U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_SHIFT)) & PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_BIR_MASK)

#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET_MASK (0xFFFFFFF8U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET_SHIFT (3U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET_WIDTH (29U)
#define PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET(x) (((uint32_t)(((uint32_t)(x)) << PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET_SHIFT)) & PCIE_RC_SHADOW_MSIX_PBA_OFFSET_REG_PCI_MSIX_PBA_OFFSET_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G399A_PCIE_RC_H_) */
