...
/*!
 * @file S32G274A_FLEXCAN.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_FLEXCAN
 *
...
#if !defined(S32G274A_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32G274A_FLEXCAN_H_
...
#endif  /* #if !defined(S32G274A_FLEXCAN_H_) */
