 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_RTC
 *
...
#if !defined(S32G274A_RTC_H_)  /* Check if memory map has not been already included */
#define S32G274A_RTC_H_
...
#define IP_RTC_BASE                              (0x40060000u)
...
#endif  /* #if !defined(S32G274A_RTC_H_) */
