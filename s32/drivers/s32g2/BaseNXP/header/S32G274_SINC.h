 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_SINC
 *
...
#if !defined(S32G274_SINC_H_)  /* Check if memory map has not been already included */
#define S32G274_SINC_H_
...
#define IP_SINC_BASE                             (0x406A8000u)
...
#endif  /* #if !defined(S32G274_SINC_H_) */
