 ...
 * @version 1.3
 * @date 2024-06-14
 * @brief Peripheral Access Layer for S32G274_NVIC
 *
...
#if !defined(S32G274_NVIC_H_)  /* Check if memory map has not been already included */
#define S32G274_NVIC_H_
...
#endif  /* #if !defined(S32G274_NVIC_H_) */
