...
/*!
 * @file S32G274_SW_GLOBAL.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_SW_GLOBAL
 *
...
#if !defined(S32G274_SW_GLOBAL_H_)  /* Check if memory map has not been already included */
#define S32G274_SW_GLOBAL_H_
...
typedef struct SW_GLOBAL_Struct {
  ...
  struct SW_GLOBAL_PCE_SL {                        /* offset: 0x100, array step: 0x8 */
  ...
  struct SW_GLOBAL_HTA_LOOP {                      /* offset: 0x200, array step: 0x28 */
  ...
  struct SW_GLOBAL_ARRAY_NUM_RC {                  /* offset: 0x300, array step: 0x10 */
...
} SW_GLOBAL_Type, *SW_GLOBAL_MemMapPtr;

/** Number of instances of the SW_GLOBAL module. */
#define SW_GLOBAL_INSTANCE_COUNT                 (1u)

/* SW_GLOBAL - Peripheral instance base addresses */
/** Peripheral NETC__SW0_GLOBAL base address */
#define IP_NETC__SW0_GLOBAL_BASE                 (0x6D070000u)
/** Peripheral NETC__SW0_GLOBAL base pointer */
#define IP_NETC__SW0_GLOBAL                      ((SW_GLOBAL_Type *)IP_NETC__SW0_GLOBAL_BASE)
/** Array initializer of SW_GLOBAL peripheral base addresses */
#define IP_SW_GLOBAL_BASE_ADDRS                  { IP_NETC__SW0_GLOBAL_BASE }
/** Array initializer of SW_GLOBAL peripheral base pointers */
#define IP_SW_GLOBAL_BASE_PTRS                   { IP_NETC__SW0_GLOBAL }
...
#define SW_GLOBAL_SMCAPR_NUM_WORDS_WIDTH         (24U)
...
#define SW_GLOBAL_SMDTR_THRESH_WIDTH             (24U)
...
#define SW_GLOBAL_SMACR_COUNT_WIDTH              (24U)
...
#define SW_GLOBAL_SMCLWMR_WATERMARK_WIDTH        (24U)
...
#define SW_GLOBAL_SMBUCR_COUNT_WIDTH             (24U)
...
#define SW_GLOBAL_SMBUCHWMR_WATERMARK_WIDTH      (24U)
...
#define SW_GLOBAL_SMLCR_COUNT_WIDTH              (24U)
...
#define SW_GLOBAL_SMLCR_IFLC_WIDTH               (1U)
...
#define SW_GLOBAL_SMLCR_IFDC_WIDTH               (1U)
...
#define SW_GLOBAL_HBTCAPR_NUM_ENTRIES_WIDTH      (16U)
...
#define SW_GLOBAL_HBTCAPR_MAX_COL_WIDTH          (3U)
...
#define SW_GLOBAL_HBTCAPR_MAX_VISITS_WIDTH       (4U)
...
#define SW_GLOBAL_HBTOR0_NUM_ENTRIES_WIDTH       (16U)
...
#define SW_GLOBAL_HBTOR0_HWM_ENTRIES_WIDTH       (16U)
...
#define SW_GLOBAL_HBTOR2_RUN_AVG_FRACT_WIDTH     (8U)
...
#define SW_GLOBAL_HBTOR2_RUN_AVG_INT_WIDTH       (8U)
...
#define SW_GLOBAL_HBTOR2_HWM_COL_WIDTH           (4U)
...
#define SW_GLOBAL_SMERBCAPR_THRESH_WIDTH         (24U)
...
#define SW_GLOBAL_SMERBCAPR_WORD_SIZE_WIDTH      (2U)
...
#define SW_GLOBAL_SMERBCAPR_MLOC_WIDTH           (2U)
...
#define SW_GLOBAL_SMERBOR0_AMOUNT_WIDTH          (24U)
...
#define SW_GLOBAL_SMERBOR1_WATERMARK_WIDTH       (24U)
...
#define SW_GLOBAL_PCEOR_NUM_FRAMES_WIDTH         (7U)
...
#define SW_GLOBAL_PCEOR_HWM_FRAMES_WIDTH         (7U)
...
#define SW_GLOBAL_PCEOR_MAX_FRAMES_WIDTH         (7U)
...
#define SW_GLOBAL_RFEOR_NUM_FRAMES_WIDTH         (6U)
...
#define SW_GLOBAL_RFEOR_HWM_FRAMES_WIDTH         (6U)
...
#define SW_GLOBAL_RFEOR_MAX_FRAMES_WIDTH         (6U)
...
#define SW_GLOBAL_NETCCLKR_FREQ_WIDTH            (11U)
...
#define SW_GLOBAL_HTACAPR_MAX_RX_FRAMES_WIDTH    (8U)
...
#define SW_GLOBAL_HTACAPR_MAX_TX_FRAMES_WIDTH    (8U)
...
#define SW_GLOBAL_HTARFCOR_HP_COUNT_WIDTH        (8U)
...
#define SW_GLOBAL_HTARFCOR_HP_HWM_WIDTH          (8U)
...
#define SW_GLOBAL_HTARFCOR_LP_COUNT_WIDTH        (8U)
...
#define SW_GLOBAL_HTARFCOR_LP_HWM_WIDTH          (8U)
...
#define SW_GLOBAL_HTAHPBCOR_HP_COUNT_WIDTH       (16U)
...
#define SW_GLOBAL_HTAHPBCOR_HWM_WIDTH            (16U)
...
#define SW_GLOBAL_HTALPBCOR_LP_COUNT_WIDTH       (16U)
...
#define SW_GLOBAL_HTALPBCOR_HWM_WIDTH            (16U)
...
#define SW_GLOBAL_HTATFCOR_HP_COUNT_WIDTH        (8U)
...
#define SW_GLOBAL_HTATFCOR_HP_HWM_WIDTH          (8U)
...
#define SW_GLOBAL_HTATFCOR_LP_COUNT_WIDTH        (8U)
...
#define SW_GLOBAL_HTATFCOR_LP_HWM_WIDTH          (8U)
...
#define SW_GLOBAL_RCSBRLAR_FRACT_WIDTH           (8U)
...
#define SW_GLOBAL_RCSBRLAR_INT_WIDTH             (12U)
...
#define SW_GLOBAL_RCSBRLHWMR_FRACT_WIDTH         (8U)
...
#define SW_GLOBAL_RCSBRLHWMR_INT_WIDTH           (12U)
...
#define SW_GLOBAL_RCSBWLAR_FRACT_WIDTH           (8U)
...
#define SW_GLOBAL_RCSBWLAR_INT_WIDTH             (12U)
...
#define SW_GLOBAL_RCSBWLHWMR_FRACT_WIDTH         (8U)
...
#define SW_GLOBAL_RCSBWLHWMR_INT_WIDTH           (12U)
...
#define SW_GLOBAL_IPBRR0_IP_MN_WIDTH             (8U)
...
#define SW_GLOBAL_IPBRR0_IP_MJ_WIDTH             (8U)
...
#define SW_GLOBAL_IPBRR1_IP_CFG_WIDTH            (8U)
...
#define SW_GLOBAL_IPBRR1_IP_MNT_WIDTH            (8U)
...
#define SW_GLOBAL_IPBRR1_IP_INT_WIDTH            (8U)
...
#define SW_GLOBAL_FBLPR_PARAM_VAL_WIDTH          (32U)
...
#endif  /* #if !defined(S32G274_SW_GLOBAL_H_) */
