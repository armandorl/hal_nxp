...
/*!
 * @file S32G274A_DMA_TCD.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_DMA_TCD
 *
...
#if !defined(S32G274A_DMA_TCD_H_)  /* Check if memory map has not been already included */
#define S32G274A_DMA_TCD_H_
...
#define IP_EDMA_0_TCD_BASE                       (0x40148000u)
/** Peripheral EDMA_0_TCD base pointer */
#define IP_EDMA_0_TCD                            ((DMA_TCD_Type *)IP_EDMA_0_TCD_BASE)
/** Peripheral EDMA_1_TCD base address */
#define IP_EDMA_1_TCD_BASE                       (0x40248000u)
/** Peripheral EDMA_1_TCD base pointer */
#define IP_EDMA_1_TCD                            ((DMA_TCD_Type *)IP_EDMA_1_TCD_BASE)
/** Array initializer of DMA_TCD peripheral base addresses */
#define IP_DMA_TCD_BASE_ADDRS                    { IP_EDMA_0_TCD_BASE, IP_EDMA_1_TCD_BASE }
/** Array initializer of DMA_TCD peripheral base pointers */
#define IP_DMA_TCD_BASE_PTRS                     { IP_EDMA_0_TCD, IP_EDMA_1_TCD }
...
#endif  /* #if !defined(S32G274A_DMA_TCD_H_) */
