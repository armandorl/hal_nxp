 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_TMU
 *
...
#if !defined(S32G274A_TMU_H_)  /* Check if memory map has not been already included */
#define S32G274A_TMU_H_
...
#define IP_TMU_BASE                              (0x400A8000u)
...
#endif  /* #if !defined(S32G274A_TMU_H_) */
