 ...
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_SPI
 *
...
#if !defined(S32G399A_SPI_H_)  /* Check if memory map has not been already included */
#define S32G399A_SPI_H_
...
#define SPI_MCR_PCSIS_MASK                       (0xFF0000U)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
#define SPI_MCR_PCSIS_SHIFT                      (16U)
#define SPI_MCR_PCSIS_WIDTH                      (8U)
#define SPI_MCR_PCSIS(x)                         (((uint32_t)(((uint32_t)(x)) << SPI_MCR_PCSIS_SHIFT)) & SPI_MCR_PCSIS_MASK)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
...
#define SPI_PUSHR_PCS_MASK                       (0xFF0000U)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
#define SPI_PUSHR_PCS_SHIFT                      (16U)
#define SPI_PUSHR_PCS_WIDTH                      (8U)
#define SPI_PUSHR_PCS(x)                         (((uint32_t)(((uint32_t)(x)) << SPI_PUSHR_PCS_SHIFT)) & SPI_PUSHR_PCS_MASK)  /* Merged from fields with different position or width, of widths (5, 8), largest definition used */
...
#endif  /* #if !defined(S32G399A_SPI_H_) */
