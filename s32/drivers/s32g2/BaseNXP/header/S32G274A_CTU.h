 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_CTU
 *
...
#if !defined(S32G274A_CTU_H_)  /* Check if memory map has not been already included */
#define S32G274A_CTU_H_
...
#define IP_CTU_BASE                              (0x401FC000u)
...
#endif  /* #if !defined(S32G274A_CTU_H_) */
