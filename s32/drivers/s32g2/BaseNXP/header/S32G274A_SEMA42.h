...
/*!
 * @file S32G274A_SEMA42.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_SEMA42
 *
...
#if !defined(S32G274A_SEMA42_H_)  /* Check if memory map has not been already included */
#define S32G274A_SEMA42_H_
...
#endif  /* #if !defined(S32G274A_SEMA42_H_) */
