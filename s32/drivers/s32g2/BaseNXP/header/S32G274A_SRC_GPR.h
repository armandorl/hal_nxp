...
/*!
 * @file S32G274A_SRC_GPR.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_SRC_GPR
 *
...
#if !defined(S32G274A_SRC_GPR_H_)  /* Check if memory map has not been already included */
#define S32G274A_SRC_GPR_H_
...
#define SRC_GPR_GPR12_GPR12_MASK                 (0xFFFFFFFFU)
#define SRC_GPR_GPR12_GPR12_SHIFT                (0U)
#define SRC_GPR_GPR12_GPR12_WIDTH                (32U)
...
#endif  /* #if !defined(S32G274A_SRC_GPR_H_) */
