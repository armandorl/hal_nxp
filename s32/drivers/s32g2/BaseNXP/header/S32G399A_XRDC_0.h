...
typedef struct {
  ...
  struct {                                         /* offset: 0x1400, array step: 0x8 */
  ...
  struct {                                         /* offset: 0x1800, array step: 0x8 */
  ...
  struct {                                         /* offset: 0x1C00, array step: 0x8 */
    __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control Word 0, array offset: 0x1C00, array step: 0x8 */
    __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control Word 1, array offset: 0x1C04, array step: 0x8 */
  ...
  struct {                                         /* offset: 0x4000, array step: 0x8 */
    __IO uint32_t PDAC_W0;                           /**< Peripheral Domain Access Control Word 0, array offset: 0x4000, array step: 0x8 */
    __IO uint32_t PDAC_W1;                           /**< Peripheral Domain Access Control Word 1, array offset: 0x4004, array step: 0x8 */
...
#define XRDC_0_MDA_W0_11_DFMT1_LPID_MASK         (0xF000000U)
#define XRDC_0_MDA_W0_11_DFMT1_LPID_SHIFT        (24U)
#define XRDC_0_MDA_W0_11_DFMT1_LPID_WIDTH        (4U)
#define XRDC_0_MDA_W0_11_DFMT1_LPID(x)           (((uint32_t)(((uint32_t)(x)) << XRDC_0_MDA_W0_11_DFMT1_LPID_SHIFT)) & XRDC_0_MDA_W0_11_DFMT1_LPID_MASK)

#define XRDC_0_MDA_W0_11_DFMT1_LPE_MASK          (0x10000000U)
#define XRDC_0_MDA_W0_11_DFMT1_LPE_SHIFT         (28U)
#define XRDC_0_MDA_W0_11_DFMT1_LPE_WIDTH         (1U)
#define XRDC_0_MDA_W0_11_DFMT1_LPE(x)            (((uint32_t)(((uint32_t)(x)) << XRDC_0_MDA_W0_11_DFMT1_LPE_SHIFT)) & XRDC_0_MDA_W0_11_DFMT1_LPE_MASK)
