...
/*!
 * @file S32G399A_QuadSPI_ARDB.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_QuadSPI_ARDB
 *
...
#if !defined(S32G399A_QuadSPI_ARDB_H_)  /* Check if memory map has not been already included */
#define S32G399A_QuadSPI_ARDB_H_
...
#define IP_QUADSPI_ARDB_BASE                     (0x41000000u)
...
#endif  /* #if !defined(S32G399A_QuadSPI_ARDB_H_) */
