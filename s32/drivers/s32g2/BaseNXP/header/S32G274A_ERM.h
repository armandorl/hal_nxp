 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_ERM
 *
...
#if !defined(S32G274A_ERM_H_)  /* Check if memory map has not been already included */
#define S32G274A_ERM_H_
...
#define IP_LLCE__ERM_LLCE_BASE                   (0x44030000u)
/** Peripheral LLCE__ERM_LLCE base pointer */
#define IP_LLCE__ERM_LLCE                        ((ERM_Type *)IP_LLCE__ERM_LLCE_BASE)
/** Array initializer of ERM peripheral base addresses */
#define IP_ERM_BASE_ADDRS                        { IP_ERM_CPU0_BASE, IP_ERM_CPU1_BASE, IP_ERM_CPU2_BASE, IP_ERM_EDMA0_BASE, IP_ERM_EDMA1_BASE, IP_ERM_PER_BASE, IP_ERM_PFE0_BASE, IP_ERM_PFE1_BASE, IP_ERM_PFE2_BASE, IP_ERM_PFE3_BASE, IP_ERM_PFE4_BASE, IP_ERM_PFE5_BASE, IP_ERM_PFE6_BASE, IP_ERM_PFE7_BASE, IP_ERM_PFE8_BASE, IP_ERM_PFE9_BASE, IP_ERM_PFE10_BASE, IP_ERM_PFE11_BASE, IP_ERM_PFE12_BASE, IP_ERM_PFE13_BASE, IP_ERM_PFE14_BASE, IP_ERM_PFE15_BASE, IP_ERM_STDBY_SRAM_BASE, IP_LLCE__ERM_LLCE_BASE }
/** Array initializer of ERM peripheral base pointers */
#define IP_ERM_BASE_PTRS                         { IP_ERM_CPU0, IP_ERM_CPU1, IP_ERM_CPU2, IP_ERM_EDMA0, IP_ERM_EDMA1, IP_ERM_PER, IP_ERM_PFE0, IP_ERM_PFE1, IP_ERM_PFE2, IP_ERM_PFE3, IP_ERM_PFE4, IP_ERM_PFE5, IP_ERM_PFE6, IP_ERM_PFE7, IP_ERM_PFE8, IP_ERM_PFE9, IP_ERM_PFE10, IP_ERM_PFE11, IP_ERM_PFE12, IP_ERM_PFE13, IP_ERM_PFE14, IP_ERM_PFE15, IP_ERM_STDBY_SRAM, IP_LLCE__ERM_LLCE }
...
#endif  /* #if !defined(S32G274A_ERM_H_) */
