 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_SAI
 *
...
#if !defined(S32G274_SAI_H_)  /* Check if memory map has not been already included */
#define S32G274_SAI_H_
...
typedef struct SAI_Struct {
  ...
  __IO uint32_t TDR[SAI_TDR_COUNT];                /**< Transmit Data, array offset: 0x20, array step: 0x4, irregular array, not all indices are valid */
  uint8_t RESERVED_0[16];
  __I  uint32_t TFR[SAI_TFR_COUNT];                /**< Transmit FIFO, array offset: 0x40, array step: 0x4, irregular array, not all indices are valid */
  ...
  __I  uint32_t RDR[SAI_RDR_COUNT];                /**< Receive Data, array offset: 0xA0, array step: 0x4, irregular array, not all indices are valid */
  uint8_t RESERVED_4[16];
  __I  uint32_t RFR[SAI_RFR_COUNT];                /**< Receive FIFO, array offset: 0xC0, array step: 0x4, irregular array, not all indices are valid */
...
#define SAI_TCR3_TCE_MASK                        (0xF0000U)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
#define SAI_TCR3_TCE_SHIFT                       (16U)
#define SAI_TCR3_TCE_WIDTH                       (4U)
#define SAI_TCR3_TCE(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_TCR3_TCE_SHIFT)) & SAI_TCR3_TCE_MASK)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */

#define SAI_TCR3_CFR_MASK                        (0xF000000U)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
#define SAI_TCR3_CFR_SHIFT                       (24U)
#define SAI_TCR3_CFR_WIDTH                       (4U)
#define SAI_TCR3_CFR(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_TCR3_CFR_SHIFT)) & SAI_TCR3_CFR_MASK)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
/*! @} */
...
#define SAI_TTCR_TSEN_MASK                       (0x1U)
#define SAI_TTCR_TSEN_SHIFT                      (0U)
#define SAI_TTCR_TSEN_WIDTH                      (1U)
#define SAI_TTCR_TSEN(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_TTCR_TSEN_SHIFT)) & SAI_TTCR_TSEN_MASK)

#define SAI_TTCR_TSINC_MASK                      (0x2U)
#define SAI_TTCR_TSINC_SHIFT                     (1U)
#define SAI_TTCR_TSINC_WIDTH                     (1U)
#define SAI_TTCR_TSINC(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_TTCR_TSINC_SHIFT)) & SAI_TTCR_TSINC_MASK)

#define SAI_TTCR_TSSEL_MASK                      (0xCU)
#define SAI_TTCR_TSSEL_SHIFT                     (2U)
#define SAI_TTCR_TSSEL_WIDTH                     (2U)
#define SAI_TTCR_TSSEL(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_TTCR_TSSEL_SHIFT)) & SAI_TTCR_TSSEL_MASK)

#define SAI_TTCR_RTSC_MASK                       (0x100U)
#define SAI_TTCR_RTSC_SHIFT                      (8U)
#define SAI_TTCR_RTSC_WIDTH                      (1U)
#define SAI_TTCR_RTSC(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_TTCR_RTSC_SHIFT)) & SAI_TTCR_RTSC_MASK)

#define SAI_TTCR_RBC_MASK                        (0x200U)
#define SAI_TTCR_RBC_SHIFT                       (9U)
#define SAI_TTCR_RBC_WIDTH                       (1U)
#define SAI_TTCR_RBC(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_TTCR_RBC_SHIFT)) & SAI_TTCR_RBC_MASK)
/*! @} */

/*! @name TTSR - Transmit Timestamp */
/*! @{ */

#define SAI_TTSR_TSC_MASK                        (0xFFFFFFFFU)
#define SAI_TTSR_TSC_SHIFT                       (0U)
#define SAI_TTSR_TSC_WIDTH                       (32U)
#define SAI_TTSR_TSC(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_TTSR_TSC_SHIFT)) & SAI_TTSR_TSC_MASK)
/*! @} */

/*! @name TBCR - Transmit Bit Count */
/*! @{ */

#define SAI_TBCR_BCNT_MASK                       (0xFFFFFFFFU)
#define SAI_TBCR_BCNT_SHIFT                      (0U)
#define SAI_TBCR_BCNT_WIDTH                      (32U)
#define SAI_TBCR_BCNT(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_TBCR_BCNT_SHIFT)) & SAI_TBCR_BCNT_MASK)
/*! @} */

/*! @name TBCTR - Transmit Bit Count Timestamp */
/*! @{ */

#define SAI_TBCTR_BCTS_MASK                      (0xFFFFFFFFU)
#define SAI_TBCTR_BCTS_SHIFT                     (0U)
#define SAI_TBCTR_BCTS_WIDTH                     (32U)
#define SAI_TBCTR_BCTS(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_TBCTR_BCTS_SHIFT)) & SAI_TBCTR_BCTS_MASK)
/*! @} */
...
#define SAI_RCR3_RCE_MASK                        (0xF0000U)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
#define SAI_RCR3_RCE_SHIFT                       (16U)
#define SAI_RCR3_RCE_WIDTH                       (4U)
#define SAI_RCR3_RCE(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_RCR3_RCE_SHIFT)) & SAI_RCR3_RCE_MASK)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */

#define SAI_RCR3_CFR_MASK                        (0xF000000U)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
#define SAI_RCR3_CFR_SHIFT                       (24U)
#define SAI_RCR3_CFR_WIDTH                       (4U)
#define SAI_RCR3_CFR(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_RCR3_CFR_SHIFT)) & SAI_RCR3_CFR_MASK)  /* Merged from fields with different position or width, of widths (2, 4), largest definition used */
/*! @} */
...
#define SAI_RTCR_TSEN_MASK                       (0x1U)
#define SAI_RTCR_TSEN_SHIFT                      (0U)
#define SAI_RTCR_TSEN_WIDTH                      (1U)
#define SAI_RTCR_TSEN(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_RTCR_TSEN_SHIFT)) & SAI_RTCR_TSEN_MASK)

#define SAI_RTCR_TSINC_MASK                      (0x2U)
#define SAI_RTCR_TSINC_SHIFT                     (1U)
#define SAI_RTCR_TSINC_WIDTH                     (1U)
#define SAI_RTCR_TSINC(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_RTCR_TSINC_SHIFT)) & SAI_RTCR_TSINC_MASK)

#define SAI_RTCR_TSSEL_MASK                      (0xCU)
#define SAI_RTCR_TSSEL_SHIFT                     (2U)
#define SAI_RTCR_TSSEL_WIDTH                     (2U)
#define SAI_RTCR_TSSEL(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_RTCR_TSSEL_SHIFT)) & SAI_RTCR_TSSEL_MASK)

#define SAI_RTCR_RTSC_MASK                       (0x100U)
#define SAI_RTCR_RTSC_SHIFT                      (8U)
#define SAI_RTCR_RTSC_WIDTH                      (1U)
#define SAI_RTCR_RTSC(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_RTCR_RTSC_SHIFT)) & SAI_RTCR_RTSC_MASK)

#define SAI_RTCR_RBC_MASK                        (0x200U)
#define SAI_RTCR_RBC_SHIFT                       (9U)
#define SAI_RTCR_RBC_WIDTH                       (1U)
#define SAI_RTCR_RBC(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_RTCR_RBC_SHIFT)) & SAI_RTCR_RBC_MASK)
/*! @} */

/*! @name RTSR - Receive Timestamp */
/*! @{ */

#define SAI_RTSR_TSC_MASK                        (0xFFFFFFFFU)
#define SAI_RTSR_TSC_SHIFT                       (0U)
#define SAI_RTSR_TSC_WIDTH                       (32U)
#define SAI_RTSR_TSC(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_RTSR_TSC_SHIFT)) & SAI_RTSR_TSC_MASK)
/*! @} */

/*! @name RBCR - Receive Bit Count */
/*! @{ */

#define SAI_RBCR_BCNT_MASK                       (0xFFFFFFFFU)
#define SAI_RBCR_BCNT_SHIFT                      (0U)
#define SAI_RBCR_BCNT_WIDTH                      (32U)
#define SAI_RBCR_BCNT(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_RBCR_BCNT_SHIFT)) & SAI_RBCR_BCNT_MASK)
/*! @} */

/*! @name RBCTR - Receive Bit Count Timestamp */
/*! @{ */

#define SAI_RBCTR_BCTS_MASK                      (0xFFFFFFFFU)
#define SAI_RBCTR_BCTS_SHIFT                     (0U)
#define SAI_RBCTR_BCTS_WIDTH                     (32U)
#define SAI_RBCTR_BCTS(x)                        (((uint32_t)(((uint32_t)(x)) << SAI_RBCTR_BCTS_SHIFT)) & SAI_RBCTR_BCTS_MASK)
/*! @} */

/*! @name MCR - MCLK Control */
/*! @{ */

#define SAI_MCR_DIV_MASK                         (0xFFU)
#define SAI_MCR_DIV_SHIFT                        (0U)
#define SAI_MCR_DIV_WIDTH                        (8U)
#define SAI_MCR_DIV(x)                           (((uint32_t)(((uint32_t)(x)) << SAI_MCR_DIV_SHIFT)) & SAI_MCR_DIV_MASK)

#define SAI_MCR_DIVEN_MASK                       (0x800000U)
#define SAI_MCR_DIVEN_SHIFT                      (23U)
#define SAI_MCR_DIVEN_WIDTH                      (1U)
#define SAI_MCR_DIVEN(x)                         (((uint32_t)(((uint32_t)(x)) << SAI_MCR_DIVEN_SHIFT)) & SAI_MCR_DIVEN_MASK)

#define SAI_MCR_MSEL_MASK                        (0x3000000U)
#define SAI_MCR_MSEL_SHIFT                       (24U)
#define SAI_MCR_MSEL_WIDTH                       (2U)
#define SAI_MCR_MSEL(x)                          (((uint32_t)(((uint32_t)(x)) << SAI_MCR_MSEL_SHIFT)) & SAI_MCR_MSEL_MASK)

#define SAI_MCR_MOE_MASK                         (0x40000000U)
#define SAI_MCR_MOE_SHIFT                        (30U)
#define SAI_MCR_MOE_WIDTH                        (1U)
#define SAI_MCR_MOE(x)                           (((uint32_t)(((uint32_t)(x)) << SAI_MCR_MOE_SHIFT)) & SAI_MCR_MOE_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274_SAI_H_) */
