...
#define IP_ERM_LAX_0_BASE                        (0x440CD000u)
/** Peripheral ERM_LAX_0 base pointer */
#define IP_ERM_LAX_0                             ((ERM_Type *)IP_ERM_LAX_0_BASE)
/** Peripheral ERM_LAX_1 base address */
#define IP_ERM_LAX_1_BASE                        (0x440CF000u)
/** Peripheral ERM_LAX_1 base pointer */
#define IP_ERM_LAX_1                             ((ERM_Type *)IP_ERM_LAX_1_BASE)
...
#define IP_ERM_PER_1_BASE                        (0x440C4000u)
/** Peripheral ERM_PER_1 base pointer */
#define IP_ERM_PER_1                             ((ERM_Type *)IP_ERM_PER_1_BASE)
/** Array initializer of ERM peripheral base addresses */
#define IP_ERM_BASE_ADDRS                        { IP_ERM_CPU0_BASE, IP_ERM_CPU1_BASE, IP_ERM_CPU2_BASE, IP_ERM_EDMA0_BASE, IP_ERM_EDMA1_BASE, IP_ERM_LAX_0_BASE, IP_ERM_LAX_1_BASE, IP_ERM_PER_BASE, IP_ERM_PER_1_BASE }
/** Array initializer of ERM peripheral base pointers */
#define IP_ERM_BASE_PTRS                         { IP_ERM_CPU0, IP_ERM_CPU1, IP_ERM_CPU2, IP_ERM_EDMA0, IP_ERM_EDMA1, IP_ERM_LAX_0, IP_ERM_LAX_1, IP_ERM_PER, IP_ERM_PER_1 }
