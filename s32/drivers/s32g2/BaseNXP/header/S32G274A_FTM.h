 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_FTM
 *
...
#if !defined(S32G274A_FTM_H_)  /* Check if memory map has not been already included */
#define S32G274A_FTM_H_
...
#define IP_FTM_0_BASE                            (0x401F4000u)
/** Peripheral FTM_0 base pointer */
#define IP_FTM_0                                 ((FTM_Type *)IP_FTM_0_BASE)
/** Peripheral FTM_1 base address */
#define IP_FTM_1_BASE                            (0x402E4000u)
/** Peripheral FTM_1 base pointer */
#define IP_FTM_1                                 ((FTM_Type *)IP_FTM_1_BASE)
/** Array initializer of FTM peripheral base addresses */
#define IP_FTM_BASE_ADDRS                  { IP_FTM_0_BASE, IP_FTM_1_BASE }
/** Array initializer of FTM peripheral base pointers */
#define IP_FTM_BASE_PTRS                   { IP_FTM_0, IP_FTM_1 }
...
#endif  /* #if !defined(S32G274A_FTM_H_) */
