...
/*!
 * @file S32G399A_BOOT.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_BOOT
 *
...
#if !defined(S32G399A_BOOT_H_)  /* Check if memory map has not been already included */
#define S32G399A_BOOT_H_
...
#define IP_BOOT_CC_BASE                          (0x4007C900u)
/** Peripheral BOOT_CC base pointer */
#define IP_BOOT_CC                               ((BOOT_Type *)IP_BOOT_CC_BASE)
/** Array initializer of BOOT peripheral base addresses */
#define IP_BOOT_BASE_ADDRS                       { IP_BOOT_CC_BASE }
/** Array initializer of BOOT peripheral base pointers */
#define IP_BOOT_BASE_PTRS                        { IP_BOOT_CC }
...
#define BOOT_BOOT_GPR_BMR2_BOOTMOD2_MASK         (0x1000000U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD2_SHIFT        (24U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD2_WIDTH        (1U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD2(x)           (((uint32_t)(((uint32_t)(x)) << BOOT_BOOT_GPR_BMR2_BOOTMOD2_SHIFT)) & BOOT_BOOT_GPR_BMR2_BOOTMOD2_MASK)

#define BOOT_BOOT_GPR_BMR2_BOOTMOD1_MASK         (0x2000000U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD1_SHIFT        (25U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD1_WIDTH        (1U)
#define BOOT_BOOT_GPR_BMR2_BOOTMOD1(x)           (((uint32_t)(((uint32_t)(x)) << BOOT_BOOT_GPR_BMR2_BOOTMOD1_SHIFT)) & BOOT_BOOT_GPR_BMR2_BOOTMOD1_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G399A_BOOT_H_) */
