 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_STM
 *
...
#if !defined(S32G274_STM_H_)  /* Check if memory map has not been already included */
#define S32G274_STM_H_
...
#define STM_INSTANCE_COUNT                       (8u)

/* STM - Peripheral instance base addresses */
/** Peripheral CPE_STM_0 base address */
#define IP_CPE_STM_0_BASE                        (0x410A4000u)
/** Peripheral CPE_STM_0 base pointer */
#define IP_CPE_STM_0                             ((STM_Type *)IP_CPE_STM_0_BASE)
/** Peripheral CPE_STM_1 base address */
#define IP_CPE_STM_1_BASE                        (0x41154000u)
/** Peripheral CPE_STM_1 base pointer */
#define IP_CPE_STM_1                             ((STM_Type *)IP_CPE_STM_1_BASE)
/** Peripheral DSP4__STM base address */
#define IP_DSP4__STM_BASE                        (0x42618000u)
/** Peripheral DSP4__STM base pointer */
#define IP_DSP4__STM                             ((STM_Type *)IP_DSP4__STM_BASE)
/** Peripheral LPE_STM base address */
#define IP_LPE_STM_BASE                          (0x42168000u)
/** Peripheral LPE_STM base pointer */
#define IP_LPE_STM                               ((STM_Type *)IP_LPE_STM_BASE)
/** Peripheral STM_0 base address */
#define IP_STM_0_BASE                            (0x405A4000u)
/** Peripheral STM_0 base pointer */
#define IP_STM_0                                 ((STM_Type *)IP_STM_0_BASE)
/** Peripheral STM_1 base address */
#define IP_STM_1_BASE                            (0x40B98000u)
/** Peripheral STM_1 base pointer */
#define IP_STM_1                                 ((STM_Type *)IP_STM_1_BASE)
/** Peripheral STM_2 base address */
#define IP_STM_2_BASE                            (0x40B9C000u)
/** Peripheral STM_2 base pointer */
#define IP_STM_2                                 ((STM_Type *)IP_STM_2_BASE)
/** Peripheral STM_3 base address */
#define IP_STM_3_BASE                            (0x40BA0000u)
/** Peripheral STM_3 base pointer */
#define IP_STM_3                                 ((STM_Type *)IP_STM_3_BASE)
/** Array initializer of STM peripheral base addresses */
#define IP_STM_BASE_ADDRS                        { IP_CPE_STM_0_BASE, IP_CPE_STM_1_BASE, IP_DSP4__STM_BASE, IP_LPE_STM_BASE, IP_STM_0_BASE, IP_STM_1_BASE, IP_STM_2_BASE, IP_STM_3_BASE }
/** Array initializer of STM peripheral base pointers */
#define IP_STM_BASE_PTRS                         { IP_CPE_STM_0, IP_CPE_STM_1, IP_DSP4__STM, IP_LPE_STM, IP_STM_0, IP_STM_1, IP_STM_2, IP_STM_3 }
...
#endif  /* #if !defined(S32G274_STM_H_) */
