...
/*!
 * @file S32G274_NETC_IERB.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_NETC_IERB
 *
...
#if !defined(S32G274_NETC_IERB_H_)  /* Check if memory map has not been already included */
#define S32G274_NETC_IERB_H_
...
#define NETC_IERB_CFG_VSI_INST_COUNT              5u

/** NETC_IERB - Register Layout Typedef */
typedef struct NETC_IERB_Struct {
  ...
  struct NETC_IERB_NUM_TMR_ARRAY {                 /* offset: 0x400, array step: 0x64 */
    uint8_t RESERVED_0[20];
    __IO uint32_t TMCR;                              /**< Timer 0 MSI-X configuration register, array offset: 0x414, array step: 0x64 */
    uint8_t RESERVED_1[8];
    __IO uint32_t T_CFH_DIDVID;                      /**< Timer 0 config header device ID and vendor ID register, array offset: 0x420, array step: 0x64 */
    __IO uint32_t T_CFH_SIDSVID;                     /**< Timer 0 config header subsystem ID and subsystem vendor ID register, array offset: 0x424, array step: 0x64 */
    uint8_t RESERVED_2[28];
    __IO uint32_t TFAUXR;                            /**< Timer 0 function auxiliary register, array offset: 0x444, array step: 0x64 */
    __IO uint32_t TBLPR[NETC_IERB_NUM_TMR_ARRAY_TMR_PF_BOOT_LOAD_COUNT];   /**< Timer 0 boot loader parameter register 0..Timer 0 boot loader parameter register 1, array offset: 0x448, array step: index*0x64, index2*0x4 */
    uint8_t RESERVED_3[16];
    __IO uint32_t TRIDAR;                            /**< Timer 0 RID assignment register, array offset: 0x460, array step: 0x64 */
  } NUM_TMR_ARRAY[NETC_IERB_NUM_TMR_ARRAY_COUNT];
  uint8_t RESERVED_15[432];
  __IO uint32_t TM0MCR;                            /**< Timer media channel 0 MSI-X configuration register, offset: 0x614 */
  uint8_t RESERVED_16[8];
  __IO uint32_t TM_CFH_DIDVID;                     /**< Timer media channel config header device ID and vendor ID register, offset: 0x620 */
  __IO uint32_t TM_CFH_SIDSVID;                    /**< Timer media channel config header subsystem ID and subsystem vendor ID register, offset: 0x624 */
  uint8_t RESERVED_17[8];
  __IO uint32_t TM0CAR;                            /**< Timer media channel 0 cache attribute register, offset: 0x630 */
  uint8_t RESERVED_18[12];
  __IO uint32_t TM0AMQR;                           /**< Timer media channel 0 access management qualifier register, offset: 0x640 */
  __IO uint32_t TM0FAUXR;                          /**< Timer media channel 0 function auxiliary register, offset: 0x644 */
  uint8_t RESERVED_19[24];
  __IO uint32_t TM0RIDAR;                          /**< Timer media channel 0 RID assignment register, offset: 0x660 */
  uint8_t RESERVED_20[412];
  ...
  __IO uint32_t GM0ATCAPR;                         /**< Gate manager 0 advance time capability register, offset: 0x80C */
  uint8_t RESERVED_21[2032];
  ...
  struct NETC_IERB_CFG_SW_INST {                   /* offset: 0x2000, array step: 0x21C */
    ...
    __IO uint32_t SASIITMAR;                         /**< Switch 0 ATS scheduler instance index table memory allocation register, array offset: 0x20C8, array step: 0x21C */
  ...
  struct NETC_IERB_CFG_ENETC_INST {                /* offset: 0x3000, array step: 0xF8 */
    ...
    uint8_t RESERVED_1[4];
    __IO uint32_t EVFRIDAR;                          /**< ENETC 0 VF RID assignment register, array offset: 0x3010, array step: 0xF8 */
    __IO uint32_t EMCR;                              /**< ENETC 0 MSI-X configuration register, array offset: 0x3014, array step: 0xF8 */
    __I  uint32_t EEVMCR;                            /**< ENETC 0 event monitor configuration register, array offset: 0x3018, array step: 0xF8 */
    ...
    __IO uint32_t EFAUXR;                            /**< ENETC 0 function auxiliary register, array offset: 0x3044, array step: 0xF8 */
    ...
    __IO uint32_t ERIDAR;                            /**< ENETC 0 RID assignment register, array offset: 0x3060, array step: 0xF8 */
  ...
  uint8_t RESERVED_41[3848];
  struct NETC_IERB_CFG_VSI_INST {                  /* offset: 0x4000, array step: 0x40 */
    __IO uint32_t VAMQR;                             /**< VSI 0 access management qualifier register..VSI 4 access management qualifier register, array offset: 0x4000, array step: 0x40 */
    __IO uint32_t VFAUXR;                            /**< VSI 0 function auxiliary register..VSI 4 function auxiliary register, array offset: 0x4004, array step: 0x40 */
    __IO uint32_t VBLPR[NETC_IERB_CFG_VSI_INST_VSI_PF_BOOT_LOAD_COUNT];   /**< VSI 0 boot loader parameter register 0..VSI 4 boot loader parameter register 1, array offset: 0x4008, array step: index*0x40, index2*0x4 */
    __IO uint32_t VPMAR0;                            /**< VSI 0 primary MAC address register 0..VSI 4 primary MAC address register 0, array offset: 0x4010, array step: 0x40 */
    __IO uint32_t VPMAR1;                            /**< VSI 0 primary MAC address register 1..VSI 4 primary MAC address register 1, array offset: 0x4014, array step: 0x40 */
...
#define IP_NETC__NETC_IERB_BASE                  (0x6D200000u)
...
#define NETC_IERB_CAPR2_NUM_EVM_WIDTH            (6U)
...
#define NETC_IERB_ITTMCAPR_NUM_WORDS_WIDTH       (16U)
...
#define NETC_IERB_ITTMCAPR_WORD_SIZE_WIDTH       (2U)
...
#define NETC_IERB_ITTCR_MAX_VISITS_WIDTH         (4U)
...
#define NETC_IERB_RCMSICAR_MSI_WRSNP_WIDTH       (2U)
...
#define NETC_IERB_EMDIOFAUXR_FAUX_WIDTH          (4U)
...
#define NETC_IERB_EMDIORIDAR_RID_WIDTH           (16U)
...
#define NETC_IERB_EMDIORIDAR_PBUS_WIDTH          (8U)
...
/*! @name TFAUXR - Timer 0 function auxiliary register */
/*! @{ */

#define NETC_IERB_TFAUXR_FAUX_MASK               (0xFU)
#define NETC_IERB_TFAUXR_FAUX_SHIFT              (0U)
#define NETC_IERB_TFAUXR_FAUX_WIDTH              (4U)
...
/*! @name TRIDAR - Timer 0 RID assignment register */
/*! @{ */

#define NETC_IERB_TRIDAR_RID_MASK                (0xFFFFU)
#define NETC_IERB_TRIDAR_RID_SHIFT               (0U)
#define NETC_IERB_TRIDAR_RID_WIDTH               (16U)
...
#define NETC_IERB_TRIDAR_PBUS_WIDTH              (8U)
#define NETC_IERB_TRIDAR_PBUS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TRIDAR_PBUS_SHIFT)) & NETC_IERB_TRIDAR_PBUS_MASK)
/*! @} */

/*! @name TM0MCR - Timer media channel 0 MSI-X configuration register */
/*! @{ */

#define NETC_IERB_TM0MCR_NUM_MSIX_MASK           (0x1U)
#define NETC_IERB_TM0MCR_NUM_MSIX_SHIFT          (0U)
#define NETC_IERB_TM0MCR_NUM_MSIX_WIDTH          (1U)
#define NETC_IERB_TM0MCR_NUM_MSIX(x)             (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0MCR_NUM_MSIX_SHIFT)) & NETC_IERB_TM0MCR_NUM_MSIX_MASK)
/*! @} */

/*! @name TM_CFH_DIDVID - Timer media channel config header device ID and vendor ID register */
/*! @{ */

#define NETC_IERB_TM_CFH_DIDVID_VENDOR_ID_MASK   (0xFFFFU)
#define NETC_IERB_TM_CFH_DIDVID_VENDOR_ID_SHIFT  (0U)
#define NETC_IERB_TM_CFH_DIDVID_VENDOR_ID_WIDTH  (16U)
#define NETC_IERB_TM_CFH_DIDVID_VENDOR_ID(x)     (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM_CFH_DIDVID_VENDOR_ID_SHIFT)) & NETC_IERB_TM_CFH_DIDVID_VENDOR_ID_MASK)

#define NETC_IERB_TM_CFH_DIDVID_DEVICE_ID_MASK   (0xFFFF0000U)
#define NETC_IERB_TM_CFH_DIDVID_DEVICE_ID_SHIFT  (16U)
#define NETC_IERB_TM_CFH_DIDVID_DEVICE_ID_WIDTH  (16U)
#define NETC_IERB_TM_CFH_DIDVID_DEVICE_ID(x)     (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM_CFH_DIDVID_DEVICE_ID_SHIFT)) & NETC_IERB_TM_CFH_DIDVID_DEVICE_ID_MASK)
/*! @} */

/*! @name TM_CFH_SIDSVID - Timer media channel config header subsystem ID and subsystem vendor ID register */
/*! @{ */

#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID_MASK (0xFFFFU)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID_SHIFT (0U)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID_WIDTH (16U)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID(x) (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID_SHIFT)) & NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_VENDOR_ID_MASK)

#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID_MASK (0xFFFF0000U)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID_SHIFT (16U)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID_WIDTH (16U)
#define NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID(x) (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID_SHIFT)) & NETC_IERB_TM_CFH_SIDSVID_SUBSYSTEM_DEVICE_ID_MASK)
/*! @} */

/*! @name TM0CAR - Timer media channel 0 cache attribute register */
/*! @{ */

#define NETC_IERB_TM0CAR_WRCACHE_MASK            (0xFU)
#define NETC_IERB_TM0CAR_WRCACHE_SHIFT           (0U)
#define NETC_IERB_TM0CAR_WRCACHE_WIDTH           (4U)
#define NETC_IERB_TM0CAR_WRCACHE(x)              (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_WRCACHE_SHIFT)) & NETC_IERB_TM0CAR_WRCACHE_MASK)

#define NETC_IERB_TM0CAR_WRDOMAIN_MASK           (0x30U)
#define NETC_IERB_TM0CAR_WRDOMAIN_SHIFT          (4U)
#define NETC_IERB_TM0CAR_WRDOMAIN_WIDTH          (2U)
#define NETC_IERB_TM0CAR_WRDOMAIN(x)             (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_WRDOMAIN_SHIFT)) & NETC_IERB_TM0CAR_WRDOMAIN_MASK)

#define NETC_IERB_TM0CAR_WRSNP_MASK              (0xC0U)
#define NETC_IERB_TM0CAR_WRSNP_SHIFT             (6U)
#define NETC_IERB_TM0CAR_WRSNP_WIDTH             (2U)
#define NETC_IERB_TM0CAR_WRSNP(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_WRSNP_SHIFT)) & NETC_IERB_TM0CAR_WRSNP_MASK)

#define NETC_IERB_TM0CAR_RDCACHE_MASK            (0xF0000U)
#define NETC_IERB_TM0CAR_RDCACHE_SHIFT           (16U)
#define NETC_IERB_TM0CAR_RDCACHE_WIDTH           (4U)
#define NETC_IERB_TM0CAR_RDCACHE(x)              (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_RDCACHE_SHIFT)) & NETC_IERB_TM0CAR_RDCACHE_MASK)

#define NETC_IERB_TM0CAR_RDDOMAIN_MASK           (0x300000U)
#define NETC_IERB_TM0CAR_RDDOMAIN_SHIFT          (20U)
#define NETC_IERB_TM0CAR_RDDOMAIN_WIDTH          (2U)
#define NETC_IERB_TM0CAR_RDDOMAIN(x)             (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_RDDOMAIN_SHIFT)) & NETC_IERB_TM0CAR_RDDOMAIN_MASK)

#define NETC_IERB_TM0CAR_RDSNP_MASK              (0xC00000U)
#define NETC_IERB_TM0CAR_RDSNP_SHIFT             (22U)
#define NETC_IERB_TM0CAR_RDSNP_WIDTH             (2U)
#define NETC_IERB_TM0CAR_RDSNP(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0CAR_RDSNP_SHIFT)) & NETC_IERB_TM0CAR_RDSNP_MASK)
/*! @} */

/*! @name TM0AMQR - Timer media channel 0 access management qualifier register */
/*! @{ */

#define NETC_IERB_TM0AMQR_ARQOS_MASK             (0xF0000U)
#define NETC_IERB_TM0AMQR_ARQOS_SHIFT            (16U)
#define NETC_IERB_TM0AMQR_ARQOS_WIDTH            (4U)
#define NETC_IERB_TM0AMQR_ARQOS(x)               (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0AMQR_ARQOS_SHIFT)) & NETC_IERB_TM0AMQR_ARQOS_MASK)

#define NETC_IERB_TM0AMQR_AWQOS_MASK             (0xF00000U)
#define NETC_IERB_TM0AMQR_AWQOS_SHIFT            (20U)
#define NETC_IERB_TM0AMQR_AWQOS_WIDTH            (4U)
#define NETC_IERB_TM0AMQR_AWQOS(x)               (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0AMQR_AWQOS_SHIFT)) & NETC_IERB_TM0AMQR_AWQOS_MASK)
/*! @} */

/*! @name TM0FAUXR - Timer media channel 0 function auxiliary register */
/*! @{ */

#define NETC_IERB_TM0FAUXR_FAUX_MASK             (0xFU)
#define NETC_IERB_TM0FAUXR_FAUX_SHIFT            (0U)
#define NETC_IERB_TM0FAUXR_FAUX_WIDTH            (4U)
#define NETC_IERB_TM0FAUXR_FAUX(x)               (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0FAUXR_FAUX_SHIFT)) & NETC_IERB_TM0FAUXR_FAUX_MASK)
/*! @} */

/*! @name TM0RIDAR - Timer media channel 0 RID assignment register */
/*! @{ */

#define NETC_IERB_TM0RIDAR_RID_MASK              (0xFFFFU)
#define NETC_IERB_TM0RIDAR_RID_SHIFT             (0U)
#define NETC_IERB_TM0RIDAR_RID_WIDTH             (16U)
#define NETC_IERB_TM0RIDAR_RID(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0RIDAR_RID_SHIFT)) & NETC_IERB_TM0RIDAR_RID_MASK)

#define NETC_IERB_TM0RIDAR_PBUS_MASK             (0xFF0000U)
#define NETC_IERB_TM0RIDAR_PBUS_SHIFT            (16U)
#define NETC_IERB_TM0RIDAR_PBUS_WIDTH            (8U)
#define NETC_IERB_TM0RIDAR_PBUS(x)               (((uint32_t)(((uint32_t)(x)) << NETC_IERB_TM0RIDAR_PBUS_SHIFT)) & NETC_IERB_TM0RIDAR_PBUS_MASK)
/*! @} */
...
#define NETC_IERB_TGSMCAPR_NUM_MEM_WIDTH         (4U)
...
#define NETC_IERB_TGSM0MAPR_SWn_WIDTH            (16U)
...
#define NETC_IERB_TGSM0MAPR_ENETCn_WIDTH         (16U)
...
#define NETC_IERB_TGSM0CAPR_NUM_WORDS_WIDTH      (16U)
...
/*! @name GM0ATCAPR - Gate manager 0 advance time capability register */
/*! @{ */

#define NETC_IERB_GM0ATCAPR_ADVANCE_TIME_MASK    (0xFFFU)
#define NETC_IERB_GM0ATCAPR_ADVANCE_TIME_SHIFT   (0U)
#define NETC_IERB_GM0ATCAPR_ADVANCE_TIME_WIDTH   (12U)
#define NETC_IERB_GM0ATCAPR_ADVANCE_TIME(x)      (((uint32_t)(((uint32_t)(x)) << NETC_IERB_GM0ATCAPR_ADVANCE_TIME_SHIFT)) & NETC_IERB_GM0ATCAPR_ADVANCE_TIME_MASK)
/*! @} */
...
#define NETC_IERB_L0CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L0CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L0CAPR_ECBS_SHIFT)) & NETC_IERB_L0CAPR_ECBS_MASK)

#define NETC_IERB_L0CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L0CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L0CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L0CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L0CAPR_ATS_SHIFT)) & NETC_IERB_L0CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L0MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L0MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L0MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L0MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L0MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L0MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L0MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L0MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L0MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L0MCAPR_MSEC_SHIFT)) & NETC_IERB_L0MCAPR_MSEC_MASK)

#define NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L0MCAPR_RGMII_DLY_MODE_CAP_MASK)
...
#define NETC_IERB_L1CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L1CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L1CAPR_ECBS_SHIFT)) & NETC_IERB_L1CAPR_ECBS_MASK)

#define NETC_IERB_L1CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L1CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L1CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L1CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L1CAPR_ATS_SHIFT)) & NETC_IERB_L1CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L1MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L1MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L1MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L1MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L1MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L1MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L1MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L1MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L1MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L1MCAPR_MSEC_SHIFT)) & NETC_IERB_L1MCAPR_MSEC_MASK)

#define NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L1MCAPR_RGMII_DLY_MODE_CAP_MASK)
...
#define NETC_IERB_L2CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L2CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L2CAPR_ECBS_SHIFT)) & NETC_IERB_L2CAPR_ECBS_MASK)

#define NETC_IERB_L2CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L2CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L2CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L2CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L2CAPR_ATS_SHIFT)) & NETC_IERB_L2CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L2MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L2MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L2MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L2MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L2MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L2MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L2MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L2MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L2MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L2MCAPR_MSEC_SHIFT)) & NETC_IERB_L2MCAPR_MSEC_MASK)

#define NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L2MCAPR_RGMII_DLY_MODE_CAP_MASK)
...
#define NETC_IERB_L2IOCAPR_PCS_PROT_WIDTH        (16U)
...
#define NETC_IERB_L2IOCAPR_IO_VAR_WIDTH          (4U)
...
#define NETC_IERB_L2IOCAPR_REVMII_RATE_WIDTH     (1U)
...
#define NETC_IERB_L2IOCAPR_REVMII_WIDTH          (1U)
...
#define NETC_IERB_L2BCR_MDIO_PHYAD_PRTAD_WIDTH   (5U)
...
#define NETC_IERB_L3CAPR_LINK_TYPE_WIDTH         (1U)
...
#define NETC_IERB_L3CAPR_NUM_TC_WIDTH            (4U)
...
#define NETC_IERB_L3CAPR_NUM_Q_WIDTH             (4U)
...
#define NETC_IERB_L3CAPR_NUM_CG_WIDTH            (4U)
...
#define NETC_IERB_L3CAPR_TGS_WIDTH               (1U)
...
#define NETC_IERB_L3CAPR_CBS_WIDTH               (1U)
...
#define NETC_IERB_L3CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L3CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L3CAPR_ECBS_SHIFT)) & NETC_IERB_L3CAPR_ECBS_MASK)

#define NETC_IERB_L3CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L3CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L3CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L3CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L3CAPR_ATS_SHIFT)) & NETC_IERB_L3CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L3MCAPR_MAC_VAR_WIDTH          (3U)
...
#define NETC_IERB_L3MCAPR_EFPAD_WIDTH            (2U)
...
#define NETC_IERB_L3MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L3MCAPR_HD_WIDTH               (1U)
...
#define NETC_IERB_L3MCAPR_FP_WIDTH               (2U)
...
#define NETC_IERB_L3MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L3MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L3MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L3MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L3MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L3MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L3MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L3MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L3MCAPR_MSEC_SHIFT)) & NETC_IERB_L3MCAPR_MSEC_MASK)

#define NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L3MCAPR_RGMII_DLY_MODE_CAP_MASK)

#define NETC_IERB_L3MCAPR_MII_PROT_MASK          (0xF000000U)
#define NETC_IERB_L3MCAPR_MII_PROT_SHIFT         (24U)
#define NETC_IERB_L3MCAPR_MII_PROT_WIDTH         (4U)
...
#define NETC_IERB_L3IOCAPR_PCS_PROT_WIDTH        (16U)
...
#define NETC_IERB_L3IOCAPR_IO_VAR_WIDTH          (4U)
...
#define NETC_IERB_L3IOCAPR_REVMII_RATE_WIDTH     (1U)
...
#define NETC_IERB_L3IOCAPR_REVMII_WIDTH          (1U)
...
#define NETC_IERB_L3BCR_SW_PORT_ENETC_INST_WIDTH (5U)
...
#define NETC_IERB_L3BCR_NETC_FUNC_WIDTH          (1U)
...
#define NETC_IERB_L3BCR_MDIO_PHYAD_PRTAD_WIDTH   (5U)
...
#define NETC_IERB_L3BCR_SPL_SW_PORT_WIDTH        (5U)
...
#define NETC_IERB_L3TXBCCTR_THRESH_WIDTH         (16U)
...
#define NETC_IERB_L3E0MAR0_MAC_ADDR_WIDTH        (32U)
...
#define NETC_IERB_L3E0MAR1_MAC_ADDR_WIDTH        (16U)
...
#define NETC_IERB_L4CAPR_LINK_TYPE_WIDTH         (1U)
...
#define NETC_IERB_L4CAPR_NUM_TC_WIDTH            (4U)
...
#define NETC_IERB_L4CAPR_NUM_Q_WIDTH             (4U)
...
#define NETC_IERB_L4CAPR_NUM_CG_WIDTH            (4U)
...
#define NETC_IERB_L4CAPR_TGS_WIDTH               (1U)
...
#define NETC_IERB_L4CAPR_CBS_WIDTH               (1U)
...
#define NETC_IERB_L4CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L4CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L4CAPR_ECBS_SHIFT)) & NETC_IERB_L4CAPR_ECBS_MASK)

#define NETC_IERB_L4CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L4CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L4CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L4CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L4CAPR_ATS_SHIFT)) & NETC_IERB_L4CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L4MCAPR_MAC_VAR_WIDTH          (3U)
...
#define NETC_IERB_L4MCAPR_EFPAD_WIDTH            (2U)
...
#define NETC_IERB_L4MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L4MCAPR_HD_WIDTH               (1U)
...
#define NETC_IERB_L4MCAPR_FP_WIDTH               (2U)
...
#define NETC_IERB_L4MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L4MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L4MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L4MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L4MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L4MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L4MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L4MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L4MCAPR_MSEC_SHIFT)) & NETC_IERB_L4MCAPR_MSEC_MASK)

#define NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L4MCAPR_RGMII_DLY_MODE_CAP_MASK)

#define NETC_IERB_L4MCAPR_MII_PROT_MASK          (0xF000000U)
#define NETC_IERB_L4MCAPR_MII_PROT_SHIFT         (24U)
#define NETC_IERB_L4MCAPR_MII_PROT_WIDTH         (4U)
...
#define NETC_IERB_L4IOCAPR_PCS_PROT_WIDTH        (16U)
...
#define NETC_IERB_L4IOCAPR_IO_VAR_WIDTH          (4U)
...
#define NETC_IERB_L4IOCAPR_REVMII_RATE_WIDTH     (1U)
...
#define NETC_IERB_L4IOCAPR_REVMII_WIDTH          (1U)
...
#define NETC_IERB_L4BCR_SW_PORT_ENETC_INST_WIDTH (5U)
...
#define NETC_IERB_L4BCR_NETC_FUNC_WIDTH          (1U)
...
#define NETC_IERB_L4BCR_MDIO_PHYAD_PRTAD_WIDTH   (5U)
...
#define NETC_IERB_L4BCR_SPL_SW_PORT_WIDTH        (5U)
...
#define NETC_IERB_L4TXBCCTR_THRESH_WIDTH         (16U)
...
#define NETC_IERB_L4E0MAR0_MAC_ADDR_WIDTH        (32U)
...
#define NETC_IERB_L4E0MAR1_MAC_ADDR_WIDTH        (16U)
...
#define NETC_IERB_L5CAPR_LINK_TYPE_WIDTH         (1U)
...
#define NETC_IERB_L5CAPR_NUM_TC_WIDTH            (4U)
...
#define NETC_IERB_L5CAPR_NUM_Q_WIDTH             (4U)
...
#define NETC_IERB_L5CAPR_NUM_CG_WIDTH            (4U)
...
#define NETC_IERB_L5CAPR_TGS_WIDTH               (1U)
...
#define NETC_IERB_L5CAPR_CBS_WIDTH               (1U)
...
#define NETC_IERB_L5CAPR_ECBS_WIDTH              (1U)
#define NETC_IERB_L5CAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L5CAPR_ECBS_SHIFT)) & NETC_IERB_L5CAPR_ECBS_MASK)

#define NETC_IERB_L5CAPR_ATS_MASK                (0x80000000U)
#define NETC_IERB_L5CAPR_ATS_SHIFT               (31U)
#define NETC_IERB_L5CAPR_ATS_WIDTH               (1U)
#define NETC_IERB_L5CAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L5CAPR_ATS_SHIFT)) & NETC_IERB_L5CAPR_ATS_MASK)
/*! @} */
...
#define NETC_IERB_L5MCAPR_MAC_VAR_WIDTH          (3U)
...
#define NETC_IERB_L5MCAPR_EFPAD_WIDTH            (2U)
...
#define NETC_IERB_L5MCAPR_PIPG_WIDTH             (1U)
...
#define NETC_IERB_L5MCAPR_HD_WIDTH               (1U)
...
#define NETC_IERB_L5MCAPR_FP_WIDTH               (2U)
...
#define NETC_IERB_L5MCAPR_MIN_MPDU_WIDTH         (1U)
#define NETC_IERB_L5MCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L5MCAPR_MIN_MPDU_SHIFT)) & NETC_IERB_L5MCAPR_MIN_MPDU_MASK)

#define NETC_IERB_L5MCAPR_MSEC_MASK              (0x2000U)
#define NETC_IERB_L5MCAPR_MSEC_SHIFT             (13U)
#define NETC_IERB_L5MCAPR_MSEC_WIDTH             (1U)
#define NETC_IERB_L5MCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L5MCAPR_MSEC_SHIFT)) & NETC_IERB_L5MCAPR_MSEC_MASK)

#define NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & NETC_IERB_L5MCAPR_RGMII_DLY_MODE_CAP_MASK)

#define NETC_IERB_L5MCAPR_MII_PROT_MASK          (0xF000000U)
#define NETC_IERB_L5MCAPR_MII_PROT_SHIFT         (24U)
#define NETC_IERB_L5MCAPR_MII_PROT_WIDTH         (4U)
...
#define NETC_IERB_L5BCR_SW_PORT_ENETC_INST_WIDTH (5U)
...
#define NETC_IERB_L5BCR_NETC_FUNC_WIDTH          (1U)
...
#define NETC_IERB_L5BCR_SPL_SW_PORT_WIDTH        (5U)
...
#define NETC_IERB_L5TXBCCTR_THRESH_WIDTH         (16U)
...
#define NETC_IERB_L5E0MAR0_MAC_ADDR_WIDTH        (32U)
...
#define NETC_IERB_L5E0MAR1_MAC_ADDR_WIDTH        (16U)
...
#define NETC_IERB_L5E1MAR0_MAC_ADDR_WIDTH        (32U)
...
#define NETC_IERB_L5E1MAR1_MAC_ADDR_WIDTH        (16U)
...
#define NETC_IERB_SEVMCR_NUM_EVM_WIDTH           (6U)
...
#define NETC_IERB_SCCAR_CBD_WRSNP_WIDTH          (2U)
...
#define NETC_IERB_SCCAR_CWRSNP_WIDTH             (2U)
...
#define NETC_IERB_SCCAR_CBD_RDSNP_WIDTH          (2U)
...
#define NETC_IERB_SCCAR_CRDSNP_WIDTH             (2U)
...
#define NETC_IERB_SFAUXR_FAUX_WIDTH              (4U)
...
#define NETC_IERB_SRIDAR_RID_WIDTH               (16U)
...
#define NETC_IERB_SRIDAR_PBUS_WIDTH              (8U)
...
/*! @name SASIITMAR - Switch 0 ATS scheduler instance index table memory allocation register */
/*! @{ */

#define NETC_IERB_SASIITMAR_NUM_WORDS_MASK       (0xFFFFU)
#define NETC_IERB_SASIITMAR_NUM_WORDS_SHIFT      (0U)
#define NETC_IERB_SASIITMAR_NUM_WORDS_WIDTH      (16U)
#define NETC_IERB_SASIITMAR_NUM_WORDS(x)         (((uint32_t)(((uint32_t)(x)) << NETC_IERB_SASIITMAR_NUM_WORDS_SHIFT)) & NETC_IERB_SASIITMAR_NUM_WORDS_MASK)
/*! @} */
...
#define NETC_IERB_SMPCR_SWID_WIDTH               (3U)
...
#define NETC_IERB_SVFHTDECR0_PORT3_WIDTH         (1U)
...
#define NETC_IERB_SVFHTDECR0_PORT4_WIDTH         (1U)
#define NETC_IERB_SVFHTDECR0_PORT4(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_SVFHTDECR0_PORT4_SHIFT)) & NETC_IERB_SVFHTDECR0_PORT4_MASK)

#define NETC_IERB_SVFHTDECR0_PORT5_MASK          (0x20U)
#define NETC_IERB_SVFHTDECR0_PORT5_SHIFT         (5U)
#define NETC_IERB_SVFHTDECR0_PORT5_WIDTH         (1U)
#define NETC_IERB_SVFHTDECR0_PORT5(x)            (((uint32_t)(((uint32_t)(x)) << NETC_IERB_SVFHTDECR0_PORT5_SHIFT)) & NETC_IERB_SVFHTDECR0_PORT5_MASK)
...
#define NETC_IERB_SVFHTDECR1_PGA_WIDTH           (1U)
...
#define NETC_IERB_SVFHTDECR1_ET_EID_WIDTH        (16U)
...
#define NETC_IERB_SVFHTDECR2_ETA_PORT0_WIDTH     (1U)
...
#define NETC_IERB_SVFHTDECR2_ETA_PORT1_WIDTH     (1U)
...
#define NETC_IERB_SVFHTDECR2_ETA_PORT2_WIDTH     (1U)
...
#define NETC_IERB_SVFHTDECR2_ETA_PORT3_WIDTH     (1U)
...
#define NETC_IERB_SVFHTDECR2_ETA_PORT4_MASK      (0x10U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT4_SHIFT     (4U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT4_WIDTH     (1U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT4(x)        (((uint32_t)(((uint32_t)(x)) << NETC_IERB_SVFHTDECR2_ETA_PORT4_SHIFT)) & NETC_IERB_SVFHTDECR2_ETA_PORT4_MASK)

#define NETC_IERB_SVFHTDECR2_ETA_PORT5_MASK      (0x20U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT5_SHIFT     (5U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT5_WIDTH     (1U)
#define NETC_IERB_SVFHTDECR2_ETA_PORT5(x)        (((uint32_t)(((uint32_t)(x)) << NETC_IERB_SVFHTDECR2_ETA_PORT5_SHIFT)) & NETC_IERB_SVFHTDECR2_ETA_PORT5_MASK)
...
#define NETC_IERB_SVFHTDECR2_FDBAFSS_WIDTH       (1U)
...
/*! @name EVFRIDAR - ENETC 0 VF RID assignment register */
/*! @{ */

#define NETC_IERB_EVFRIDAR_NUM_VF_MASK           (0xFU)
#define NETC_IERB_EVFRIDAR_NUM_VF_SHIFT          (0U)
#define NETC_IERB_EVFRIDAR_NUM_VF_WIDTH          (4U)
...
#define NETC_IERB_EVFRIDAR_STRIDE_WIDTH          (2U)
...
#define NETC_IERB_EVFRIDAR_OFFSET_WIDTH          (16U)
...
/*! @name EEVMCR - ENETC 0 event monitor configuration register */
/*! @{ */

#define NETC_IERB_EEVMCR_NUM_EVM_MASK            (0x3FU)
#define NETC_IERB_EEVMCR_NUM_EVM_SHIFT           (0U)
#define NETC_IERB_EEVMCR_NUM_EVM_WIDTH           (6U)
...
#define NETC_IERB_EBCAR_BD_WRSNP_WIDTH           (2U)
...
#define NETC_IERB_EBCAR_WRSNP_WIDTH              (2U)
...
#define NETC_IERB_EBCAR_BD_RDSNP_WIDTH           (2U)
...
#define NETC_IERB_EBCAR_RDSNP_WIDTH              (2U)
...
#define NETC_IERB_EMCAR_MSG_WRSNP_WIDTH          (2U)
...
#define NETC_IERB_EMCAR_MSG_RDSNP_WIDTH          (2U)
...
#define NETC_IERB_ECAR_CBD_WRSNP_WIDTH           (2U)
...
#define NETC_IERB_ECAR_CWRSNP_WIDTH              (2U)
...
#define NETC_IERB_ECAR_CBD_RDSNP_WIDTH           (2U)
...
#define NETC_IERB_ECAR_CRDSNP_WIDTH              (2U)
...
/*! @name EFAUXR - ENETC 0 function auxiliary register */
/*! @{ */

#define NETC_IERB_EFAUXR_FAUX_MASK               (0xFU)
#define NETC_IERB_EFAUXR_FAUX_SHIFT              (0U)
#define NETC_IERB_EFAUXR_FAUX_WIDTH              (4U)
...
/*! @name ERIDAR - ENETC 0 RID assignment register */
/*! @{ */

#define NETC_IERB_ERIDAR_RID_MASK                (0xFFFFU)
#define NETC_IERB_ERIDAR_RID_SHIFT               (0U)
#define NETC_IERB_ERIDAR_RID_WIDTH               (16U)
...
#define NETC_IERB_ERIDAR_PBUS_WIDTH              (8U)
...
/*! @name VAMQR - VSI 0 access management qualifier register..VSI 4 access management qualifier register */
/*! @{ */
...
/*! @name VFAUXR - VSI 0 function auxiliary register..VSI 4 function auxiliary register */
/*! @{ */

#define NETC_IERB_VFAUXR_FAUX_MASK               (0xFU)
#define NETC_IERB_VFAUXR_FAUX_SHIFT              (0U)
#define NETC_IERB_VFAUXR_FAUX_WIDTH              (4U)
#define NETC_IERB_VFAUXR_FAUX(x)                 (((uint32_t)(((uint32_t)(x)) << NETC_IERB_VFAUXR_FAUX_SHIFT)) & NETC_IERB_VFAUXR_FAUX_MASK)
/*! @} */

/*! @name VBLPR - VSI 0 boot loader parameter register 0..VSI 4 boot loader parameter register 1 */
/*! @{ */
...
/*! @name VPMAR0 - VSI 0 primary MAC address register 0..VSI 4 primary MAC address register 0 */
/*! @{ */
...
/*! @name VPMAR1 - VSI 0 primary MAC address register 1..VSI 4 primary MAC address register 1 */
/*! @{ */
...
#endif  /* #if !defined(S32G274_NETC_IERB_H_) */
