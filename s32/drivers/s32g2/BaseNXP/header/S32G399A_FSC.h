 ...
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_FSC
 *
...
#if !defined(S32G399A_FSC_H_)  /* Check if memory map has not been already included */
#define S32G399A_FSC_H_
...
#define FSC_SCLF0_LATENTFAULT_MASK               (0x7FU)
#define FSC_SCLF0_LATENTFAULT_SHIFT              (0U)
#define FSC_SCLF0_LATENTFAULT_WIDTH              (7U)
...
#define FSC_SCMF0_MISSIONFAULT_MASK              (0x7FU)
#define FSC_SCMF0_MISSIONFAULT_SHIFT             (0U)
#define FSC_SCMF0_MISSIONFAULT_WIDTH             (7U)
...
#endif  /* #if !defined(S32G399A_FSC_H_) */
