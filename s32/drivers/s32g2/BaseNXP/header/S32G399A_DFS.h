 ...
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_DFS
 *
...
#if !defined(S32G399A_DFS_H_)  /* Check if memory map has not been already included */
#define S32G399A_DFS_H_
...
#endif  /* #if !defined(S32G399A_DFS_H_) */
