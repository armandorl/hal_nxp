...
#if !defined(S32R45_M7_COMMON_H_)  /* Check if memory map has not been already included */
#define S32R45_M7_COMMON_H_
#define MCU_S32R45

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32R45 memory map: There is already included another memory map. Only one memory map can be included.
...
typedef enum {
  ...
  PCIE0_PHY_LDOWN_IRQn         = 126,              /**< PHY link down interrupt */
  PCIE0_PHY_LUP_IRQn           = 127,              /**< PHY link up interrupt */
  ...
  PCIE0_MISC_IRQn              = 132,              /**< Miscellaneous interrupt generated by SerDes Subsystem */
  PCIE0_PCS_IRQn               = 133,              /**< PCS interrupt */
  PCIE0_TLP_IRQn               = 134,              /**< TLP request has not completed within the expected time window */
  ...
  PCIE1_ORED_DMA_IRQn          = 208,              /**< Logical OR of PCIe DMA interrupts */
  PCIE1_LINK_IRQn              = 209,              /**< Link request status interrupt */
  PCIE1_AXI_MSI_IRQn           = 210,              /**< DSP AXI MSI Interrupt Detected */
  PCIE1_PHY_LDOWN_IRQn         = 211,              /**< PHY link down interrupt */
  PCIE1_PHY_LUP_IRQn           = 212,              /**< PHY link up interrupt */
  PCIE1_INTA_IRQn              = 213,              /**< Interrupt indicating INTA message received */
  PCIE1_INTB_IRQn              = 214,              /**< Interrupt indicating INTB message received */
  PCIE1_INTC_IRQn              = 215,              /**< Interrupt indicating INTC message received */
  PCIE1_INTD_IRQn              = 216,              /**< Interrupt indicating INTD message received */
  PCIE1_MISC_IRQn              = 217,              /**< Miscellaneous interrupt generated by PCIe Subsystem */
  PCIE1_PCS_IRQn               = 218,              /**< PCS interrupt */
  PCIE1_TLP_IRQn               = 219,              /**< TLP request has not completed within the expected time window */
