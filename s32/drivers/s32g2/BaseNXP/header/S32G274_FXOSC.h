...
/*!
 * @file S32G274_FXOSC.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_FXOSC
 *
...
#if !defined(S32G274_FXOSC_H_)  /* Check if memory map has not been already included */
#define S32G274_FXOSC_H_
...
/** Peripheral LPE_FXOSC base address */
#define IP_LPE_FXOSC_BASE                        (0x42110000u)
/** Peripheral LPE_FXOSC base pointer */
#define IP_LPE_FXOSC                             ((FXOSC_Type *)IP_LPE_FXOSC_BASE)
/** Array initializer of FXOSC peripheral base addresses */
#define IP_FXOSC_BASE_ADDRS                      { IP_LPE_FXOSC_BASE }
/** Array initializer of FXOSC peripheral base pointers */
#define IP_FXOSC_BASE_PTRS                       { IP_LPE_FXOSC }
...
#define FXOSC_CTRL_ALC_D_MASK                    (0x4U)
#define FXOSC_CTRL_ALC_D_SHIFT                   (2U)
#define FXOSC_CTRL_ALC_D_WIDTH                   (1U)
#define FXOSC_CTRL_ALC_D(x)                      (((uint32_t)(((uint32_t)(x)) << FXOSC_CTRL_ALC_D_SHIFT)) & FXOSC_CTRL_ALC_D_MASK)
...
#endif  /* #if !defined(S32G274_FXOSC_H_) */
