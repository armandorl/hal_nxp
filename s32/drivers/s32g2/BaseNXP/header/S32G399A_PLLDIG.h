...
/*!
 * @file S32G399A_PLLDIG.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_PLLDIG
 *
...
#if !defined(S32G399A_PLLDIG_H_)  /* Check if memory map has not been already included */
#define S32G399A_PLLDIG_H_
...
#define IP_PLLDIG_BASE_ADDRS                     { IP_ACCEL_PLL_BASE, IP_CORE_PLL_BASE, IP_DDR_PLL_BASE, IP_PERIPH_PLL_BASE }
/** Array initializer of PLLDIG peripheral base pointers */
#define IP_PLLDIG_BASE_PTRS                      { IP_ACCEL_PLL, IP_CORE_PLL, IP_DDR_PLL, IP_PERIPH_PLL }
...
#endif  /* #if !defined(S32G399A_PLLDIG_H_) */
