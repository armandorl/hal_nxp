...
#if !defined(S32G274_DSPV_COMMON_H_)  /* Check if memory map has not been already included */
#define S32G274_DSPV_COMMON_H_
#define MCU_S32G274

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error S32G274 memory map: There is already included another memory map. Only one memory map can be included.
...
#endif  /* #if !defined(S32G274_DSPV_COMMON_H_) */
