...
/*!
 * @file S32G274_VFCCU_0.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_VFCCU_0
 *
...
#if !defined(S32G274_VFCCU_0_H_)  /* Check if memory map has not been already included */
#define S32G274_VFCCU_0_H_
...
#endif  /* #if !defined(S32G274_VFCCU_0_H_) */
