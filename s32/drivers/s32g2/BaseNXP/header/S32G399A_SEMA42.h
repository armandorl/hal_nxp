...
/*!
 * @file S32G399A_SEMA42.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_SEMA42
 *
...
#if !defined(S32G399A_SEMA42_H_)  /* Check if memory map has not been already included */
#define S32G399A_SEMA42_H_
...
#define IP_SEMA42_BASE                           (0x40298000u)
...
#endif  /* #if !defined(S32G399A_SEMA42_H_) */
