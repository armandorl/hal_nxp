...
/*!
 * @file S32G274_USDHC.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_USDHC
 *
...
#if !defined(S32G274_USDHC_H_)  /* Check if memory map has not been already included */
#define S32G274_USDHC_H_
...
#define IP_USDHC_BASE                            (0x4011C000u)
...
#define USDHC_PRES_STATE_BRESP_RCV_MASK          (0x400000U)
#define USDHC_PRES_STATE_BRESP_RCV_SHIFT         (22U)
#define USDHC_PRES_STATE_BRESP_RCV_WIDTH         (1U)
#define USDHC_PRES_STATE_BRESP_RCV(x)            (((uint32_t)(((uint32_t)(x)) << USDHC_PRES_STATE_BRESP_RCV_SHIFT)) & USDHC_PRES_STATE_BRESP_RCV_MASK)
...
#endif  /* #if !defined(S32G274_USDHC_H_) */
