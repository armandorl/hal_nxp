...
/*!
 * @file S32G274A_FLEXRAY.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_FLEXRAY
 *
...
#if !defined(S32G274A_FLEXRAY_H_)  /* Check if memory map has not been already included */
#define S32G274A_FLEXRAY_H_
...
#define IP_FR_0_BASE                             (0x402F8000u)
...
#define IP_FLEXRAY_BASE_ADDRS                    { IP_FR_0_BASE }
/** Array initializer of FLEXRAY peripheral base pointers */
#define IP_FLEXRAY_BASE_PTRS                     { IP_FR_0 }
...
#define FLEXRAY_PEOER_CYC_EE_MASK                (0x1U)
#define FLEXRAY_PEOER_CYC_EE_SHIFT               (0U)
#define FLEXRAY_PEOER_CYC_EE_WIDTH               (1U)
#define FLEXRAY_PEOER_CYC_EE(x)                  (((uint16_t)(((uint16_t)(x)) << FLEXRAY_PEOER_CYC_EE_SHIFT)) & FLEXRAY_PEOER_CYC_EE_MASK)

#define FLEXRAY_PEOER_TIM1_EE_MASK               (0x2U)
#define FLEXRAY_PEOER_TIM1_EE_SHIFT              (1U)
#define FLEXRAY_PEOER_TIM1_EE_WIDTH              (1U)
#define FLEXRAY_PEOER_TIM1_EE(x)                 (((uint16_t)(((uint16_t)(x)) << FLEXRAY_PEOER_TIM1_EE_SHIFT)) & FLEXRAY_PEOER_TIM1_EE_MASK)

#define FLEXRAY_PEOER_TIM2_EE_MASK               (0x4U)
#define FLEXRAY_PEOER_TIM2_EE_SHIFT              (2U)
#define FLEXRAY_PEOER_TIM2_EE_WIDTH              (1U)
#define FLEXRAY_PEOER_TIM2_EE(x)                 (((uint16_t)(((uint16_t)(x)) << FLEXRAY_PEOER_TIM2_EE_SHIFT)) & FLEXRAY_PEOER_TIM2_EE_MASK)
...
#endif  /* #if !defined(S32G274A_FLEXRAY_H_) */
