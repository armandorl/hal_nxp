...
/*!
 * @file S32G274A_DMA_CRC.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_DMA_CRC
 *
...
#if !defined(S32G274A_DMA_CRC_H_)  /* Check if memory map has not been already included */
#define S32G274A_DMA_CRC_H_
...
#define IP_DMA_CRC_BASE_ADDRS                    { IP_DMA_CRC_0_BASE, IP_DMA_CRC_1_BASE }
/** Array initializer of DMA_CRC peripheral base pointers */
#define IP_DMA_CRC_BASE_PTRS                     { IP_DMA_CRC_0, IP_DMA_CRC_1 }
...
#endif  /* #if !defined(S32G274A_DMA_CRC_H_) */
