...
/*!
 * @file S32G274A_USDHC.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_USDHC
 *
...
#if !defined(S32G274A_USDHC_H_)  /* Check if memory map has not been already included */
#define S32G274A_USDHC_H_
...
#define IP_USDHC_BASE                            (0x402F0000u)
...
#endif  /* #if !defined(S32G274A_USDHC_H_) */
