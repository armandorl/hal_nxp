...
/*!
 * @file S32G274_ENETC_PORT.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_ENETC_PORT
 *
...
#if !defined(S32G274_ENETC_PORT_H_)  /* Check if memory map has not been already included */
#define S32G274_ENETC_PORT_H_
...
typedef struct ENETC_PORT_Struct {
...
#define IP_NETC__ENETC0_PORT_BASE                (0x6D094000u)
...
#define ENETC_PORT_PCAPR_NUM_CBS_WIDTH           (3U)
...
#define ENETC_PORT_PCAPR_ECBS_WIDTH              (1U)
#define ENETC_PORT_PCAPR_ECBS(x)                 (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PCAPR_ECBS_SHIFT)) & ENETC_PORT_PCAPR_ECBS_MASK)

#define ENETC_PORT_PCAPR_ATS_MASK                (0x80000000U)
#define ENETC_PORT_PCAPR_ATS_SHIFT               (31U)
#define ENETC_PORT_PCAPR_ATS_WIDTH               (1U)
#define ENETC_PORT_PCAPR_ATS(x)                  (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PCAPR_ATS_SHIFT)) & ENETC_PORT_PCAPR_ATS_MASK)
/*! @} */
...
#define ENETC_PORT_PMCAPR_PIPG_WIDTH             (1U)
...
#define ENETC_PORT_PMCAPR_MIN_MPDU_WIDTH         (1U)
#define ENETC_PORT_PMCAPR_MIN_MPDU(x)            (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PMCAPR_MIN_MPDU_SHIFT)) & ENETC_PORT_PMCAPR_MIN_MPDU_MASK)

#define ENETC_PORT_PMCAPR_MSEC_MASK              (0x2000U)
#define ENETC_PORT_PMCAPR_MSEC_SHIFT             (13U)
#define ENETC_PORT_PMCAPR_MSEC_WIDTH             (1U)
#define ENETC_PORT_PMCAPR_MSEC(x)                (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PMCAPR_MSEC_SHIFT)) & ENETC_PORT_PMCAPR_MSEC_MASK)

#define ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP_MASK (0x300000U)
#define ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP_SHIFT (20U)
#define ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP_WIDTH (2U)
#define ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP(x)  (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & ENETC_PORT_PMCAPR_RGMII_DLY_MODE_CAP_MASK)
...
#define ENETC_PORT_PCR_NS_TAG_PORT_WIDTH         (1U)
...
#define ENETC_PORT_PCR_L3DOSE_WIDTH              (1U)
...
#define ENETC_PORT_PRXSDUOR_MACSEC_BCO_MASK      (0x3F00U)
#define ENETC_PORT_PRXSDUOR_MACSEC_BCO_SHIFT     (8U)
#define ENETC_PORT_PRXSDUOR_MACSEC_BCO_WIDTH     (6U)
...
#define ENETC_PORT_PTXSDUOR_MACSEC_BCO_MASK      (0x3F00U)
#define ENETC_PORT_PTXSDUOR_MACSEC_BCO_SHIFT     (8U)
#define ENETC_PORT_PTXSDUOR_MACSEC_BCO_WIDTH     (6U)
...
#define ENETC_PORT_PDGSR_DGS_TC0_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC1_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC2_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC3_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC4_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC5_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC6_WIDTH           (1U)
...
#define ENETC_PORT_PDGSR_DGS_TC7_WIDTH           (1U)
...
#define ENETC_PORT_PRXDCRR0_L3DOSDR_WIDTH        (1U)
...
#define ENETC_PORT_PRXDCRR0_NSTPDR_WIDTH         (1U)
...
#define ENETC_PORT_PRXDCRR0_NSTDDR_WIDTH         (1U)
...
#define ENETC_PORT_PTGSTCOCR_TX_OVERRUN_MASK     (0xFU)
#define ENETC_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT    (0U)
#define ENETC_PORT_PTGSTCOCR_TX_OVERRUN_WIDTH    (4U)
#define ENETC_PORT_PTGSTCOCR_TX_OVERRUN(x)       (((uint32_t)(((uint32_t)(x)) << ENETC_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT)) & ENETC_PORT_PTGSTCOCR_TX_OVERRUN_MASK)
/*! @} */
...
#define ENETC_PORT_PTCCBSR0_FRACT_WIDTH          (4U)
...
#define ENETC_PORT_PTCCBSR2_IDLESLOPE_WIDTH      (27U)
...
#define ENETC_PORT_PTCCBSR2_CBSE_WIDTH           (1U)
...
#endif  /* #if !defined(S32G274_ENETC_PORT_H_) */
