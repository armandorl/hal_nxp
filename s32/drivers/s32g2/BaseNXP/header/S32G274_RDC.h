 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_RDC
 *
...
#if !defined(S32G274_RDC_H_)  /* Check if memory map has not been already included */
#define S32G274_RDC_H_
...
/** Peripheral RDC_C0 base address */
#define IP_RDC_C0_BASE                           (0x408EC000u)
/** Peripheral RDC_C0 base pointer */
#define IP_RDC_C0                                ((RDC_Type *)IP_RDC_C0_BASE)
/** Peripheral RDC_REST base address */
#define IP_RDC_REST_BASE                         (0x408E8000u)
/** Peripheral RDC_REST base pointer */
#define IP_RDC_REST                              ((RDC_Type *)IP_RDC_REST_BASE)
/** Array initializer of RDC peripheral base addresses */
#define IP_RDC_BASE_ADDRS                        { IP_RDC_C0_BASE, IP_RDC_REST_BASE }
/** Array initializer of RDC peripheral base pointers */
#define IP_RDC_BASE_PTRS                         { IP_RDC_C0, IP_RDC_REST }
...
#define RDC_RD1_CTRL_REG_RD1_INTERCONNECT_INTERFACE_DISABLE(x) (((uint32_t)(((uint32_t)(x)) << RDC_RD1_CTRL_REG_RD1_INTERCONNECT_INTERFACE_DISABLE_SHIFT)) & RDC_RD1_CTRL_REG_RD1_INTERCONNECT_INTERFACE_DISABLE_MASK)
...
#define RDC_RD1_CTRL_REG_RD1_CTRL_UNLOCK(x)      (((uint32_t)(((uint32_t)(x)) << RDC_RD1_CTRL_REG_RD1_CTRL_UNLOCK_SHIFT)) & RDC_RD1_CTRL_REG_RD1_CTRL_UNLOCK_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274_RDC_H_) */
