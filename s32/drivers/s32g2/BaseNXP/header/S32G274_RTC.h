 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_RTC
 *
...
#if !defined(S32G274_RTC_H_)  /* Check if memory map has not been already included */
#define S32G274_RTC_H_
...
typedef struct RTC_Struct {
  ...
  __IO uint32_t RTCC;                              /**< RTC Control, offset: 0x4 */
  __IO uint32_t RTCS;                              /**< RTC Status register, offset: 0x8 */
  __I  uint32_t RTCCNT;                            /**< RTC Count, offset: 0xC */
...
/** Peripheral LPE_RTC base address */
#define IP_LPE_RTC_BASE                          (0x42164000u)
/** Peripheral LPE_RTC base pointer */
#define IP_LPE_RTC                               ((RTC_Type *)IP_LPE_RTC_BASE)
/** Array initializer of RTC peripheral base addresses */
#define IP_RTC_BASE_ADDRS                        { IP_LPE_RTC_BASE }
/** Array initializer of RTC peripheral base pointers */
#define IP_RTC_BASE_PTRS                         { IP_LPE_RTC }
...
#endif  /* #if !defined(S32G274_RTC_H_) */
