 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_SWT
 *
...
#if !defined(S32G274A_SWT_H_)  /* Check if memory map has not been already included */
#define S32G274A_SWT_H_
...
#define IP_SWT_BASE_ADDRS                        { IP_SWT_0_BASE, IP_SWT_1_BASE, IP_SWT_2_BASE, IP_SWT_3_BASE, IP_SWT_4_BASE, IP_SWT_5_BASE, IP_SWT_6_BASE }
/** Array initializer of SWT peripheral base pointers */
#define IP_SWT_BASE_PTRS                         { IP_SWT_0, IP_SWT_1, IP_SWT_2, IP_SWT_3, IP_SWT_4, IP_SWT_5, IP_SWT_6 }
...
#endif  /* #if !defined(S32G274A_SWT_H_) */
