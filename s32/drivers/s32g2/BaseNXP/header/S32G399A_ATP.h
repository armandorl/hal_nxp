 ...
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_ATP
 *
...
#if !defined(S32G399A_ATP_H_)  /* Check if memory map has not been already included */
#define S32G399A_ATP_H_
...
#define IP_ATP_BASE                              (0x51033000u)
...
#endif  /* #if !defined(S32G399A_ATP_H_) */
