...
/*!
 * @file S32G274A_SRAMC.h
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_SRAMC
 *
...
#if !defined(S32G274A_SRAMC_H_)  /* Check if memory map has not been already included */
#define S32G274A_SRAMC_H_
...
#define IP_SRAMC_BASE_ADDRS                      { IP_SRAMC_BASE, IP_SRAMC_1_BASE, IP_STDBY_SRAM_CFG_BASE }
/** Array initializer of SRAMC peripheral base pointers */
#define IP_SRAMC_BASE_PTRS                       { IP_SRAMC, IP_SRAMC_1, IP_STDBY_SRAM_CFG }
...
#endif  /* #if !defined(S32G274A_SRAMC_H_) */
