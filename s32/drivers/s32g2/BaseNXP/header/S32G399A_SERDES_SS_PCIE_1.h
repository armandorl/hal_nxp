...
/*!
 * @file S32G399A_SerDes_SS_PCIe_1.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_SerDes_SS_PCIe_1
 *
...
#if !defined(S32G399A_SerDes_SS_PCIe_1_H_)  /* Check if memory map has not been already included */
#define S32G399A_SerDes_SS_PCIe_1_H_
...
#define SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE_MASK (0x100U)
#define SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE_SHIFT (8U)
#define SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE_WIDTH (1U)
#define SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE(x) (((uint32_t)(((uint32_t)(x)) << SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE_SHIFT)) & SerDes_SS_PCIe_1_PE0_GEN_CTRL_1_SRIS_MODE_MASK)
...
#endif  /* #if !defined(S32G399A_SerDes_SS_PCIe_1_H_) */
