 ...
 * @version 2.1
 * @date 2022-06-27
 * @brief Peripheral Access Layer for S32G274A_JDC
 *
...
#if !defined(S32G274A_JDC_H_)  /* Check if memory map has not been already included */
#define S32G274A_JDC_H_
...
#define IP_JDC_BASE                              (0x402F4000u)
...
#endif  /* #if !defined(S32G274A_JDC_H_) */
