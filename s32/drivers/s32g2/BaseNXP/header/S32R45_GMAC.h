...
#define IP_GMAC_1_BASE                           (0x44010000u)
/** Peripheral GMAC_1 base pointer */
#define IP_GMAC_1                                ((GMAC_Type *)IP_GMAC_1_BASE)
/** Array initializer of GMAC peripheral base addresses */
#define IP_GMAC_BASE_ADDRS                       { IP_GMAC_0_BASE, IP_GMAC_1_BASE }
/** Array initializer of GMAC peripheral base pointers */
#define IP_GMAC_BASE_PTRS                        { IP_GMAC_0, IP_GMAC_1 }
