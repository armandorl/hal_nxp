 ...
 * @version 1.3
 * @date 2024-06-14
 * @brief Peripheral Access Layer for S32G274_MPU
 *
...
#if !defined(S32G274_MPU_H_)  /* Check if memory map has not been already included */
#define S32G274_MPU_H_
...
#endif  /* #if !defined(S32G274_MPU_H_) */
