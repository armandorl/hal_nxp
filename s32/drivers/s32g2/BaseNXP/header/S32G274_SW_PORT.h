...
/*!
 * @file S32G274_SW_PORT.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_SW_PORT
 *
...
#if !defined(S32G274_SW_PORT_H_)  /* Check if memory map has not been already included */
#define S32G274_SW_PORT_H_
...
typedef struct SW_PORT_Struct {
  ...
  struct SW_PORT_TCT_NUM {                         /* offset: 0x200, array step: 0x20 */
    ...
    __I  uint32_t PTGSTCOCR;                         /**< Port time gate scheduling traffic class 0 overrun counter register..Port time gate scheduling traffic class 7 overrun counter register, array offset: 0x204, array step: 0x20 */
  ...
  __IO uint32_t PMCR1;                             /**< Port mirror configuration register 1, offset: 0x444 */
  __IO uint32_t PMCR2;                             /**< Port mirror configuration register 2, offset: 0x448 */
  uint8_t RESERVED_18[4];
  __IO uint32_t PCTFCR;                            /**< Port cut through forwarding configuration register, offset: 0x450, not available in all instances (available on 5 out of 6) */
...
} SW_PORT_Type, *SW_PORT_MemMapPtr;

/** Number of instances of the SW_PORT module. */
#define SW_PORT_INSTANCE_COUNT                   (6u)

/* SW_PORT - Peripheral instance base addresses */
/** Peripheral NETC__SW0_PORT0 base address */
#define IP_NETC__SW0_PORT0_BASE                  (0x6D004000u)
/** Peripheral NETC__SW0_PORT0 base pointer */
#define IP_NETC__SW0_PORT0                       ((SW_PORT_Type *)IP_NETC__SW0_PORT0_BASE)
/** Peripheral NETC__SW0_PORT1 base address */
#define IP_NETC__SW0_PORT1_BASE                  (0x6D008000u)
/** Peripheral NETC__SW0_PORT1 base pointer */
#define IP_NETC__SW0_PORT1                       ((SW_PORT_Type *)IP_NETC__SW0_PORT1_BASE)
/** Peripheral NETC__SW0_PORT2 base address */
#define IP_NETC__SW0_PORT2_BASE                  (0x6D00C000u)
/** Peripheral NETC__SW0_PORT2 base pointer */
#define IP_NETC__SW0_PORT2                       ((SW_PORT_Type *)IP_NETC__SW0_PORT2_BASE)
/** Peripheral NETC__SW0_PORT3 base address */
#define IP_NETC__SW0_PORT3_BASE                  (0x6D010000u)
/** Peripheral NETC__SW0_PORT3 base pointer */
#define IP_NETC__SW0_PORT3                       ((SW_PORT_Type *)IP_NETC__SW0_PORT3_BASE)
/** Peripheral NETC__SW0_PORT4 base address */
#define IP_NETC__SW0_PORT4_BASE                  (0x6D014000u)
/** Peripheral NETC__SW0_PORT4 base pointer */
#define IP_NETC__SW0_PORT4                       ((SW_PORT_Type *)IP_NETC__SW0_PORT4_BASE)
/** Peripheral NETC__SW0_PORT5 base address */
#define IP_NETC__SW0_PORT5_BASE                  (0x6D018000u)
/** Peripheral NETC__SW0_PORT5 base pointer */
#define IP_NETC__SW0_PORT5                       ((SW_PORT_Type *)IP_NETC__SW0_PORT5_BASE)
/** Array initializer of SW_PORT peripheral base addresses */
#define IP_SW_PORT_BASE_ADDRS                    { IP_NETC__SW0_PORT0_BASE, IP_NETC__SW0_PORT1_BASE, IP_NETC__SW0_PORT2_BASE, IP_NETC__SW0_PORT3_BASE, IP_NETC__SW0_PORT4_BASE, IP_NETC__SW0_PORT5_BASE }
/** Array initializer of SW_PORT peripheral base pointers */
#define IP_SW_PORT_BASE_PTRS                     { IP_NETC__SW0_PORT0, IP_NETC__SW0_PORT1, IP_NETC__SW0_PORT2, IP_NETC__SW0_PORT3, IP_NETC__SW0_PORT4, IP_NETC__SW0_PORT5 }
...
#define SW_PORT_PCAPR_LINK_TYPE_WIDTH            (1U)
...
#define SW_PORT_PCAPR_NUM_TC_WIDTH               (4U)
...
#define SW_PORT_PCAPR_NUM_Q_WIDTH                (4U)
...
#define SW_PORT_PCAPR_NUM_CBS_WIDTH              (3U)
...
#define SW_PORT_PCAPR_NUM_CG_WIDTH               (4U)
...
#define SW_PORT_PCAPR_TGS_WIDTH                  (1U)
...
#define SW_PORT_PCAPR_CBS_WIDTH                  (1U)
...
#define SW_PORT_PCAPR_ECBS_WIDTH                 (1U)
#define SW_PORT_PCAPR_ECBS(x)                    (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCAPR_ECBS_SHIFT)) & SW_PORT_PCAPR_ECBS_MASK)

#define SW_PORT_PCAPR_ATS_MASK                   (0x80000000U)
#define SW_PORT_PCAPR_ATS_SHIFT                  (31U)
#define SW_PORT_PCAPR_ATS_WIDTH                  (1U)
#define SW_PORT_PCAPR_ATS(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCAPR_ATS_SHIFT)) & SW_PORT_PCAPR_ATS_MASK)
/*! @} */
...
#define SW_PORT_PMCAPR_MAC_VAR_WIDTH             (3U)
...
#define SW_PORT_PMCAPR_EFPAD_WIDTH               (2U)
...
#define SW_PORT_PMCAPR_PIPG_WIDTH                (1U)
...
#define SW_PORT_PMCAPR_HD_WIDTH                  (1U)
...
#define SW_PORT_PMCAPR_FP_WIDTH                  (2U)
...
#define SW_PORT_PMCAPR_MIN_MPDU_WIDTH            (1U)
#define SW_PORT_PMCAPR_MIN_MPDU(x)               (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCAPR_MIN_MPDU_SHIFT)) & SW_PORT_PMCAPR_MIN_MPDU_MASK)

#define SW_PORT_PMCAPR_MSEC_MASK                 (0x2000U)
#define SW_PORT_PMCAPR_MSEC_SHIFT                (13U)
#define SW_PORT_PMCAPR_MSEC_WIDTH                (1U)
#define SW_PORT_PMCAPR_MSEC(x)                   (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCAPR_MSEC_SHIFT)) & SW_PORT_PMCAPR_MSEC_MASK)

#define SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP_MASK   (0x300000U)
#define SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP_SHIFT  (20U)
#define SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP_WIDTH  (2U)
#define SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP(x)     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP_SHIFT)) & SW_PORT_PMCAPR_RGMII_DLY_MODE_CAP_MASK)

#define SW_PORT_PMCAPR_MII_PROT_MASK             (0xF000000U)
#define SW_PORT_PMCAPR_MII_PROT_SHIFT            (24U)
#define SW_PORT_PMCAPR_MII_PROT_WIDTH            (4U)
...
#define SW_PORT_PIOCAPR_PCS_PROT_WIDTH           (16U)
...
#define SW_PORT_PIOCAPR_IO_VAR_WIDTH             (4U)
...
#define SW_PORT_PIOCAPR_EMDIO_WIDTH              (1U)
...
#define SW_PORT_PIOCAPR_REVMII_RATE_WIDTH        (1U)
...
#define SW_PORT_PIOCAPR_REVMII_WIDTH             (1U)
...
#define SW_PORT_PCR_HDR_FMT_WIDTH                (1U)
...
#define SW_PORT_PCR_NS_TAG_PORT_WIDTH            (1U)
...
#define SW_PORT_PCR_L2DOSE_WIDTH                 (1U)
...
#define SW_PORT_PCR_L3DOSE_WIDTH                 (1U)
...
#define SW_PORT_PCR_TIMER_CS_WIDTH               (1U)
#define SW_PORT_PCR_TIMER_CS(x)                  (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCR_TIMER_CS_SHIFT)) & SW_PORT_PCR_TIMER_CS_MASK)

#define SW_PORT_PCR_FCSEA_MASK                   (0x1000U)
#define SW_PORT_PCR_FCSEA_SHIFT                  (12U)
#define SW_PORT_PCR_FCSEA_WIDTH                  (1U)
#define SW_PORT_PCR_FCSEA(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCR_FCSEA_SHIFT)) & SW_PORT_PCR_FCSEA_MASK)

#define SW_PORT_PCR_PSPEED_MASK                  (0x3FFF0000U)
#define SW_PORT_PCR_PSPEED_SHIFT                 (16U)
#define SW_PORT_PCR_PSPEED_WIDTH                 (14U)
...
#define SW_PORT_PMAR0_PRIM_MAC_ADDR_WIDTH        (32U)
...
#define SW_PORT_PMAR1_PRIM_MAC_ADDR_WIDTH        (16U)
...
#define SW_PORT_PTAR_OVTPIDL_WIDTH               (4U)
...
#define SW_PORT_PTAR_IVTPIDL_WIDTH               (4U)
...
#define SW_PORT_PQOSMR_VS_WIDTH                  (1U)
...
#define SW_PORT_PQOSMR_VE_WIDTH                  (1U)
...
#define SW_PORT_PQOSMR_DDR_WIDTH                 (2U)
...
#define SW_PORT_PQOSMR_DIPV_WIDTH                (3U)
...
#define SW_PORT_PQOSMR_VQMP_WIDTH                (4U)
...
#define SW_PORT_PQOSMR_QVMP_WIDTH                (4U)
...
#define SW_PORT_PQOR_Q0S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q1S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q2S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q3S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q4S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q5S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q6S_WIDTH                   (1U)
...
#define SW_PORT_PQOR_Q7S_WIDTH                   (1U)
...
#define SW_PORT_PPCR_L1PFS_WIDTH                 (5U)
...
#define SW_PORT_PPCR_L2PFS_WIDTH                 (5U)
...
#define SW_PORT_PPCR_L3HFP_WIDTH                 (1U)
...
#define SW_PORT_PPCR_L3PFS_WIDTH                 (5U)
...
#define SW_PORT_PPCR_L4HFP_WIDTH                 (1U)
...
#define SW_PORT_PPCR_L4PFS_WIDTH                 (5U)
...
#define SW_PORT_PIPFCR_EN_WIDTH                  (1U)
...
#define SW_PORT_PSGCR_PDELAY_WIDTH               (24U)
...
#define SW_PORT_PSGCR_OGC_WIDTH                  (1U)
...
#define SW_PORT_POR_TXDIS_WIDTH                  (1U)
...
#define SW_PORT_POR_RXDIS_WIDTH                  (1U)
...
#define SW_PORT_PSR_TX_BUSY_WIDTH                (1U)
...
#define SW_PORT_PSR_RX_BUSY_WIDTH                (1U)
...
#define SW_PORT_PTGSCR_TGE_WIDTH                 (1U)
...
#define SW_PORT_PTGAGLSR_TG_WIDTH                (1U)
...
#define SW_PORT_PTGAGLSR_CFG_PEND_WIDTH          (1U)
...
#define SW_PORT_PTGAGLLR_ADMIN_GATE_LIST_LENGTH_WIDTH (16U)
...
#define SW_PORT_PTGOGLLR_OPER_GATE_LIST_LENGTH_WIDTH (16U)
...
#define SW_PORT_PTGSHAR_HOLDADVANCE_MASK         (0xFFFFU)
#define SW_PORT_PTGSHAR_HOLDADVANCE_SHIFT        (0U)
#define SW_PORT_PTGSHAR_HOLDADVANCE_WIDTH        (16U)
#define SW_PORT_PTGSHAR_HOLDADVANCE(x)           (((uint32_t)(((uint32_t)(x)) << SW_PORT_PTGSHAR_HOLDADVANCE_SHIFT)) & SW_PORT_PTGSHAR_HOLDADVANCE_MASK)
/*! @} */

/*! @name PTGSRAR - Port time gate scheduling release advance register */
/*! @{ */

#define SW_PORT_PTGSRAR_RELEASEADVANCE_MASK      (0xFFFFU)
#define SW_PORT_PTGSRAR_RELEASEADVANCE_SHIFT     (0U)
#define SW_PORT_PTGSRAR_RELEASEADVANCE_WIDTH     (16U)
#define SW_PORT_PTGSRAR_RELEASEADVANCE(x)        (((uint32_t)(((uint32_t)(x)) << SW_PORT_PTGSRAR_RELEASEADVANCE_SHIFT)) & SW_PORT_PTGSRAR_RELEASEADVANCE_MASK)
/*! @} */

/*! @name PTGSHCR - Port time gate scheduling hold configuration register */
/*! @{ */

#define SW_PORT_PTGSHCR_HOLD_SKEW_MASK           (0xFFFFFU)
#define SW_PORT_PTGSHCR_HOLD_SKEW_SHIFT          (0U)
#define SW_PORT_PTGSHCR_HOLD_SKEW_WIDTH          (20U)
#define SW_PORT_PTGSHCR_HOLD_SKEW(x)             (((uint32_t)(((uint32_t)(x)) << SW_PORT_PTGSHCR_HOLD_SKEW_SHIFT)) & SW_PORT_PTGSHCR_HOLD_SKEW_MASK)
/*! @} */

/*! @name PFPCR - Port frame preemption configuration register */
/*! @{ */

#define SW_PORT_PFPCR_FPE_TC0_MASK               (0x1U)
#define SW_PORT_PFPCR_FPE_TC0_SHIFT              (0U)
#define SW_PORT_PFPCR_FPE_TC0_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC0(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC0_SHIFT)) & SW_PORT_PFPCR_FPE_TC0_MASK)

#define SW_PORT_PFPCR_FPE_TC1_MASK               (0x2U)
#define SW_PORT_PFPCR_FPE_TC1_SHIFT              (1U)
#define SW_PORT_PFPCR_FPE_TC1_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC1(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC1_SHIFT)) & SW_PORT_PFPCR_FPE_TC1_MASK)

#define SW_PORT_PFPCR_FPE_TC2_MASK               (0x4U)
#define SW_PORT_PFPCR_FPE_TC2_SHIFT              (2U)
#define SW_PORT_PFPCR_FPE_TC2_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC2(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC2_SHIFT)) & SW_PORT_PFPCR_FPE_TC2_MASK)

#define SW_PORT_PFPCR_FPE_TC3_MASK               (0x8U)
#define SW_PORT_PFPCR_FPE_TC3_SHIFT              (3U)
#define SW_PORT_PFPCR_FPE_TC3_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC3(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC3_SHIFT)) & SW_PORT_PFPCR_FPE_TC3_MASK)

#define SW_PORT_PFPCR_FPE_TC4_MASK               (0x10U)
#define SW_PORT_PFPCR_FPE_TC4_SHIFT              (4U)
#define SW_PORT_PFPCR_FPE_TC4_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC4(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC4_SHIFT)) & SW_PORT_PFPCR_FPE_TC4_MASK)

#define SW_PORT_PFPCR_FPE_TC5_MASK               (0x20U)
#define SW_PORT_PFPCR_FPE_TC5_SHIFT              (5U)
#define SW_PORT_PFPCR_FPE_TC5_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC5(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC5_SHIFT)) & SW_PORT_PFPCR_FPE_TC5_MASK)

#define SW_PORT_PFPCR_FPE_TC6_MASK               (0x40U)
#define SW_PORT_PFPCR_FPE_TC6_SHIFT              (6U)
#define SW_PORT_PFPCR_FPE_TC6_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC6(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC6_SHIFT)) & SW_PORT_PFPCR_FPE_TC6_MASK)

#define SW_PORT_PFPCR_FPE_TC7_MASK               (0x80U)
#define SW_PORT_PFPCR_FPE_TC7_SHIFT              (7U)
#define SW_PORT_PFPCR_FPE_TC7_WIDTH              (1U)
#define SW_PORT_PFPCR_FPE_TC7(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PFPCR_FPE_TC7_SHIFT)) & SW_PORT_PFPCR_FPE_TC7_MASK)
/*! @} */
...
#define SW_PORT_PDGSR_DGS_TC0_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC1_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC2_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC3_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC4_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC5_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC6_WIDTH              (1U)
...
#define SW_PORT_PDGSR_DGS_TC7_WIDTH              (1U)
...
#define SW_PORT_PRXDCR_COUNT_WIDTH               (32U)
...
#define SW_PORT_PRXDCRR0_PCDR_WIDTH              (1U)
...
#define SW_PORT_PRXDCRR0_SMREDR_WIDTH            (1U)
...
#define SW_PORT_PRXDCRR0_RXDISDR_WIDTH           (1U)
...
#define SW_PORT_PRXDCRR0_IPFDR_WIDTH             (1U)
...
#define SW_PORT_PRXDCRR0_RPDR_WIDTH              (1U)
...
#define SW_PORT_PRXDCRR0_ISFDR_WIDTH             (1U)
...
#define SW_PORT_PRXDCRR0_SGCDR_WIDTH             (1U)
...
#define SW_PORT_PRXDCRR0_SGOEDR_WIDTH            (1U)
...
#define SW_PORT_PRXDCRR0_MSDUEDR_WIDTH           (1U)
...
#define SW_PORT_PRXDCRR0_FMMEDR_WIDTH            (1U)
...
#define SW_PORT_PRXDCRR0_CMDR_WIDTH              (1U)
...
#define SW_PORT_PRXDCRR0_ITEDR_WIDTH             (1U)
...
#define SW_PORT_PRXDCRR0_ECCEDR_WIDTH            (1U)
...
#define SW_PORT_PRXDCRR0_L2DOSDR_WIDTH           (1U)
...
#define SW_PORT_PRXDCRR0_L3DOSDR_WIDTH           (1U)
#define SW_PORT_PRXDCRR0_L3DOSDR(x)              (((uint32_t)(((uint32_t)(x)) << SW_PORT_PRXDCRR0_L3DOSDR_SHIFT)) & SW_PORT_PRXDCRR0_L3DOSDR_MASK)

#define SW_PORT_PRXDCRR0_PEDR_MASK               (0x10000U)
#define SW_PORT_PRXDCRR0_PEDR_SHIFT              (16U)
#define SW_PORT_PRXDCRR0_PEDR_WIDTH              (1U)
#define SW_PORT_PRXDCRR0_PEDR(x)                 (((uint32_t)(((uint32_t)(x)) << SW_PORT_PRXDCRR0_PEDR_SHIFT)) & SW_PORT_PRXDCRR0_PEDR_MASK)

#define SW_PORT_PRXDCRR0_NODESTDR_MASK           (0x20000U)
#define SW_PORT_PRXDCRR0_NODESTDR_SHIFT          (17U)
#define SW_PORT_PRXDCRR0_NODESTDR_WIDTH          (1U)
...
#define SW_PORT_PRXDCRR0_NSTPDR_WIDTH            (1U)
...
#define SW_PORT_PRXDCRR0_NSTDDR_WIDTH            (1U)
#define SW_PORT_PRXDCRR0_NSTDDR(x)               (((uint32_t)(((uint32_t)(x)) << SW_PORT_PRXDCRR0_NSTDDR_SHIFT)) & SW_PORT_PRXDCRR0_NSTDDR_MASK)

#define SW_PORT_PRXDCRR0_ASIDR_MASK              (0x100000U)
#define SW_PORT_PRXDCRR0_ASIDR_SHIFT             (20U)
#define SW_PORT_PRXDCRR0_ASIDR_WIDTH             (1U)
#define SW_PORT_PRXDCRR0_ASIDR(x)                (((uint32_t)(((uint32_t)(x)) << SW_PORT_PRXDCRR0_ASIDR_SHIFT)) & SW_PORT_PRXDCRR0_ASIDR_MASK)
/*! @} */
...
#define SW_PORT_PRXDCRR1_ENTRYID_WIDTH           (16U)
...
#define SW_PORT_PRXDCRR1_TT_WIDTH                (4U)
...
#define SW_PORT_PTXDCR_COUNT_WIDTH               (32U)
...
#define SW_PORT_PTXDCRR0_TXDISDR_WIDTH           (1U)
...
#define SW_PORT_PTXDCRR0_ECCEDR_WIDTH            (1U)
...
#define SW_PORT_PTXDCRR0_PEDR_WIDTH              (1U)
...
#define SW_PORT_PTXDCRR0_TGSFTLDR_WIDTH          (1U)
...
#define SW_PORT_PTXDCRR0_FMMDR_WIDTH             (1U)
...
#define SW_PORT_PTXDCRR0_TXDISEDR_WIDTH          (1U)
...
#define SW_PORT_PTXDCRR0_MSDUEDR_WIDTH           (1U)
...
#define SW_PORT_PTXDCRR0_QCONGDR_WIDTH           (1U)
...
#define SW_PORT_PTXDCRR0_ITEDR_WIDTH             (1U)
...
#define SW_PORT_PTXDCRR0_INVEQDR_WIDTH           (1U)
...
#define SW_PORT_PTXDCRR0_SQRTNSQDR_WIDTH         (1U)
...
#define SW_PORT_PTXDCRR0_SQRRDR_WIDTH            (1U)
...
#define SW_PORT_PTXDCRR0_SQRDDR_WIDTH            (1U)
...
#define SW_PORT_PTXDCRR0_SMREDR_WIDTH            (1U)
...
#define SW_PORT_PTXDCRR1_ENTRYID_WIDTH           (16U)
...
#define SW_PORT_PTXDCRR1_TT_WIDTH                (4U)
...
#define SW_PORT_PTGSTCSR_LH_STATE_WIDTH          (1U)
#define SW_PORT_PTGSTCSR_LH_STATE(x)             (((uint32_t)(((uint32_t)(x)) << SW_PORT_PTGSTCSR_LH_STATE_SHIFT)) & SW_PORT_PTGSTCSR_LH_STATE_MASK)
/*! @} */

/*! @name PTGSTCOCR - Port time gate scheduling traffic class 0 overrun counter register..Port time gate scheduling traffic class 7 overrun counter register */
/*! @{ */

#define SW_PORT_PTGSTCOCR_TX_OVERRUN_MASK        (0xFU)
#define SW_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT       (0U)
#define SW_PORT_PTGSTCOCR_TX_OVERRUN_WIDTH       (4U)
#define SW_PORT_PTGSTCOCR_TX_OVERRUN(x)          (((uint32_t)(((uint32_t)(x)) << SW_PORT_PTGSTCOCR_TX_OVERRUN_SHIFT)) & SW_PORT_PTGSTCOCR_TX_OVERRUN_MASK)
/*! @} */
...
#define SW_PORT_PTCTMSDUR_MAXSDU_WIDTH           (16U)
...
#define SW_PORT_PTCTMSDUR_SDU_TYPE_WIDTH         (2U)
...
#define SW_PORT_PTCTMSDUR_SF_MAXSDU_DIS_WIDTH    (1U)
...
#define SW_PORT_PTCCBSR0_BW_WIDTH                (7U)
...
#define SW_PORT_PTCCBSR0_FRACT_WIDTH             (4U)
...
#define SW_PORT_PTCCBSR0_CBSE_WIDTH              (1U)
...
#define SW_PORT_PTCCBSR1_HI_CREDIT_WIDTH         (32U)
...
#define SW_PORT_PTCCBSR2_IDLESLOPE_WIDTH         (27U)
...
#define SW_PORT_PTCCBSR2_CBSE_WIDTH              (1U)
...
#define SW_PORT_PBPMCR0_IPV0_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR0_IPV1_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR0_IPV2_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR0_IPV3_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR1_IPV4_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR1_IPV5_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR1_IPV6_INDEX_WIDTH         (8U)
...
#define SW_PORT_PBPMCR1_IPV7_INDEX_WIDTH         (8U)
...
#define SW_PORT_PGCR_PGID_WIDTH                  (3U)
...
#define SW_PORT_PPCPDEIMR_IPCPMP_WIDTH           (4U)
...
#define SW_PORT_PPCPDEIMR_IPCPMPV_WIDTH          (1U)
...
#define SW_PORT_PPCPDEIMR_EPCPMP_WIDTH           (4U)
...
#define SW_PORT_PPCPDEIMR_EPCPMPV_WIDTH          (1U)
...
#define SW_PORT_PPCPDEIMR_DR0DEI_WIDTH           (1U)
...
#define SW_PORT_PPCPDEIMR_DR1DEI_WIDTH           (1U)
...
#define SW_PORT_PPCPDEIMR_DR2DEI_WIDTH           (1U)
...
#define SW_PORT_PPCPDEIMR_DR3DEI_WIDTH           (1U)
...
#define SW_PORT_PPCPDEIMR_DRME_WIDTH             (1U)
...
#define SW_PORT_PMCR_MIRE_MASK                   (0x1U)
#define SW_PORT_PMCR_MIRE_SHIFT                  (0U)
#define SW_PORT_PMCR_MIRE_WIDTH                  (1U)
#define SW_PORT_PMCR_MIRE(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR_MIRE_SHIFT)) & SW_PORT_PMCR_MIRE_MASK)

#define SW_PORT_PMCR_DIR_MASK                    (0x10U)
#define SW_PORT_PMCR_DIR_SHIFT                   (4U)
#define SW_PORT_PMCR_DIR_WIDTH                   (1U)
#define SW_PORT_PMCR_DIR(x)                      (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR_DIR_SHIFT)) & SW_PORT_PMCR_DIR_MASK)

#define SW_PORT_PMCR_MACM_MASK                   (0x300U)
#define SW_PORT_PMCR_MACM_SHIFT                  (8U)
#define SW_PORT_PMCR_MACM_WIDTH                  (2U)
#define SW_PORT_PMCR_MACM(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR_MACM_SHIFT)) & SW_PORT_PMCR_MACM_MASK)

#define SW_PORT_PMCR_VIDM_MASK                   (0x3000U)
#define SW_PORT_PMCR_VIDM_SHIFT                  (12U)
#define SW_PORT_PMCR_VIDM_WIDTH                  (2U)
#define SW_PORT_PMCR_VIDM(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR_VIDM_SHIFT)) & SW_PORT_PMCR_VIDM_MASK)

#define SW_PORT_PMCR_PCPM_MASK                   (0x10000U)
#define SW_PORT_PMCR_PCPM_SHIFT                  (16U)
#define SW_PORT_PMCR_PCPM_WIDTH                  (1U)
#define SW_PORT_PMCR_PCPM(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR_PCPM_SHIFT)) & SW_PORT_PMCR_PCPM_MASK)
/*! @} */

/*! @name PMCR1 - Port mirror configuration register 1 */
/*! @{ */

#define SW_PORT_PMCR1_MAC_ADDR_MASK              (0xFFFFFFFFU)
#define SW_PORT_PMCR1_MAC_ADDR_SHIFT             (0U)
#define SW_PORT_PMCR1_MAC_ADDR_WIDTH             (32U)
#define SW_PORT_PMCR1_MAC_ADDR(x)                (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR1_MAC_ADDR_SHIFT)) & SW_PORT_PMCR1_MAC_ADDR_MASK)
/*! @} */

/*! @name PMCR2 - Port mirror configuration register 2 */
/*! @{ */

#define SW_PORT_PMCR2_MAC_ADDR_MASK              (0xFFFFU)
#define SW_PORT_PMCR2_MAC_ADDR_SHIFT             (0U)
#define SW_PORT_PMCR2_MAC_ADDR_WIDTH             (16U)
#define SW_PORT_PMCR2_MAC_ADDR(x)                (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR2_MAC_ADDR_SHIFT)) & SW_PORT_PMCR2_MAC_ADDR_MASK)

#define SW_PORT_PMCR2_VID_MASK                   (0xFFF0000U)
#define SW_PORT_PMCR2_VID_SHIFT                  (16U)
#define SW_PORT_PMCR2_VID_WIDTH                  (12U)
#define SW_PORT_PMCR2_VID(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR2_VID_SHIFT)) & SW_PORT_PMCR2_VID_MASK)

#define SW_PORT_PMCR2_PCP_MASK                   (0x70000000U)
#define SW_PORT_PMCR2_PCP_SHIFT                  (28U)
#define SW_PORT_PMCR2_PCP_WIDTH                  (3U)
#define SW_PORT_PMCR2_PCP(x)                     (((uint32_t)(((uint32_t)(x)) << SW_PORT_PMCR2_PCP_SHIFT)) & SW_PORT_PMCR2_PCP_MASK)
/*! @} */

/*! @name PCTFCR - Port cut through forwarding configuration register */
/*! @{ */

#define SW_PORT_PCTFCR_ICTS_MASK                 (0x1U)
#define SW_PORT_PCTFCR_ICTS_SHIFT                (0U)
#define SW_PORT_PCTFCR_ICTS_WIDTH                (1U)
#define SW_PORT_PCTFCR_ICTS(x)                   (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCTFCR_ICTS_SHIFT)) & SW_PORT_PCTFCR_ICTS_MASK)

#define SW_PORT_PCTFCR_ECTS_MASK                 (0x2U)
#define SW_PORT_PCTFCR_ECTS_SHIFT                (1U)
#define SW_PORT_PCTFCR_ECTS_WIDTH                (1U)
#define SW_PORT_PCTFCR_ECTS(x)                   (((uint32_t)(((uint32_t)(x)) << SW_PORT_PCTFCR_ECTS_SHIFT)) & SW_PORT_PCTFCR_ECTS_MASK)
/*! @} */
...
#define SW_PORT_PISIDCR_KCPAIR_WIDTH             (1U)
...
#define SW_PORT_PISIDCR_KC0EN_WIDTH              (1U)
...
#define SW_PORT_PISIDCR_KC1EN_WIDTH              (1U)
...
#define SW_PORT_PISIDCR_ISEID_WIDTH              (16U)
...
#define SW_PORT_PFMCR_FMMA_WIDTH                 (1U)
...
#define SW_PORT_PIPV2QMR0_IPV0_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV1_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV2_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV3_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV4_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV5_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV6_Q_WIDTH           (4U)
...
#define SW_PORT_PIPV2QMR0_IPV7_Q_WIDTH           (4U)
...
#define SW_PORT_PTCMINLR_LATENCY_WIDTH           (30U)
...
#define SW_PORT_PTCMINLR_COUNT_WIDTH             (2U)
...
#define SW_PORT_PTCMAXLR_LATENCY_WIDTH           (30U)
...
#define SW_PORT_PSRCR_TX_SQTA_WIDTH              (1U)
...
#define SW_PORT_PSRCR_PATHID_WIDTH               (4U)
...
#define SW_PORT_PSRCR_ISQG_EID_WIDTH             (16U)
...
#define SW_PORT_BPCR_DYN_LIMIT_WIDTH             (16U)
...
#define SW_PORT_BPCR_MLO_WIDTH                   (3U)
...
#define SW_PORT_BPCR_UUCASTE_WIDTH               (1U)
...
#define SW_PORT_BPCR_UMCASTE_WIDTH               (1U)
...
#define SW_PORT_BPCR_MCASTE_WIDTH                (1U)
...
#define SW_PORT_BPCR_BCASTE_WIDTH                (1U)
...
#define SW_PORT_BPCR_STAMVD_WIDTH                (1U)
...
#define SW_PORT_BPCR_SRCPRND_WIDTH               (1U)
...
#define SW_PORT_BPDVR_VID_WIDTH                  (12U)
...
#define SW_PORT_BPDVR_DEI_WIDTH                  (1U)
...
#define SW_PORT_BPDVR_PCP_WIDTH                  (3U)
...
#define SW_PORT_BPDVR_TPID_WIDTH                 (1U)
...
#define SW_PORT_BPDVR_RXTAGA_WIDTH               (4U)
...
#define SW_PORT_BPDVR_RXVAM_WIDTH                (1U)
...
#define SW_PORT_BPDVR_TXTAGA_WIDTH               (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE0_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE1_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE2_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE3_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE4_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE5_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE6_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE7_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE8_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE9_WIDTH         (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE10_WIDTH        (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE11_WIDTH        (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE12_WIDTH        (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE13_WIDTH        (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE14_WIDTH        (2U)
...
#define SW_PORT_BPSTGSR_STG_STATE15_WIDTH        (2U)
...
#define SW_PORT_BPSCR0_UUCASTRPEID_WIDTH         (16U)
...
#define SW_PORT_BPSCR0_BCASTRPEID_WIDTH          (16U)
...
#define SW_PORT_BPSCR1_MCASTRPEID_WIDTH          (16U)
...
#define SW_PORT_BPSCR1_UMCASTRPEID_WIDTH         (16U)
...
#define SW_PORT_BPOR_NUM_DYN_WIDTH               (16U)
...
#define SW_PORT_BPDCR_COUNT_WIDTH                (32U)
...
#define SW_PORT_BPDCRR0_BPACDR_WIDTH             (1U)
...
#define SW_PORT_BPDCRR0_ISTGSDR_WIDTH            (1U)
...
#define SW_PORT_BPDCRR0_BPVFLTDR_WIDTH           (1U)
...
#define SW_PORT_BPDCRR0_MACLNFDR_WIDTH           (1U)
...
#define SW_PORT_BPDCRR0_STAMVDDR_WIDTH           (1U)
...
#define SW_PORT_BPDCRR0_MACFDDDR_WIDTH           (1U)
...
#define SW_PORT_BPDCRR0_NODESTDR_WIDTH           (1U)
...
#define SW_PORT_BPDCRR0_IPMFDR_WIDTH             (1U)
...
#define SW_PORT_BPDCRR0_UFMMDR_WIDTH             (1U)
...
#define SW_PORT_BPDCRR0_MISCDR_WIDTH             (1U)
...
#define SW_PORT_BPDCRR0_STRMCTRLDR_WIDTH         (1U)
...
#define SW_PORT_BPDCRR1_ENTRYID_WIDTH            (27U)
...
#define SW_PORT_BPDCRR1_TT_WIDTH                 (4U)
...
#define SW_PORT_BPMLFSR_BPMLLRFR_WIDTH           (1U)
...
#define SW_PORT_BPMLFSR_FFDBTRFR_WIDTH           (1U)
...
#define SW_PORT_BPMLFSR_HCCLRFR_WIDTH            (1U)
...
#endif  /* #if !defined(S32G274_SW_PORT_H_) */
