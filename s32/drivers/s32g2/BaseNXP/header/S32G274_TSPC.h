 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_TSPC
 *
...
#if !defined(S32G274_TSPC_H_)  /* Check if memory map has not been already included */
#define S32G274_TSPC_H_
...
typedef struct TSPC_Struct {
  __IO uint32_t GRP_EN;                            /**< Group Enable, offset: 0x0 */
  uint8_t RESERVED_0[76];
  struct TSPC_GROUP {                              /* offset: 0x50, array step: 0x50 */
...
/** Peripheral LPE_TSPC base address */
#define IP_LPE_TSPC_BASE                         (0x42080000u)
/** Peripheral LPE_TSPC base pointer */
#define IP_LPE_TSPC                              ((TSPC_Type *)IP_LPE_TSPC_BASE)
/** Array initializer of TSPC peripheral base addresses */
#define IP_TSPC_BASE_ADDRS                       { IP_LPE_TSPC_BASE }
/** Array initializer of TSPC peripheral base pointers */
#define IP_TSPC_BASE_PTRS                        { IP_LPE_TSPC }
...
#endif  /* #if !defined(S32G274_TSPC_H_) */
