...
/*!
 * @file S32G274_CANXL_SIC.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_SIC
 *
...
#if !defined(S32G274_CANXL_SIC_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_SIC_H_
...
typedef struct CANXL_SIC_Struct {
  ...
  __IO uint32_t SYSMSG1;                           /**< System Message 1, offset: 0x60 */
  __IO uint32_t SYSMSG2;                           /**< System Message 2, offset: 0x64 */
  ...
  __I  uint32_t BEC;                               /**< BCANXL Error Counter, offset: 0xA4 */
  uint8_t RESERVED_4[16];
  __I  uint32_t BST;                               /**< BCANXL Status, offset: 0xB8 */
  uint8_t RESERVED_5[4];
  __I  uint32_t BPCRC;                             /**< BCANXL Preface CRC, offset: 0xC0 */
  __I  uint32_t BCRC;                              /**< BCANXL CRC, offset: 0xC4 */
  __I  uint32_t BTDCS;                             /**< BCANXL Transceiver Delay Compensation Status, offset: 0xC8 */
...
#define IP_CANEXCEL__SIC_BASE                    (0x6A01B000u)
/** Peripheral CANEXCEL__SIC base pointer */
#define IP_CANEXCEL__SIC                         ((CANXL_SIC_Type *)IP_CANEXCEL__SIC_BASE)
/** Array initializer of CANXL_SIC peripheral base addresses */
#define IP_CANXL_SIC_BASE_ADDRS                  { IP_CANEXCEL__SIC_BASE }
/** Array initializer of CANXL_SIC peripheral base pointers */
#define IP_CANXL_SIC_BASE_PTRS                   { IP_CANEXCEL__SIC }
...
#define CANXL_SIC_SYSMC_MSGRREQ_MASK             (0x1000U)
#define CANXL_SIC_SYSMC_MSGRREQ_SHIFT            (12U)
#define CANXL_SIC_SYSMC_MSGRREQ_WIDTH            (1U)
#define CANXL_SIC_SYSMC_MSGRREQ(x)               (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSMC_MSGRREQ_SHIFT)) & CANXL_SIC_SYSMC_MSGRREQ_MASK)
...
#define CANXL_SIC_SYSMCFG_JMPRNG_MASK            (0x4U)
#define CANXL_SIC_SYSMCFG_JMPRNG_SHIFT           (2U)
#define CANXL_SIC_SYSMCFG_JMPRNG_WIDTH           (1U)
#define CANXL_SIC_SYSMCFG_JMPRNG(x)              (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSMCFG_JMPRNG_SHIFT)) & CANXL_SIC_SYSMCFG_JMPRNG_MASK)
...
#define CANXL_SIC_SYSIE_MRUIE_MASK               (0x8U)
#define CANXL_SIC_SYSIE_MRUIE_SHIFT              (3U)
#define CANXL_SIC_SYSIE_MRUIE_WIDTH              (1U)
#define CANXL_SIC_SYSIE_MRUIE(x)                 (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSIE_MRUIE_SHIFT)) & CANXL_SIC_SYSIE_MRUIE_MASK)
...
#define CANXL_SIC_SYSIE_MSGRNOTIE_MASK           (0x1000U)
#define CANXL_SIC_SYSIE_MSGRNOTIE_SHIFT          (12U)
#define CANXL_SIC_SYSIE_MSGRNOTIE_WIDTH          (1U)
#define CANXL_SIC_SYSIE_MSGRNOTIE(x)             (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSIE_MSGRNOTIE_SHIFT)) & CANXL_SIC_SYSIE_MSGRNOTIE_MASK)

#define CANXL_SIC_SYSIE_ABTACKIE_MASK            (0x2000U)
#define CANXL_SIC_SYSIE_ABTACKIE_SHIFT           (13U)
#define CANXL_SIC_SYSIE_ABTACKIE_WIDTH           (1U)
#define CANXL_SIC_SYSIE_ABTACKIE(x)              (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSIE_ABTACKIE_SHIFT)) & CANXL_SIC_SYSIE_ABTACKIE_MASK)

#define CANXL_SIC_SYSIE_CCNOTIE_MASK             (0x4000U)
#define CANXL_SIC_SYSIE_CCNOTIE_SHIFT            (14U)
#define CANXL_SIC_SYSIE_CCNOTIE_WIDTH            (1U)
#define CANXL_SIC_SYSIE_CCNOTIE(x)               (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSIE_CCNOTIE_SHIFT)) & CANXL_SIC_SYSIE_CCNOTIE_MASK)
...
#define CANXL_SIC_SYSS_STATE_MASK                (0x70U)
#define CANXL_SIC_SYSS_STATE_SHIFT               (4U)
#define CANXL_SIC_SYSS_STATE_WIDTH               (3U)
#define CANXL_SIC_SYSS_STATE(x)                  (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSS_STATE_SHIFT)) & CANXL_SIC_SYSS_STATE_MASK)
...
#define CANXL_SIC_SYSS_MSGRNOTF_MASK             (0x1000U)
#define CANXL_SIC_SYSS_MSGRNOTF_SHIFT            (12U)
#define CANXL_SIC_SYSS_MSGRNOTF_WIDTH            (1U)
#define CANXL_SIC_SYSS_MSGRNOTF(x)               (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSS_MSGRNOTF_SHIFT)) & CANXL_SIC_SYSS_MSGRNOTF_MASK)

#define CANXL_SIC_SYSS_ABTACK_MASK               (0x2000U)
#define CANXL_SIC_SYSS_ABTACK_SHIFT              (13U)
#define CANXL_SIC_SYSS_ABTACK_WIDTH              (1U)
#define CANXL_SIC_SYSS_ABTACK(x)                 (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSS_ABTACK_SHIFT)) & CANXL_SIC_SYSS_ABTACK_MASK)

#define CANXL_SIC_SYSS_CCNOTF_MASK               (0x4000U)
#define CANXL_SIC_SYSS_CCNOTF_SHIFT              (14U)
#define CANXL_SIC_SYSS_CCNOTF_WIDTH              (1U)
#define CANXL_SIC_SYSS_CCNOTF(x)                 (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSS_CCNOTF_SHIFT)) & CANXL_SIC_SYSS_CCNOTF_MASK)
...
/*! @name SYSMSG1 - System Message 1 */
/*! @{ */

#define CANXL_SIC_SYSMSG1_DATA_MASK              (0xFFFFFFFFU)
#define CANXL_SIC_SYSMSG1_DATA_SHIFT             (0U)
#define CANXL_SIC_SYSMSG1_DATA_WIDTH             (32U)
#define CANXL_SIC_SYSMSG1_DATA(x)                (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSMSG1_DATA_SHIFT)) & CANXL_SIC_SYSMSG1_DATA_MASK)
/*! @} */

/*! @name SYSMSG2 - System Message 2 */
/*! @{ */

#define CANXL_SIC_SYSMSG2_DATA_MASK              (0xFFFFFFFFU)
#define CANXL_SIC_SYSMSG2_DATA_SHIFT             (0U)
#define CANXL_SIC_SYSMSG2_DATA_WIDTH             (32U)
#define CANXL_SIC_SYSMSG2_DATA(x)                (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_SYSMSG2_DATA_SHIFT)) & CANXL_SIC_SYSMSG2_DATA_MASK)
/*! @} */
...
/*! @name BEC - BCANXL Error Counter */
/*! @{ */

#define CANXL_SIC_BEC_REC_MASK                   (0xFFU)
#define CANXL_SIC_BEC_REC_SHIFT                  (0U)
#define CANXL_SIC_BEC_REC_WIDTH                  (8U)
#define CANXL_SIC_BEC_REC(x)                     (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BEC_REC_SHIFT)) & CANXL_SIC_BEC_REC_MASK)

#define CANXL_SIC_BEC_TEC_MASK                   (0xFF00U)
#define CANXL_SIC_BEC_TEC_SHIFT                  (8U)
#define CANXL_SIC_BEC_TEC_WIDTH                  (8U)
#define CANXL_SIC_BEC_TEC(x)                     (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BEC_TEC_SHIFT)) & CANXL_SIC_BEC_TEC_MASK)

#define CANXL_SIC_BEC_DPREC_MASK                 (0xFF0000U)
#define CANXL_SIC_BEC_DPREC_SHIFT                (16U)
#define CANXL_SIC_BEC_DPREC_WIDTH                (8U)
#define CANXL_SIC_BEC_DPREC(x)                   (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BEC_DPREC_SHIFT)) & CANXL_SIC_BEC_DPREC_MASK)

#define CANXL_SIC_BEC_DPTEC_MASK                 (0xFF000000U)
#define CANXL_SIC_BEC_DPTEC_SHIFT                (24U)
#define CANXL_SIC_BEC_DPTEC_WIDTH                (8U)
#define CANXL_SIC_BEC_DPTEC(x)                   (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BEC_DPTEC_SHIFT)) & CANXL_SIC_BEC_DPTEC_MASK)
/*! @} */

/*! @name BST - BCANXL Status */
/*! @{ */

#define CANXL_SIC_BST_CANCS_MASK                 (0x3U)
#define CANXL_SIC_BST_CANCS_SHIFT                (0U)
#define CANXL_SIC_BST_CANCS_WIDTH                (2U)
#define CANXL_SIC_BST_CANCS(x)                   (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BST_CANCS_SHIFT)) & CANXL_SIC_BST_CANCS_MASK)

#define CANXL_SIC_BST_FLTCONF_MASK               (0xCU)
#define CANXL_SIC_BST_FLTCONF_SHIFT              (2U)
#define CANXL_SIC_BST_FLTCONF_WIDTH              (2U)
#define CANXL_SIC_BST_FLTCONF(x)                 (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BST_FLTCONF_SHIFT)) & CANXL_SIC_BST_FLTCONF_MASK)

#define CANXL_SIC_BST_RX_PIN_ST_MASK             (0x400000U)
#define CANXL_SIC_BST_RX_PIN_ST_SHIFT            (22U)
#define CANXL_SIC_BST_RX_PIN_ST_WIDTH            (1U)
#define CANXL_SIC_BST_RX_PIN_ST(x)               (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BST_RX_PIN_ST_SHIFT)) & CANXL_SIC_BST_RX_PIN_ST_MASK)
/*! @} */

/*! @name BPCRC - BCANXL Preface CRC */
/*! @{ */

#define CANXL_SIC_BPCRC_PCRC_MASK                (0x1FFFU)
#define CANXL_SIC_BPCRC_PCRC_SHIFT               (0U)
#define CANXL_SIC_BPCRC_PCRC_WIDTH               (13U)
#define CANXL_SIC_BPCRC_PCRC(x)                  (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BPCRC_PCRC_SHIFT)) & CANXL_SIC_BPCRC_PCRC_MASK)
/*! @} */

/*! @name BCRC - BCANXL CRC */
/*! @{ */

#define CANXL_SIC_BCRC_CRC_MASK                  (0x1FFFFFU)
#define CANXL_SIC_BCRC_CRC_SHIFT                 (0U)
#define CANXL_SIC_BCRC_CRC_WIDTH                 (21U)
#define CANXL_SIC_BCRC_CRC(x)                    (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BCRC_CRC_SHIFT)) & CANXL_SIC_BCRC_CRC_MASK)
/*! @} */

/*! @name BTDCS - BCANXL Transceiver Delay Compensation Status */
/*! @{ */

#define CANXL_SIC_BTDCS_TDCVAL_MASK              (0x1FFU)
#define CANXL_SIC_BTDCS_TDCVAL_SHIFT             (0U)
#define CANXL_SIC_BTDCS_TDCVAL_WIDTH             (9U)
#define CANXL_SIC_BTDCS_TDCVAL(x)                (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BTDCS_TDCVAL_SHIFT)) & CANXL_SIC_BTDCS_TDCVAL_MASK)

#define CANXL_SIC_BTDCS_TDCVT_MASK               (0x20000000U)
#define CANXL_SIC_BTDCS_TDCVT_SHIFT              (29U)
#define CANXL_SIC_BTDCS_TDCVT_WIDTH              (1U)
#define CANXL_SIC_BTDCS_TDCVT(x)                 (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BTDCS_TDCVT_SHIFT)) & CANXL_SIC_BTDCS_TDCVT_MASK)

#define CANXL_SIC_BTDCS_XTDCFAIL_MASK            (0x40000000U)
#define CANXL_SIC_BTDCS_XTDCFAIL_SHIFT           (30U)
#define CANXL_SIC_BTDCS_XTDCFAIL_WIDTH           (1U)
#define CANXL_SIC_BTDCS_XTDCFAIL(x)              (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BTDCS_XTDCFAIL_SHIFT)) & CANXL_SIC_BTDCS_XTDCFAIL_MASK)

#define CANXL_SIC_BTDCS_FTDCFAIL_MASK            (0x80000000U)
#define CANXL_SIC_BTDCS_FTDCFAIL_SHIFT           (31U)
#define CANXL_SIC_BTDCS_FTDCFAIL_WIDTH           (1U)
#define CANXL_SIC_BTDCS_FTDCFAIL(x)              (((uint32_t)(((uint32_t)(x)) << CANXL_SIC_BTDCS_FTDCFAIL_SHIFT)) & CANXL_SIC_BTDCS_FTDCFAIL_MASK)
/*! @} */
...
#endif  /* #if !defined(S32G274_CANXL_SIC_H_) */
