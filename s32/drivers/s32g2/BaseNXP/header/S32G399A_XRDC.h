...
typedef struct {
  ...
  struct {                                         /* offset: 0x1000, array step: index*0x80, index2*0x8 */
...
#define XRDC_MDA_W0_3_DFMT1_LPID_MASK            (0xF000000U)
#define XRDC_MDA_W0_3_DFMT1_LPID_SHIFT           (24U)
#define XRDC_MDA_W0_3_DFMT1_LPID_WIDTH           (4U)
#define XRDC_MDA_W0_3_DFMT1_LPID(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_3_DFMT1_LPID_SHIFT)) & XRDC_MDA_W0_3_DFMT1_LPID_MASK)

#define XRDC_MDA_W0_3_DFMT1_LPE_MASK             (0x10000000U)
#define XRDC_MDA_W0_3_DFMT1_LPE_SHIFT            (28U)
#define XRDC_MDA_W0_3_DFMT1_LPE_WIDTH            (1U)
#define XRDC_MDA_W0_3_DFMT1_LPE(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_3_DFMT1_LPE_SHIFT)) & XRDC_MDA_W0_3_DFMT1_LPE_MASK)
...
#define XRDC_MDA_W0_4_DFMT1_LPID_MASK            (0xF000000U)
#define XRDC_MDA_W0_4_DFMT1_LPID_SHIFT           (24U)
#define XRDC_MDA_W0_4_DFMT1_LPID_WIDTH           (4U)
#define XRDC_MDA_W0_4_DFMT1_LPID(x)              (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT1_LPID_SHIFT)) & XRDC_MDA_W0_4_DFMT1_LPID_MASK)

#define XRDC_MDA_W0_4_DFMT1_LPE_MASK             (0x10000000U)
#define XRDC_MDA_W0_4_DFMT1_LPE_SHIFT            (28U)
#define XRDC_MDA_W0_4_DFMT1_LPE_WIDTH            (1U)
#define XRDC_MDA_W0_4_DFMT1_LPE(x)               (((uint32_t)(((uint32_t)(x)) << XRDC_MDA_W0_4_DFMT1_LPE_SHIFT)) & XRDC_MDA_W0_4_DFMT1_LPE_MASK)
