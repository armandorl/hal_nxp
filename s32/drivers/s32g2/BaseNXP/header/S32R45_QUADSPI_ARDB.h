...
/*!
 * @file S32R45_QuadSPI_ARDB.h
 * @version 2.4
 * @date 2022-02-14
 * @brief Peripheral Access Layer for S32R45_QuadSPI_ARDB
 *
...
#if !defined(S32R45_QuadSPI_ARDB_H_)  /* Check if memory map has not been already included */
#define S32R45_QuadSPI_ARDB_H_
...
#endif  /* #if !defined(S32R45_QuadSPI_ARDB_H_) */
