 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_BCTU
 *
...
#if !defined(S32G274_BCTU_H_)  /* Check if memory map has not been already included */
#define S32G274_BCTU_H_
...
typedef struct BCTU_Struct {
  __IO uint32_t MCR;                               /**< Module Configuration, offset: 0x0 */
  uint8_t RESERVED_0[4];
  __IO uint32_t MSR;                               /**< Module Status, offset: 0x8 */
  uint8_t RESERVED_1[12];
  __IO uint32_t TRGCFG[BCTU_TRGCFG_COUNT];         /**< Trigger Configuration, array offset: 0x18, array step: 0x4, irregular array, not all indices are valid */
  ...
  __IO uint32_t SFTRGR2;                           /**< Software Trigger 2, offset: 0x230, available only on: BCTU (missing on LPE_BCTU) */
  __IO uint32_t SFTRGR3;                           /**< Software Trigger 3, offset: 0x234, available only on: BCTU (missing on LPE_BCTU) */
  uint8_t RESERVED_3[4];
  __I  uint32_t ADCDR[BCTU_ADCDR_COUNT];           /**< ADC0 Result Data..ADC1 Result Data, array offset: 0x23C, array step: 0x4, irregular array, not all indices are valid */
  uint8_t RESERVED_4[8];
  __I  uint32_t LISTSTAR;                          /**< CL Size Status, offset: 0x24C */
  __IO uint32_t LISTCHR[BCTU_LISTCHR_COUNT];       /**< CL Channel Address, array offset: 0x250, array step: 0x4, irregular array, not all indices are valid */
...
#define BCTU_INSTANCE_COUNT                      (2u)

/* BCTU - Peripheral instance base addresses */
/** Peripheral BCTU base address */
#define IP_BCTU_BASE                             (0x4069C000u)
/** Peripheral BCTU base pointer */
#define IP_BCTU                                  ((BCTU_Type *)IP_BCTU_BASE)
/** Peripheral LPE_BCTU base address */
#define IP_LPE_BCTU_BASE                         (0x42154000u)
/** Peripheral LPE_BCTU base pointer */
#define IP_LPE_BCTU                              ((BCTU_Type *)IP_LPE_BCTU_BASE)
/** Array initializer of BCTU peripheral base addresses */
#define IP_BCTU_BASE_ADDRS                       { IP_BCTU_BASE, IP_LPE_BCTU_BASE }
/** Array initializer of BCTU peripheral base pointers */
#define IP_BCTU_BASE_PTRS                        { IP_BCTU, IP_LPE_BCTU }
...
#define BCTU_FIFOWM_WM_FIFO1_MASK                (0xFU)  /* Merged from fields with different position or width, of widths (3, 4), largest definition used */
#define BCTU_FIFOWM_WM_FIFO1_SHIFT               (0U)
#define BCTU_FIFOWM_WM_FIFO1_WIDTH               (4U)
#define BCTU_FIFOWM_WM_FIFO1(x)                  (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOWM_WM_FIFO1_SHIFT)) & BCTU_FIFOWM_WM_FIFO1_MASK)  /* Merged from fields with different position or width, of widths (3, 4), largest definition used */
...
#define BCTU_FIFOCNTR_CNTR_FIFO1_MASK            (0x1FU)  /* Merged from fields with different position or width, of widths (4, 5), largest definition used */
#define BCTU_FIFOCNTR_CNTR_FIFO1_SHIFT           (0U)
#define BCTU_FIFOCNTR_CNTR_FIFO1_WIDTH           (5U)
#define BCTU_FIFOCNTR_CNTR_FIFO1(x)              (((uint32_t)(((uint32_t)(x)) << BCTU_FIFOCNTR_CNTR_FIFO1_SHIFT)) & BCTU_FIFOCNTR_CNTR_FIFO1_MASK)  /* Merged from fields with different position or width, of widths (4, 5), largest definition used */
...
#endif  /* #if !defined(S32G274_BCTU_H_) */
