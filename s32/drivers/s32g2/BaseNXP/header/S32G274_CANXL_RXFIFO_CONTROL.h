...
/*!
 * @file S32G274_CANXL_RXFIFO_CONTROL.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CANXL_RXFIFO_CONTROL
 *
...
#if !defined(S32G274_CANXL_RXFIFO_CONTROL_H_)  /* Check if memory map has not been already included */
#define S32G274_CANXL_RXFIFO_CONTROL_H_
...
typedef struct CANXL_RXFIFO_CONTROL_Struct {
...
#define CANXL_RXFIFO_CONTROL_INSTANCE_COUNT      (1u)

/* CANXL_RXFIFO_CONTROL - Peripheral instance base addresses */
/** Peripheral CANEXCEL__RXFIFO_CONTROL base address */
#define IP_CANEXCEL__RXFIFO_CONTROL_BASE         (0x6A025000u)
/** Peripheral CANEXCEL__RXFIFO_CONTROL base pointer */
#define IP_CANEXCEL__RXFIFO_CONTROL              ((CANXL_RXFIFO_CONTROL_Type *)IP_CANEXCEL__RXFIFO_CONTROL_BASE)
/** Array initializer of CANXL_RXFIFO_CONTROL peripheral base addresses */
#define IP_CANXL_RXFIFO_CONTROL_BASE_ADDRS       { IP_CANEXCEL__RXFIFO_CONTROL_BASE }
/** Array initializer of CANXL_RXFIFO_CONTROL peripheral base pointers */
#define IP_CANXL_RXFIFO_CONTROL_BASE_PTRS        { IP_CANEXCEL__RXFIFO_CONTROL }
...
#endif  /* #if !defined(S32G274_CANXL_RXFIFO_CONTROL_H_) */
