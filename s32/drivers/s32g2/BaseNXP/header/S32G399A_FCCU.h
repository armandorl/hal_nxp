...
/*!
 * @file S32G399A_FCCU.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_FCCU
 *
...
#if !defined(S32G399A_FCCU_H_)  /* Check if memory map has not been already included */
#define S32G399A_FCCU_H_
...
#define IP_FCCU_BASE                             (0x4030C000u)
...
#endif  /* #if !defined(S32G399A_FCCU_H_) */
