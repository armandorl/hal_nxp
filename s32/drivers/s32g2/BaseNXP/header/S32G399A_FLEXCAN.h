...
/*!
 * @file S32G399A_FLEXCAN.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_FLEXCAN
 *
...
#if !defined(S32G399A_FLEXCAN_H_)  /* Check if memory map has not been already included */
#define S32G399A_FLEXCAN_H_
...
#define IP_FLEXCAN_BASE_ADDRS                    { IP_CAN_0_BASE, IP_CAN_1_BASE, IP_CAN_2_BASE, IP_CAN_3_BASE }
/** Array initializer of FLEXCAN peripheral base pointers */
#define IP_FLEXCAN_BASE_PTRS                     { IP_CAN_0, IP_CAN_1, IP_CAN_2, IP_CAN_3 }
...
#endif  /* #if !defined(S32G399A_FLEXCAN_H_) */
