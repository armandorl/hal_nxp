 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_PMC
 *
...
#if !defined(S32G274_PMC_H_)  /* Check if memory map has not been already included */
#define S32G274_PMC_H_
...
#endif  /* #if !defined(S32G274_PMC_H_) */
