...
/*!
 * @file S32G274_CAN_HUB.h
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_CAN_HUB
 *
...
#if !defined(S32G274_CAN_HUB_H_)  /* Check if memory map has not been already included */
#define S32G274_CAN_HUB_H_
...
/** Peripheral CAN_HUB base address */
#define IP_CAN_HUB_BASE                          (0x4028C000u)
/** Peripheral CAN_HUB base pointer */
#define IP_CAN_HUB                               ((CAN_HUB_Type *)IP_CAN_HUB_BASE)
/** Array initializer of CAN_HUB peripheral base addresses */
#define IP_CAN_HUB_BASE_ADDRS                    { IP_CAN_HUB_BASE }
/** Array initializer of CAN_HUB peripheral base pointers */
#define IP_CAN_HUB_BASE_PTRS                     { IP_CAN_HUB }
...
#define CAN_HUB_CANNETW_STATUS_MASK              (0x1FFFFU)
#define CAN_HUB_CANNETW_STATUS_SHIFT             (0U)
#define CAN_HUB_CANNETW_STATUS_WIDTH             (17U)
...
#endif  /* #if !defined(S32G274_CAN_HUB_H_) */
