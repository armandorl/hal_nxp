 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_FTM
 *
...
#if !defined(S32G274_FTM_H_)  /* Check if memory map has not been already included */
#define S32G274_FTM_H_
...
typedef struct FTM_Struct {
  __IO uint32_t SC;                                /**< Status and Control, offset: 0x0 */
  __IO uint32_t CNT;                               /**< Counter, offset: 0x4 */
  __IO uint32_t MOD;                               /**< Modulo, offset: 0x8 */
  struct FTM_CONTROLS {                            /* offset: 0xC, array step: 0x8 */
    __IO uint32_t CnSC;                               /**< Channel n Status and Control, array offset: 0xC, array step: 0x8 */
    __IO uint32_t CnV;                                /**< Channel n Value, array offset: 0x10, array step: 0x8 */
  } CONTROLS[FTM_CnSC_COUNT];
  __IO uint32_t CNTIN;                             /**< Counter Initial Value, offset: 0x4C */
  __IO uint32_t STATUS;                            /**< Capture and Compare Status, offset: 0x50 */
  __IO uint32_t MODE;                              /**< Feature Mode Selection, offset: 0x54 */
  __IO uint32_t SYNC;                              /**< Synchronization, offset: 0x58 */
  __IO uint32_t OUTINIT;                           /**< Initial State for Channel Output, offset: 0x5C */
  __IO uint32_t OUTMASK;                           /**< Output Mask, offset: 0x60 */
  __IO uint32_t COMBINE;                           /**< Functions for Linked Channels, offset: 0x64 */
  __IO uint32_t DEADTIME;                          /**< Dead Time Configuration, offset: 0x68 */
  ...
  __IO uint32_t HCR;                               /**< Half-Cycle Reload, offset: 0x9C */
  __IO uint32_t PAIR0DEADTIME;                     /**< Pair 0 Dead Time Configuration, offset: 0xA0 */
  uint8_t RESERVED_0[4];
  __IO uint32_t PAIR1DEADTIME;                     /**< Pair 1 Dead Time Configuration, offset: 0xA8 */
  uint8_t RESERVED_1[4];
  __IO uint32_t PAIR2DEADTIME;                     /**< Pair 2 Dead Time Configuration, offset: 0xB0 */
  uint8_t RESERVED_2[4];
  __IO uint32_t PAIR3DEADTIME;                     /**< Pair 3 Dead Time Configuration, offset: 0xB8 */
...
#define FTM_INSTANCE_COUNT                       (1u)

/* FTM - Peripheral instance base addresses */
/** Peripheral LPE_FTM base address */
#define IP_LPE_FTM_BASE                          (0x42158000u)
/** Peripheral LPE_FTM base pointer */
#define IP_LPE_FTM                               ((FTM_Type *)IP_LPE_FTM_BASE)
/** Array initializer of FTM peripheral base addresses */
#define IP_FTM_BASE_ADDRS                        { IP_LPE_FTM_BASE }
/** Array initializer of FTM peripheral base pointers */
#define IP_FTM_BASE_PTRS                         { IP_LPE_FTM }
...
/*! @name MODE - Feature Mode Selection */
/*! @{ */
...
/*! @name OUTINIT - Initial State for Channel Output */
/*! @{ */
...
/*! @name COMBINE - Functions for Linked Channels */
/*! @{ */
...
/*! @name DEADTIME - Dead Time Configuration */
/*! @{ */
...
/*! @name PAIR0DEADTIME - Pair 0 Dead Time Configuration */
/*! @{ */
...
/*! @name PAIR1DEADTIME - Pair 1 Dead Time Configuration */
/*! @{ */
...
/*! @name PAIR2DEADTIME - Pair 2 Dead Time Configuration */
/*! @{ */
...
/*! @name PAIR3DEADTIME - Pair 3 Dead Time Configuration */
/*! @{ */
...
#endif  /* #if !defined(S32G274_FTM_H_) */
