 ...
 * @version 2.2
 * @date 2025-10-16
 * @brief Peripheral Access Layer for S32G274_MCM
 *
...
#if !defined(S32G274_MCM_H_)  /* Check if memory map has not been already included */
#define S32G274_MCM_H_
...
typedef struct MCM_Struct {
  __I  uint16_t PLREV;                             /**< Chip-Defined Platform Revision, offset: 0x0 */
  ...
  __IO uint8_t PID;                                /**< Process Identifier, offset: 0x30 */
  uint8_t RESERVED_2[975];
...
/*! @name PLREV - Chip-Defined Platform Revision */
/*! @{ */
...
#define MCM_PID_PID(x)                           (((uint8_t)(((uint8_t)(x)) << MCM_PID_PID_SHIFT)) & MCM_PID_PID_MASK)
/*! @} */
...
#define MCM_LMEM_DESC_LMV_WIDTH                  (1U)
...
#endif  /* #if !defined(S32G274_MCM_H_) */
