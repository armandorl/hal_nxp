...
/*!
 * @file S32G399A_DMAMUX.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_DMAMUX
 *
...
#if !defined(S32G399A_DMAMUX_H_)  /* Check if memory map has not been already included */
#define S32G399A_DMAMUX_H_
...
#define IP_DMAMUX_0_BASE                         (0x4012C000u)
/** Peripheral DMAMUX_0 base pointer */
#define IP_DMAMUX_0                              ((DMAMUX_Type *)IP_DMAMUX_0_BASE)
/** Peripheral DMAMUX_1 base address */
#define IP_DMAMUX_1_BASE                         (0x40130000u)
/** Peripheral DMAMUX_1 base pointer */
#define IP_DMAMUX_1                              ((DMAMUX_Type *)IP_DMAMUX_1_BASE)
/** Peripheral DMAMUX_2 base address */
#define IP_DMAMUX_2_BASE                         (0x4022C000u)
/** Peripheral DMAMUX_2 base pointer */
#define IP_DMAMUX_2                              ((DMAMUX_Type *)IP_DMAMUX_2_BASE)
/** Peripheral DMAMUX_3 base address */
#define IP_DMAMUX_3_BASE                         (0x40230000u)
/** Peripheral DMAMUX_3 base pointer */
#define IP_DMAMUX_3                              ((DMAMUX_Type *)IP_DMAMUX_3_BASE)
/** Array initializer of DMAMUX peripheral base addresses */
#define IP_DMAMUX_BASE_ADDRS                     { IP_DMAMUX_0_BASE, IP_DMAMUX_1_BASE, IP_DMAMUX_2_BASE, IP_DMAMUX_3_BASE }
/** Array initializer of DMAMUX peripheral base pointers */
#define IP_DMAMUX_BASE_PTRS                      { IP_DMAMUX_0, IP_DMAMUX_1, IP_DMAMUX_2, IP_DMAMUX_3 }
...
#endif  /* #if !defined(S32G399A_DMAMUX_H_) */
