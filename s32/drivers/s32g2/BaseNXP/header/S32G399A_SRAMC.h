...
/*!
 * @file S32G399A_SRAMC.h
 * @version 2.7
 * @date 2022-07-21
 * @brief Peripheral Access Layer for S32G399A_SRAMC
 *
...
#if !defined(S32G399A_SRAMC_H_)  /* Check if memory map has not been already included */
#define S32G399A_SRAMC_H_
...
#define SRAMC_INSTANCE_COUNT                     (5u)

/* SRAMC - Peripheral instance base addresses */
/** Peripheral SRAMC base address */
#define IP_SRAMC_BASE                            (0x4019C000u)
/** Peripheral SRAMC base pointer */
#define IP_SRAMC                                 ((SRAMC_Type *)IP_SRAMC_BASE)
/** Peripheral SRAMC_1 base address */
#define IP_SRAMC_1_BASE                          (0x401A0000u)
/** Peripheral SRAMC_1 base pointer */
#define IP_SRAMC_1                               ((SRAMC_Type *)IP_SRAMC_1_BASE)
/** Peripheral SRAMC_2 base address */
#define IP_SRAMC_2_BASE                          (0x4055A000u)
/** Peripheral SRAMC_2 base pointer */
#define IP_SRAMC_2                               ((SRAMC_Type *)IP_SRAMC_2_BASE)
/** Peripheral SRAMC_3 base address */
#define IP_SRAMC_3_BASE                          (0x4055E000u)
/** Peripheral SRAMC_3 base pointer */
#define IP_SRAMC_3                               ((SRAMC_Type *)IP_SRAMC_3_BASE)
/** Peripheral STDBY_SRAM_CFG base address */
#define IP_STDBY_SRAM_CFG_BASE                   (0x44028000u)
/** Peripheral STDBY_SRAM_CFG base pointer */
#define IP_STDBY_SRAM_CFG                        ((SRAMC_Type *)IP_STDBY_SRAM_CFG_BASE)
/** Array initializer of SRAMC peripheral base addresses */
#define IP_SRAMC_BASE_ADDRS                      { IP_SRAMC_BASE, IP_SRAMC_1_BASE, IP_SRAMC_2_BASE, IP_SRAMC_3_BASE, IP_STDBY_SRAM_CFG_BASE }
/** Array initializer of SRAMC peripheral base pointers */
#define IP_SRAMC_BASE_PTRS                       { IP_SRAMC, IP_SRAMC_1, IP_SRAMC_2, IP_SRAMC_3, IP_STDBY_SRAM_CFG }
...
#endif  /* #if !defined(S32G399A_SRAMC_H_) */
