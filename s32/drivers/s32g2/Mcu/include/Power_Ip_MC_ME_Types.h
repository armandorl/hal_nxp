...
#define POWER_IP_MC_ME_TYPES_AR_RELEASE_MINOR_VERSION        4
#define POWER_IP_MC_ME_TYPES_AR_RELEASE_REVISION_VERSION     0
#define POWER_IP_MC_ME_TYPES_SW_MAJOR_VERSION                4
...
#define MC_ME_PRTNX_PCONF_OSSE_MASK_U32                 (MC_ME_PRTN1_PCONF_OSSE_MASK)
#define MC_ME_PRTNX_PCONF_OSSE_EN_U32                   (MC_ME_PRTN1_PCONF_OSSE_MASK)
#define MC_ME_PRTNX_PCONF_OSSE_DIS_U32                  ((uint32)0x00000000U)
...
/*                    MC_ME_PRTNx_PUPD                     */
/***********************************************************/
#define MC_ME_PRTNX_PUPD_PCUD_TRIG_U32                  (MC_ME_PRTN0_PUPD_PCUD_MASK)
#define MC_ME_PRTNX_PUPD_PCUD_NOT_TRIG_U32              ((uint32)0x00000000U)

#if (defined(POWER_IP_HAS_OUTPUT_SAFE_STATE))
  #if (POWER_IP_HAS_OUTPUT_SAFE_STATE == STD_ON)
#define MC_ME_PRTNX_PUPD_OSSUD_TRIG_U32                 (MC_ME_PRTN1_PUPD_OSSUD_MASK)
#define MC_ME_PRTNX_PUPD_OSSUD_NOT_TRIG_U32             ((uint32)0x00000000U)
  #endif
#endif /* (POWER_IP_HAS_OUTPUT_SAFE_STATE == STD_ON) */
...
#if (defined(POWER_IP_HAS_OUTPUT_SAFE_STATE))
  #if (POWER_IP_HAS_OUTPUT_SAFE_STATE == STD_ON)
#define MC_ME_PRTNX_STAT_OSSS_ACTIVE_U32                (MC_ME_PRTN1_STAT_OSSS_MASK)
#define MC_ME_PRTNX_STAT_OSSS_INACTIVE_U32              ((uint32)0x00000000U)
  #endif /* (POWER_IP_HAS_OUTPUT_SAFE_STATE == STD_ON) */
#endif
/***********************************************************/
