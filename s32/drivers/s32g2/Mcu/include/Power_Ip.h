...
#define POWER_IP_SW_MAJOR_VERSION                4
...
#define Power_Ip_DisableSleepOnExit()   Call_Power_Ip_CM7_DisableSleepOnExit()
#define Power_Ip_EnableSleepOnExit()    Call_Power_Ip_CM7_EnableSleepOnExit()
