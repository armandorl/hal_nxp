...
#define POWER_IP_MC_RGM_AR_RELEASE_MINOR_VERSION        4
...
#define  Call_Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_ModeConfig,(MC_RGM_pModeConfigPtr))
#define  Call_Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_CheckModeConfig,(MC_RGM_pModeConfigPtr))
#define  Call_Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_EnableResetDomain,(MC_RGM_pModeConfigPtr))
#define  Call_Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr) \
    OsIf_Trusted_Call1param(Power_Ip_MC_RGM_DisableResetDomain,(MC_RGM_pModeConfigPtr))

  #else /* (STD_OFF == POWER_IP_ENABLE_USER_MODE_SUPPORT) */

#define  Call_Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr) \
    Power_Ip_MC_RGM_ModeConfig(MC_RGM_pModeConfigPtr)
#define  Call_Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr) \
    Power_Ip_MC_RGM_CheckModeConfig(MC_RGM_pModeConfigPtr)
#define  Call_Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr) \
    Power_Ip_MC_RGM_EnableResetDomain(MC_RGM_pModeConfigPtr)
#define  Call_Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr) \
    Power_Ip_MC_RGM_DisableResetDomain(MC_RGM_pModeConfigPtr)

  #endif
#else /* ifndef POWER_IP_ENABLE_USER_MODE_SUPPORT */
...
#endif /* POWER_IP_RESET_DOMAINS_SUPPORTED */
