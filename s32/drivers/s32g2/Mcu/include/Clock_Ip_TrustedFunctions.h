...
#define CLOCK_IP_TRUSTEDFUNCTIONS_SW_MAJOR_VERSION                4
 ...
 *
 */
extern void Clock_Ip_ConfigureSetGenCtrl1(Clock_Ip_SelectorConfigType const *Config);
#endif
 ...
 *
 */
extern uint32 Clock_Ip_Get_GENCTRL1_CTRL(void);
