...
static uint32 get_PFEMAC1_TX_DIV_CLK_Frequency(void);
static uint32 get_PFEMAC2_TX_DIV_CLK_Frequency(void);
...

{
    ...
    get_PFEMAC1_TX_DIV_CLK_Frequency,             /* PFEMAC1_TX_DIV_CLK     */
    get_PFEMAC2_RX_CLK_Frequency,                 /* PFEMAC2_RX_CLK */
    get_PFEMAC2_TX_CLK_Frequency,                 /* PFEMAC2_TX_CLK */
    get_PFEMAC2_TX_DIV_CLK_Frequency,             /* PFEMAC2_TX_DIV_CLK     */
...
static uint32 get_PFEMAC1_TX_CLK_Frequency(void)
{
    ...
    if (0U != ((RegValue & CLOCK_IP_GENCTRL1_CTRL_EMAC1_MASK) << CLOCK_IP_GENCTRL1_CTRL_EMAC1_SHIFT))
    {
        Frequency = get_SERDES_1_XPCS_1_TX_Frequency();
    }
    else
    {
        Frequency = get_PFEMAC1_TX_DIV_CLK_Frequency();
    }
...
static uint32 get_PFEMAC2_TX_CLK_Frequency(void)
{
    ...
    if (0U != ((RegValue & CLOCK_IP_GENCTRL1_CTRL_EMAC2_MASK) << CLOCK_IP_GENCTRL1_CTRL_EMAC2_SHIFT))
    {
        Frequency = get_SERDES_0_XPCS_1_TX_Frequency();
    }
    else
    {
        Frequency = get_PFEMAC2_TX_DIV_CLK_Frequency();
    }
