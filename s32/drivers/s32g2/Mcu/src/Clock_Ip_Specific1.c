...
==================================================================================================*/
#define CLOCK_IP_SPECIFIC1_VENDOR_ID_C                      43
#define CLOCK_IP_SPECIFIC1_AR_RELEASE_MAJOR_VERSION_C       4
#define CLOCK_IP_SPECIFIC1_AR_RELEASE_MINOR_VERSION_C       4
#define CLOCK_IP_SPECIFIC1_AR_RELEASE_REVISION_VERSION_C    0
#define CLOCK_IP_SPECIFIC1_SW_MAJOR_VERSION_C               4
#define CLOCK_IP_SPECIFIC1_SW_MINOR_VERSION_C               0
#define CLOCK_IP_SPECIFIC1_SW_PATCH_VERSION_C               0

/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Check if Clock_Ip_Specific1.c file and Clock_Ip_Private.h file are of the same vendor */
#if (CLOCK_IP_SPECIFIC1_VENDOR_ID_C != CLOCK_IP_PRIVATE_VENDOR_ID)
    #error "Clock_Ip_Specific1.c and Clock_Ip_Private.h have different vendor ids"
#endif

/* Check if Clock_Ip_Specific1.c file and Clock_Ip_Private.h file are of the same Autosar version */
#if ((CLOCK_IP_SPECIFIC1_AR_RELEASE_MAJOR_VERSION_C != CLOCK_IP_PRIVATE_AR_RELEASE_MAJOR_VERSION) || \
     (CLOCK_IP_SPECIFIC1_AR_RELEASE_MINOR_VERSION_C != CLOCK_IP_PRIVATE_AR_RELEASE_MINOR_VERSION) || \
     (CLOCK_IP_SPECIFIC1_AR_RELEASE_REVISION_VERSION_C != CLOCK_IP_PRIVATE_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Clock_Ip_Specific1.c and Clock_Ip_Private.h are different"
#endif

/* Check if Clock_Ip_Specific1.c file and Clock_Ip_Private.h file are of the same Software version */
#if ((CLOCK_IP_SPECIFIC1_SW_MAJOR_VERSION_C != CLOCK_IP_PRIVATE_SW_MAJOR_VERSION) || \
     (CLOCK_IP_SPECIFIC1_SW_MINOR_VERSION_C != CLOCK_IP_PRIVATE_SW_MINOR_VERSION) || \
     (CLOCK_IP_SPECIFIC1_SW_PATCH_VERSION_C != CLOCK_IP_PRIVATE_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Clock_Ip_Specific1.c and Clock_Ip_Private.h are different"
#endif

#if (defined(CLOCK_IP_ENABLE_USER_MODE_SUPPORT))
  #if (STD_ON == CLOCK_IP_ENABLE_USER_MODE_SUPPORT)
    #ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if Clock_Ip_Specific1.c file and RegLockMacros.h file are of the same Autosar version */
    #if ((CLOCK_IP_SPECIFIC1_AR_RELEASE_MAJOR_VERSION    != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
        (CLOCK_IP_SPECIFIC1_AR_RELEASE_MINOR_VERSION    != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Clock_Ip_Specific1.c and RegLockMacros.h are different"
    #endif
    #endif
  #endif
#endif /* CLOCK_IP_ENABLE_USER_MODE_SUPPORT */
...
void SRAMC_SetRamIWS(void)
{
    ...
    IP_SRAMC_0->PRAMCR |= SRAMC_PRAMCR_IWS(IwsSetting);

    IP_SRAMC_1->PRAMCR |= SRAMC_PRAMCR_IWS(IwsSetting);
}
