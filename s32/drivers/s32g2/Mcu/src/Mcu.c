...
static Std_ReturnType Mcu_CheckInitRamSection(Mcu_RamSectionType RamSection)
{
    ...
    else
    {
        ...
        {
            if (
                    ( (Mcu_RamWriteSizeType)1U != ((*Mcu_pConfigPtr->RamConfigArrayPtr)[Mcu_au8RamConfigIds[RamSection]]).RamWriteSize ) &&
                    ( (Mcu_RamWriteSizeType)2U != ((*Mcu_pConfigPtr->RamConfigArrayPtr)[Mcu_au8RamConfigIds[RamSection]]).RamWriteSize ) &&
                    ( (Mcu_RamWriteSizeType)4U != ((*Mcu_pConfigPtr->RamConfigArrayPtr)[Mcu_au8RamConfigIds[RamSection]]).RamWriteSize ) &&
                    ( (Mcu_RamWriteSizeType)8U != ((*Mcu_pConfigPtr->RamConfigArrayPtr)[Mcu_au8RamConfigIds[RamSection]]).RamWriteSize )
               )
            {
                CheckStatus = (Std_ReturnType)E_NOT_OK;
...
static Std_ReturnType Mcu_CheckPerformReset(void)
{
    ...
    if ( (Std_ReturnType)E_OK != Mcu_IPW_GetFircStatus() )
    {
        CheckStatus = (Std_ReturnType)E_NOT_OK;
...
Std_ReturnType Mcu_InitRamSection(Mcu_RamSectionType RamSection)
{
    ...
    if ( (Std_ReturnType)E_OK == (Std_ReturnType) Mcu_HLDChecksEntry(MCU_INITRAMSECTION_ID) )
    {
        ...
        if( (Std_ReturnType)E_OK == (Std_ReturnType) Mcu_CheckInitRamSection(RamSection) )
        {
            ...
            RamStatus = Mcu_Ipw_InitRamSection(&(*Mcu_pConfigPtr->RamConfigArrayPtr)[Mcu_au8RamConfigIds[RamSection]]);
    #if (MCU_PARAM_CHECK == STD_ON)
        }
    #endif /* (MCU_PARAM_CHECK == STD_ON) */
#else
...
Std_ReturnType Mcu_InitClock(Mcu_ClockType ClockSetting)
{
    ...
    if( (Std_ReturnType)E_OK == (Std_ReturnType) Mcu_HLDChecksEntry(MCU_INITCLOCK_ID) )
    {
        ...
        {
#endif /* (MCU_PARAM_CHECK == STD_ON) */
            Mcu_Ipw_InitClock(&(*Mcu_pConfigPtr->ClockConfigArrayPtr)[Mcu_au8ClockConfigIds[ClockSetting]]);
...
void Mcu_SetMode(Mcu_ModeType McuMode)
{
    ...
    if( (Std_ReturnType)E_OK == (Std_ReturnType) Mcu_HLDChecksEntry(MCU_SETMODE_ID) )
    {
        ...
        if ( (Std_ReturnType)E_OK == (Std_ReturnType) Mcu_CheckSetMode(McuMode) )
        {
            ...
            Mcu_Ipw_SetMode( &(*Mcu_pConfigPtr->ModeConfigArrayPtr)[Mcu_au8ModeConfigIds[McuMode]] );
