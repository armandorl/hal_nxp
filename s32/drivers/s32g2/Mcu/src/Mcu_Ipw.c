...
#define MCU_IPW_ENABLE_POWER_NOTIFICATIONS STD_ON
#else
#define MCU_IPW_ENABLE_POWER_NOTIFICATIONS STD_OFF    
#endif
/*==================================================================================================
                                       GLOBAL CONSTANTS
==================================================================================================*/
...
void ClockNotificationsCallback(Clock_Ip_NotificationType Notification, Clock_Ip_NameType ClockName);
#endif

#if (MCU_IPW_ENABLE_POWER_NOTIFICATIONS == STD_ON)
void ReportPowerErrorsCallback(Power_Ip_ReportErrorType Error, uint8 ErrorCode);
#endif

#if (defined(MCU_DISABLE_DEM_REPORT_ERROR_STATUS) && (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF))
void ReportRamErrorsCallback(Ram_Ip_RamReportErrorType Error, uint8 ErrorCode);
#endif
...
#endif
#if ((defined(MCU_DISABLE_DEM_REPORT_ERROR_STATUS) && (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)) && (MCU_GET_RAM_STATE_API == STD_ON))
    Ram_Ip_InstallNotificationsCallback(ReportRamErrorsCallback);
#endif
...
{
    /* Must be removed, GetFrequency function must be added instead */
}
...
#if ((defined(MCU_DISABLE_DEM_REPORT_ERROR_STATUS) && (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)) || (defined(MCU_ERROR_ISR_NOTIFICATION)))
void ReportPowerErrorsCallback(Power_Ip_ReportErrorType Error, uint8 ErrorCode)
{
    switch(Error)
    {
