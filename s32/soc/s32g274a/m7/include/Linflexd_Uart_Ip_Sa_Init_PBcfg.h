...
#define LINFLEXD_UART_IP_SA_INIT_PBCFG_AR_RELEASE_MINOR_VERSION      4
#define LINFLEXD_UART_IP_SA_INIT_PBCFG_AR_RELEASE_REVISION_VERSION   0
#define LINFLEXD_UART_IP_SA_INIT_PBCFG_SW_MAJOR_VERSION              4
#define LINFLEXD_UART_IP_SA_INIT_PBCFG_SW_MINOR_VERSION              0
#define LINFLEXD_UART_IP_SA_INIT_PBCFG_SW_PATCH_VERSION              0
