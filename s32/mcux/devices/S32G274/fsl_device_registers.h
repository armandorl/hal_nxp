...
#if defined(CPU_S32G274)

#define S32G274_SERIES

/* CMSIS-style register definitions */
#include "S32G274.h"
/* CPU specific feature definitions */
#include "S32G274_features.h"
 ...
 */
#include "S32G274_glue_mcux.h"

#if defined(CONFIG_CPU_CORTEX_M7)
/*
 * RTD header S32G274_COMMON.h already defined the code configuration for CMSIS,
